...
-- Insert active conversation for REAL user (25 hours old, partner spoke last)
...
SELECT id, '999999999', '396943893', '這是一條25小時前的測試訊息，你應該收到提醒！(Real User)', datetime('now', '-25 hours'), 0
FROM conversations 
