 ...
 * 基于四象限元素法的配对逻辑
 */
export const ZODIAC_MATCH_RULES: Record<ZodiacElement, {
 ...
 * 基于气质互补理论
 */
export const MBTI_MATCH_RULES: Record<MbtiTemperament, {
...
export const BLOOD_MATCH_RULES: Record<BloodType, {
  targets: BloodType[];
  reasonKey: string;
}> = {
  A: {
