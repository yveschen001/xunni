export default {
  "resultTitle": "💘 **Résultat de compatibilité avec {target}**",
  "score": "💫 Indice de compatibilité : {score} points",
  "analysis": "📊 **Analyse détaillée :**",
  "high": "✨ **Une parfaite harmonie !**\nVos personnalités se complètent parfaitement, et votre interaction sera très agréable. Que ce soit en tant qu'amis ou partenaires, vous avez un grand potentiel de développement !",
  "medium": "⚖️ **Complémentarité**\nVous êtes en accord sur certains points, mais il se peut qu'il y ait besoin de quelques ajustements sur d'autres. Tant que vous êtes indulgents l'un envers l'autre, la relation sera stable.",
  "low": "🔥 **Choc des personnalités**\nVos différences de caractère sont importantes, ce qui pourrait engendrer quelques défis. Mais c'est justement cette diversité qui peut créer des étincelles inattendues !",
