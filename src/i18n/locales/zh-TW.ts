...
export const translations: Translations = {
  ...
  admin: {
    ...
    message:
      "• 更新時間：${new Date(post.updated_at).toLocaleString('zh-TW', { month: '2-digit', day: '2-digit', hour: '2-digit', minute: '2-digit' })}\n\n",
    ...
    message2:
      "• 更新時間：${avatarInfo.avatar_updated_at ? new Date(avatarInfo.avatar_updated_at).toLocaleString('zh-TW') : '未知'}\n",
    ...
    message40:
      "• 更新時間：${new Date(post.updated_at).toLocaleString('zh-TW', { month: '2-digit', day: '2-digit', hour:",
  ...
  bottle: {
    ...
    throw: {
      ...
      gender:
        "• 性別：\\${selectedGender === 'male' ? '👨 男生' : selectedGender === 'female' ? '👩 女生' : '🌈 任何人'}\n",
      gender2: '👤 **性別篩選**\n\n',
      gender3: '• 性別：篩選性別\n\n',
      gender4: '💡 選擇你想要的性別：',
      gender5: '👤 性別篩選',
      ...
      message3:
        '已選擇：\\${selectedZodiac.length > 0 ? selectedZodiac.map((z) => ZODIAC_NAMES[z]).join(',
      ...
      vip7: '✨ VIP 特權啟動中\n',
      zodiac:
        "• 星座：\\${selectedZodiac.length > 0 ? selectedZodiac.map((z) => ZODIAC_NAMES[z]).join(', ') : '無限制'}\n",
  ...
  common: {
    ...
    bloodTypeO: '🩸 O 型',
    bottle:
      '瓶子內容太短，至少需要 ${MIN_BOTTLE_LENGTH} 個字符（目前 ${trimmedContent.length} 個字符）',
    ...
    confirm7: '請確認：',
    conversation:
      '📨 ${formatIdentifier(conv.identifier)} 的對話（${conv.message_count} 則訊息）\n',
  ...
  warnings: {
    ...
    push: {
      ...
      messageReminderB:
        '📩 你有一則來自 {masked_partner_name} 的未讀訊息：\n> "{last_message_preview}..."\n(已經過了 24 小時囉！)',
