...
export const translations: Translations = {
  ...
  admin: {
    ...
    ban: {
      ...
      viewHistory:
        '💡 Použijte /admin_bans <user_id> pro zobrazení historie zákazů konkrétního uživatele',
    ...
    banSuccess:
      '✅ Zablokovaný uživatel {userId} ({nickname})\n\nDoba zákazu: {duration}\nČas odblokování: {unbanTime}',
    ...
    message:
      "• Aktualizováno: ${new Date(post.updated_at).toLocaleString('zh-TW', { month: '2-digit', day: '2-digit', hour: '2-digit', minute: '2-digit' })}\n\n",
    ...
    message2:
      "• Čas aktualizace: ${avatarInfo.avatar_updated_at ? new Date(avatarInfo.avatar_updated_at).toLocaleString('cs-CZ') : 'Neznámý'}",
    ...
    message3:
      '• ${username}: ${detail.postsUpdated} aktualizací, ${detail.postsFailed} neúspěchů\n',
    ...
    message40:
      "• Čas aktualizace: ${new Date(post.updated_at).toLocaleString('zh-TW', { month: '2-digit', day: '2-digit', hour:",
  ...
  block: {
    ...
    ensureReply:
      'Prosím, ujistěte se, že odpovídáte na zprávu zaslanou druhou stranou (s identifikátorem #).',
    hint: '💡 Toto přesně určuje osobu, kterou chcete zablokovat.',
    replyRequired:
      '⚠️ Prosím, dlouze stiskněte zprávu, kterou chcete zablokovat a odpovězte s příkazem.',
  ...
  bottle: {
    ...
    cancelled: '❌ ${zodiac} zrušeno',
      ...
      banned:
        '❌ Váš účet byl zablokován a nemůžete vybírat láhve se zprávami.\n\nPokud máte otázky, použijte /appeal k podání odvolání.',
      ...
      notRegistered:
        '❌ Prosím, dokončete registrační proces před výběrem láhve se zprávami.\n\nPoužijte /start pro pokračování registrace.',
      ...
      translationServiceFallback:
        '💬 Překladová služba momentálně má problémy, použit byl záložní překlad',
      translationServiceUnavailable:
        '⚠️ Překladová služba je dočasně nedostupná, zde je originální text',
      unknown: 'Neznámý',
    ...
    inappropriate:
      'Obsah láhve se zprávou obsahuje nevhodný obsah, prosím upravte a znovu odešlete',
    ...
    throw: {
      ...
      gender:
        "• Pohlaví: \\${selectedGender === 'male' ? '👨 Muž' : selectedGender === 'female' ? '👩 Žena' : '🌈 Kdokoliv'}",
      ...
      mbtiLabel: '• MBTI: {mbti}',
      message:
        "Vybráno: \\${selectedZodiac.length > 0 ? selectedZodiac.map((z) => ZODIAC_NAMES[z]).join(', ') : 'Žádné'}",
      message2:
        "Aktuální výběr: \\${currentGender === 'male' ? '👨 Muž' : currentGender === 'female' ? '👩 Žena' : '🌈 Kdokoliv'}",
      message3:
        'Vybráno: \\${selectedZodiac.length > 0 ? selectedZodiac.map((z) => ZODIAC_NAMES[z]).join(',
      message4: 'Aktuální výběr: \\${bloodTypeDisplay[currentBloodType]}\n\n',
      message5: '👤 Druhá strana: \\${vipMatchInfo.matcherNickname}\n',
      message6:
        '"Ahoj! Jsem někdo, kdo miluje hudbu a filmy, doufajíc, že potkám přátele se stejnými zájmy!"\n\n',
      ...
      zodiac:
        "• Znamení: \\${selectedZodiac.length > 0 ? selectedZodiac.map((z) => ZODIAC_NAMES[z]).join(', ') : 'Žádná omezení'}",
    ...
    tooShort:
      'Obsah zprávy je příliš krátký, minimálně ${min} znaků požadováno (aktuálně ${current} znaků)',
  },
  broadcast: {
    ...
    filter: {
      ...
      invalidAgeMinMax:
        'Neplatný věkový rozmezí: {value} (minimální věk nesmí být větší než maximální věk)',
    ...
    filterCreatedSending:
      'Vysílání bude provedeno na pozadí, použijte /broadcast_status {id} pro kontrolu postupu.',
    ...
    maxUsersExceeded:
      '❌ Aktuální systém vysílání podporuje maximálně ${max} uživatelů.\n\nCílový počet uživatelů: ${current}',
    ...
    upgradeRequired:
      'Hromadné vysílání vyžaduje upgrade systémové architektury, prosím odkazujte se na BROADCAST_SYSTEM_REDESIGN.md',
    usageError: '❌ Nesprávné použití\n\n',
  ...
  buttons: {
    ...
    banned:
      '❌ Váš účet byl zablokován a nemůže vybírat láhve se zprávami.\n\nPokud máte otázky, použijte /appeal pro podání odvolání.',
    ...
    nickname2: '📝 Přezdívka: ${catcherNickname}\n',
    notRegistered:
      '❌ Dokončete registrační proces, abyste mohli vyzvednout láhve se zprávou.\n\nPoužijte /start pro pokračování registrace.',
    originalContent: 'Původní text: {content}',
    ...
    translatedLanguage: 'Překladový jazyk: {language}',
    translationServiceFallback:
      '💬 Služba překladu dočasně má problémy, byla použita záložní překlad',
  ...
  channelMembership: {
    ...
    notJoined:
      '❌ Nedetekováno, že jste se připojili k kanálu, prosím připojte se nejdříve a zkuste to znovu',
  ...
  common: {
    ...
    bloodTypeO: '🩸 Typ O',
    bottle:
      'Obsah láhve se zprávou je příliš krátký, vyžadováno alespoň ${MIN_BOTTLE_LENGTH} znaků (aktuálně ${trimmedContent.length} znaků)',
    ...
    bottle2:
      'Obsah láhve se zprávou je příliš dlouhý, maximálně ${MAX_BOTTLE_LENGTH} znaků povoleno (aktuálně ${content.length} znaků)',
    ...
    bottle4:
      'Anonymní platforma pro láhve se zprávou, která vám pomáhá najít podobně smýšlející přátele prostřednictvím MBTI a znamení zvěrokruhu\n\n',
    bottle5:
    ...
    bottle9:
      'Podívejte se na láhve se zprávou od ostatních a odpovězte, pokud máte zájem začít chatovat\n\n',
    broadcast:
      'Broadcast bude odeslán na pozadí, použijte /broadcast_status ${broadcastId} pro kontrolu průběhu.',
    ...
    broadcast2:
      'Velkoplošná vysílání vyžadují upgrady systémové architektury, prosím odkažte na BROADCAST_SYSTEM_REDESIGN.md',
    ...
    confirm:
      'Abychom zajistili bezpečnost všech uživatelů, potvrďte, prosím, že chápete následující:\n\n',
    ...
    conversation:
      "📨 ${formatIdentifier(conv.identifier)}'s konverzace (${conv.message_count} zpráv)\n",
    conversation10: '💡 **Nebyla nalezena historie konverzací**\n\n',
    conversation11:
      'Některé záznamy konverzace nemusí být aktualizovány, prosím zkuste to znovu později.',
    ...
    conversation6:
      'Vaše cache avataru byla aktualizována. Nejnovější avatar se zobrazí příště, když si prohlédnete historii konverzací.\n\n',
    conversation7:
      '💡 Pro ochranu soukromí a zabezpečení jsou v konverzacích povoleny pouze textové zprávy.\n\n',
    ...
    message2:
      "datum_narození = '2000-01-01',\n věk = 25,\n znamení_zvěrokruhu = 'Kozoroh',\n skóre_proti_podvodům = 100,\n souhlas_s_podmínkami = 1",
    ...
    message23:
      "💡 Prosím, dlouze stiskněte zprávu, na kterou chcete odpovědět, vyberte 'Odpovědět' z menu, které se objeví, a zadejte svou odpověď do chatovacího okna.",
    ...
    message28: '/maintenance_enable <doba (minuty)> [Zpráva o údržbě]',
    ...
    message32:
      'Velitel - Odvážní, výjimečně kreativní a silní vůdci, kteří vždy najdou nebo vytvoří řešení.',
    message33: '💡 Použijte /broadcast_status <id> pro zobrazení podrobností',
    message34: '🏷️ Značky zájmu: ${updatedUser.interests ||',
    message35:
      'Guvernér - Empatický, populární a ochotní jedinci, kteří se vždy snaží přispět do komunity.',
    message36: '/broadcast_filter <filtr> <obsah zprávy> <filter> <message content>',
    message37: '**Obsah zprávy:**\n${broadcastMessage}',
    message38: '• Celkový počet zpráv: ${stats.total_messages}',
    message39:
      'Kandidát - Vášniví, kreativní a společenské volnomyšlenkáři, kteří vždy najdou důvod se usmívat.',
    message4:
      '💡 Použijte /history ${formatIdentifier(conversations[0].identifier)} pro zobrazení celé konverzace',
    message40: 'Zbývající čas: ${remaining.remainingText}\n',
    message41:
      'Interpret - Spontánní, energičtí a vášniví umělci, kteří nikdy nenacházejí život nudný.',
    ...
    message48:
      'Podnikatel - Chytrý, energický a vnímavý jedinci, kteří si skutečně užívají život na hraně.',
    ...
    message6:
      '• Zobrazení: ${stats.total_views} | Kliknutí: ${stats.total_clicks} (${stats.ctr}%)\n',
    message60:
      'Průzkumník - Obratní a okouzlující umělci, vždy připraveni objevovat a zažívat nové věci.',
    message61:
      '• Dlouze stiskněte zprávu druhé osoby pro odpověď /block pro blokování tohoto uživatele\n',
    message62:
      'Prosím, ujistěte se, že zpráva, na kterou odpovídáte, je ta, kterou poslal druhý účastník (s identifikátorem #).',
    message63: '/broadcast_non_vip <obsah zprávy> <message content>',
    ...
    message68: '/broadcast <message content> <obsah zprávy> <訊息內容>',
    message69: '/broadcast_vip <message content> <obsah zprávy> <訊息內容>',
    message7:
      '• Počet ověření: ${stats.total_verified}\n• Míra ověření: ${stats.verification_rate}%',
    ...
    next: 'Další stránka',
    nickname:
      '💡 Zadejte prosím jednoduchou přezdívku, která neobsahuje odkazy jako http:// nebo https://.',
    ...
    text12:
      'Generální ředitel - Vynikající manažer, bezkonkurenční v řízení záležitostí nebo personálu.',
    text120: '💡 **Tip:**',
    ...
    text13:
      '💡 To bude zobrazeno na vaší profilové kartě, což pomůže ostatním uživatelům vás lépe pochopit.\n',
    ...
    text16: "✅ Je potřeba ověření: Klikněte na tlačítko 'Ověřit' po připojení do skupiny/kanálu",
    ...
    text22:
      'Zapište si své pocity nebo myšlenky a systém vám pomůže najít toho pravého člověka\n\n',
    text23:
      'Logistický specialista - Praktičtí a fakta orientovaní jednotlivci, jejichž spolehlivost je nezpochybnitelná.',
    ...
    yes: 'Ano',
    zodiac:
      "Neplatný znamení zvěrokruhu: ${trimmedValue} (musí být jedním z: ${VALID_ZODIACS.join(', ')})",
  },
  conversation: {
    age: '🎂 Věkový rozmezí: ${ageRange} let\n',
    anonymousCardHint:
      '💡 Toto je anonymní datová karta a nebude zobrazovat skutečné identifikační informace druhé strany.',
    ...
    conversation3:
      "💡 Klikněte na tlačítko 'Odpovědět' na zprávě druhé strany, abyste pokračovali v konverzaci\n",
  ...
  country: {
    ...
    confirmHint:
      '💡 To se zobrazí na vaší profilové kartě a pomůže ostatním uživatelům vás lépe pochopit.\n',
  ...
  dev: {
    ...
    notAvailableInProduction:
      '❌ Tento příkaz není k dispozici v produkčním prostředí.\n\nTento příkaz není k dispozici v produkci.',
  ...
  error: {
    ...
    bottle:
      '❌ Tato konverzace byla ukončena.\n\nPoužijte /catch pro vyzvednutí nové láhve se zprávou a zahájení nové konverzace.',
    bottle2:
      '❌ Váš účet byl pozastaven a nemůže vyzvedávat láhve se zprávou.\n\nPokud máte nějaké dotazy, použijte prosím /appeal pro odvolání.',
    bottle3: '❌ Tuto láhev již někdo vyzvedl, prosím zkuste jinou láhev!',
    broadcast:
      '❌ Aktuální vysílací systém podporuje pouze vysílání pro maximálně ${MAX_SAFE_USERS} uživatelů.\n\n',
    broadcast2: '❌ ID vysílání musí být číslo',
    broadcast3: '❌ Nelze najít záznam o vysílání',
    cancel:
      '❌ Přezdívka je příliš dlouhá, zadejte prosím přezdívku o maximální délce 36 znaků.\n\nProsím, zadejte znovu nebo zrušte úpravy:',
    cancel2:
      '❌ Osobní profil je příliš dlouhý, zadejte prosím profil o maximální délce 200 znaků.\n\nProsím, zadejte znovu nebo zrušte úpravy:',
    cancel3:
      '❌ Název oblasti je příliš dlouhý, zadejte prosím název o maximální délce 50 znaků.\n\nProsím, zadejte znovu nebo zrušte úpravy:',
    cancel4:
      '❌ Přezdívka je příliš krátká, musí mít alespoň 4 znaky.\n\nProsím, zadejte znovu nebo zrušte úpravy:',
    cancel5:
      '❌ Každý štítek může mít maximálně 20 znaků.\n\nProsím, zadejte znovu nebo zrušte úpravy:',
    ...
    failed2:
      '❌ Vytvoření filtrovaného vysílání se nezdařilo\n\n${error instanceof Error ? error.message : String(error)}',
    failed20: '❌ Potvrzení selhalo',
    failed21: '❌ Nastavení selhalo',
    failed22: '❌ Přeskočení selhalo',
    failed23: '❌ Operace selhala',
    failed24:
      '❌ Odeslání denní zprávy selhalo: ${error instanceof Error ? error.message : String(error)}',
    ...
    failed3:
      '❌ Nepodařilo se zpracovat frontu příspěvků: ${error instanceof Error ? error.message : String(error)}',
    ...
    failed4:
      '❌ Nepodařilo se dotázat na stav vysílání: ${error instanceof Error ? error.message : String(error)}',
    failed40: '❌ Odeslání selhalo, zkuste to prosím později.',
    failed41: '❌ Nepodařilo se vytvořit konverzaci, zkuste to prosím později.',
    failed5:
      '❌ Nepodařilo se zrušit vysílání: ${error instanceof Error ? error.message : String(error)}',
    failed6:
      '❌ Nepodařilo se vyčistit vysílání: ${error instanceof Error ? error.message : String(error)}',
    ...
    message4:
      '❌ Omlouváme se, musíte být alespoň 18 let, abyste mohli používat tuto službu.\n\nProsím, vraťte se, až dosáhnete zletilosti!',
    ...
    quota:
      '❌ Dnešní kvóta na zprávy z láhve byla vyčerpána (${quotaDisplay})\n\n💡 Způsoby, jak získat více kvót:\n',
  ...
  errors: {
    ...
    error: {
      ...
      bottle2:
        '❌ Váš účet byl zakázán a nemůže vybírat láhve se zprávou.\n\nPokud máte dotazy, použijte prosím /appeal k odvolání.',
      bottle3: '❌ Tato láhev byla již vyzvednuta někým jiným, zkuste prosím jiné láhve!',
      broadcast:
        '❌ Aktuální vysílací systém podporuje pouze vysílání pro \\${MAX_SAFE_USERS} uživatelů nebo méně.\n\n',
      broadcast2: '❌ ID vysílání musí být číslo',
      broadcast3: '❌ Nelze nalézt záznam o vysílání',
      cancel:
        '❌ Přezdívka je příliš dlouhá, prosím, zadejte přezdívku, která má maximálně 36 znaků.\n\nProsím, zadejte znovu nebo zrušte úpravy:',
      cancel2:
        '❌ Osobní profil je příliš dlouhý, prosím, zadejte profil, který má maximálně 200 znaků.\n\nProsím, zadejte znovu nebo zrušte úpravy:',
      cancel3:
        '❌ Název regionu je příliš dlouhý, prosím, zadejte název, který má maximálně 50 znaků.\n\nProsím, zadejte znovu nebo zrušte úpravy:',
      cancel4:
        '❌ Přezdívka je příliš krátká, je potřeba alespoň 4 znaky.\n\nProsím, zadejte znovu nebo zrušte úpravy:',
      ...
      cancel9: '❌ Zrušeno',
      conversation:
        '❌ Rozhovor s identifikátorem \\${formatIdentifier(identifier)} nebyl nalezen\n\n',
      ...
      failed2:
        '❌ Nepodařilo se vytvořit filtrové vysílání\n\n\\${error instanceof Error ? error.message : String(error)}',
      failed20: '❌ Potvrzení selhalo',
      failed21: '❌ Nepodařilo se nastavit',
      failed22: '❌ Přeskočení selhalo',
      failed23: '❌ Operace selhala',
      failed24:
        '❌ Nepodařilo se odeslat denní zprávu: \\${error instanceof Error ? error.message : String(error)}',
      ...
      failed3:
        '❌ Nepodařilo se zpracovat frontu vysílání: \\${error instanceof Error ? error.message : String(error)}',
      ...
      failed37: '❌ Nepodařilo se nastavit prioritu',
      failed38:
        '❌ Vrácení peněz se nezdařilo: \\${error instanceof Error ? error.message : String(error)}',
      failed39: '❌ Operace selhala: \\${error instanceof Error ? error.message : String(error)}',
      failed4:
        '❌ Nepodařilo se dotázat na stav vysílání: \\${error instanceof Error ? error.message : String(error)}',
      ...
      message3:
        '❌ Nastala chyba, zkuste to prosím znovu později.\n\nZpráva o chybě: \\${error instanceof Error ? error.message : String(error)}',
      message4:
        '❌ Omlouváme se, musíte být alespoň 18 let, abyste mohli tuto službu používat.\n\nVraťte se prosím, až budete dospělí!',
      ...
      quota:
        '❌ Dnešní kvóta na láhve se zprávou je vyčerpána (\\${quotaDisplay})\n\n💡 Způsoby, jak získat více kvoty:\n',
      quota2:
        '❌ Dnešní kvóta zpráv v rozhovoru byla vyčerpána (\\${usedToday}/\\${dailyLimit})\n\n',
      quota3: '❌ Dnešní kvóta zpráv v láhvi byla vyčerpána (\\${quotaDisplay})\n\n',
      register:
        '❌ Nejprve prosím dokončete registrační proces.\n\nPoužijte /start pro pokračování registrace.',
      register2:
        '❌ Uživatelova data nebyla nalezena, nejprve prosím použijte /start pro registraci.',
      register3:
        '❌ Prosím, dokončete registrační proces pro vyzvednutí lahví se zprávou.\n\nPoužijte /start pro pokračování registrace.',
      ...
      text17:
        '❌ Při zpracování platby došlo k systémové chybě, prosím kontaktujte zákaznickou podporu.\n\n',
  ...
  history: {
    ...
    conversationNotFound:
      '❌ Konverzace s identifikátorem {identifier} nebyla nalezena.\n\nPoužijte /history pro zobrazení všech konverzací.\n\n🏠 Návrat do hlavního menu: /menu',
  ...
  invite: {
    ...
    upgradePrompt: '💎 Získejte VIP pro více pozvánek',
    userType: '{type}',
  },
  maintenance: {
  ...
  mbti: {
    ...
    share: {
      welcome:
        '👋 Váš přítel vás zve k vyzkoušení MBTI testu!\n\nPřijďte a zjistěte svůj typ osobnosti～',
  ...
  mbtiTest: {
    ...
    quickTestInfo:
      '💡 Toto je rychlý kvíz ({questions}), a výsledky jsou pouze orientační.\nPo dokončení registrace si můžete kvíz zopakovat přes /mbti.',
  ...
  menu: {
    ...
    levelVip: '💎 VIP člen',
    message:
      'Pojďme společně posílat láhve se zprávou na XunNi! 🍾 Použij můj pozvánkový kód k připojení a oba získáme více kvót!',
    message2:
      'https://t.me/share/url?url=https://t.me/${botUsername}?start=invite_${inviteCode}&text=Přijďte do XunNi a hodíme si láhev se zprávou spolu ',
  ...
  nickname: {
    ...
    genderSelection:
      'Skvělé! Vaše uživatelské jméno je: {nickname}\n\nNyní prosím vyberte své pohlaví:\n\n',
  ...
  officialAd: {
    ...
    requiresVerification:
      "✅ Potřebná verifikace: Klikněte na tlačítko 'Ověřit' po připojení do skupiny/kanálu",
  ...
  onboarding: {
    ...
    ageRestriction:
      '❌ Omlouváme se, musíte být alespoň 18 let, abyste mohli tuto službu používat.\n\n',
    agreeTerms:
      'Klikněte na tlačítko níže a potvrďte, že jste si přečetli a souhlasíte s výše uvedenými podmínkami.',
    antiFraud: {
    ...
    antiFraudQuestions:
      'Abychom chránili bezpečnost všech uživatelů, prosím potvrďte, že rozumíte následujícímu:\n\n',
    antiFraudYes: '✅ Ano, rozumím a budu dbát na bezpečnost',
    back: '⬅️ Zpět',
    birthday:
      'Pokud si myslíte, že je to omyl, zkontrolujte prosím, zda je formát vašeho data narození správný (RRRR-MM-DD).',
    ...
    birthdayCheck:
      'Pokud si myslíte, že se jedná o chybu, zkontrolujte, zda je formát vašich narozenin správný (RRRR-MM-DD).',
    birthdayError: '❌ {error}',
    birthdayFormatError:
      '❌ Nesprávný formát narozenin\n\nProsím, zadejte znovu (formát: RRRR-MM-DD):',
    birthdayRetry: 'Prosím, zadejte znovu datum narození (formát: RRRR-MM-DD):',
    birthdayWarning:
      '⚠️ Narozeniny nelze upravovat po nastavení, prosím potvrďte, že jsou správné!',
    bloodType: {
    ...
    confirm:
      'Abychom zajistili bezpečnost všech uživatelů, prosím potvrďte, že rozumíte rizikům online seznamování.\n\n',
    ...
    settings:
      '💡 Tip: Můžete kdykoli použít příkaz /mbti k nastavení nebo otestování svého typu MBTI.\n\n',
    ...
    stats: '📊 Statistiky',
    stepAntiFraud:
      '🛡️ Prosím, klikněte na tlačítko výše pro potvrzení bezpečnostních opatření proti podvodům',
    ...
    text7:
      'Klikněte na tlačítko níže pro potvrzení, že jste si přečetli a souhlasíte s výše uvedenými podmínkami.',
    ...
    understandRisks:
      'Abychom ochránili bezpečnost všech uživatelů, prosím, potvrďte, že chápete rizika online seznamování.\n\n',
  ...
  profile: {
    ...
    completeOnboarding:
      '⚠️ Prosím nejprve dokončete registrační proces.\n\nPoužijte /start pro pokračování v registraci.',
    ...
    message:
      'https://t.me/share/url?url=https://t.me/${botUsername}?start=invite_${inviteCode}&text=Pozvěte do XunNi a společně házíme láhve se zprávami!🍾 Použijte můj pozvánkový kód: ${inviteCode}',
    ...
    message7:
      'https://t.me/share/url?url=https://t.me/${botUsername}?start=invite_${inviteCode}&text=Přijďte se připojit k XunNi a hoďte láhev se zprávou',
  ...
  report: {
    ...
    reasonSpam: '📢 Spam',
    replyRequired:
      '⚠️ Prosím, dlouze stiskněte zprávu, kterou chcete nahlásit, a pak odpovězte příkazem\n\n',
  ...
  tasks: {
    ...
    description: {
      ...
      first_conversation:
        "Navázejte první kontakt (dlouhým stisknutím zprávy → vyberte 'Odpovědět')",
      interests: 'Nechte ostatní vás lépe poznat',
      invite_progress:
        'Získejte +1 trvalou denní kvótu za každou osobu, kterou pozvete (zdarma pro až 10 lidí, VIP až pro 100 lidí)',
    ...
    message2:
      'Klikněte na tlačítko níže a připojte se k oficiálnímu kanálu XunNi pro nejnovější zprávy a události!\n\n',
    name: {
  ...
  throw: {
    ...
    gender:
      "• Pohlaví: ${selectedGender === 'male' ? '👨 Muž' : selectedGender === 'female' ? '👩 Žena' : '🌈 Jakékoliv'}",
    gender2: '👤 **Filtr pohlaví**\n\n',
    ...
    mbtiLabel: '• MBTI: {mbti}',
    message:
      "Vybráno: ${selectedZodiac.length > 0 ? selectedZodiac.map((z) => ZODIAC_NAMES[z]).join(', ') : 'Žádný'}",
    message2:
      "Aktuální výběr: ${currentGender === 'male' ? '👨 Muž' : currentGender === 'female' ? '👩 Žena' : '🌈 Kdokoli'}",
    message3:
      'Vybráno: ${selectedZodiac.length > 0 ? selectedZodiac.map((z) => ZODIAC_NAMES[z]).join(',
    message4: 'Aktuální výběr: ${bloodTypeDisplay[currentBloodType]}',
    message5: '👤 Protivník: ${vipMatchInfo.matcherNickname}',
    message6:
      '"Ahoj! Jsem někdo, kdo miluje hudbu a filmy, doufám, že potkám přátele se stejnými zájmy～"',
    ...
    zodiac:
      "• Zodiac: ${selectedZodiac.length > 0 ? selectedZodiac.map((z) => ZODIAC_NAMES[z]).join(', ') : 'Žádné omezení'}",
    zodiac2: '⭐ Zvěrokruh: ${matchResult.user.zodiac ||',
    zodiac3: '⭐ Zvěrokruh: ${user.zodiac_sign ||',
    zodiac4: '⭐ **Filtr Zvěrokruhu**\n\n',
  ...
  tutorial: {
    ...
    catchBottleDesc:
      'Podívejte se na láhve se zprávou ostatních a pokud máte zájem, odpovězte, abyste začali chatovat',
    ...
    whatIsXunNiDesc:
      'Platforma pro přátelství pomocí anonymních láhví se zprávou, která vám pomůže najít podobně smýšlející přátele pomocí MBTI a znamení zvěrokruhu',
  },
  vip: {
    admin: '⏳ Máte pending žádost o vrácení, prosím buďte trpěliví, než administrátor posoudí.',
    bottle:
      "📝 Obsah láhve se zprávou: ${bottle.content.substring(0, 50)}${bottle.content.length > 50 ? '...' : ''}\n\n",
    ...
    message12:
      "💬 **Prosím, dlouze stiskněte tuto zprávu, vyberte 'Odpovědět' a zadejte obsah, abyste začali chatovat s druhou stranou**",
    ...
    refundPending:
      '⏳ Máte čekající žádost o vrácení peněz, prosím vyčkejte trpělivě na posouzení administrátorem.',
    ...
    refundRejected:
      '❌ **Žádost o vrácení peněz byla odmítnuta**\n\nDůvod: ${reason}\n\nPokud máte otázky, kontaktujte prosím zákaznickou podporu.',
    refundRejectedAdmin:
      '✅ Vrácení peněz odmítnuto\n\nID žádosti: #${requestId}\nID uživatele: ${userId}',
    refundRequestItem:
    ...
    reminderGracePeriod:
      '📌 Gracia: Služba nebude přerušena, pokud bude obnovena do 3 dnů po vypršení.',
    ...
    settings:
      '💡 Chcete-li zrušit předplatné, přejděte do Nastavení Telegramu > Správa předplatného\n\n',
    settings2:
      '💡 Chcete-li zrušit své předplatné, přejděte do Nastavení Telegramu > Správa předplatného',
    ...
    text4:
      '🔄 **Automatické obnovení**: Automaticky se účtuje měsíčně, není třeba ručního obnovení\n',
  ...
  warning: {
    ...
    message:
      '⚠️ Nalezeno ${outdatedPosts.length} zastaralých příspěvků, které je potřeba obnovit\n',
    message2: '⚠️ Poznámka: Toto je ${testInfo}${testTitle}, ${accuracy}.\n\n',
    message3:
      '⚠️ Prosím dlouze stiskněte zprávu, kterou chcete zablokovat, a odpovězte příkazem\n\n',
  ...
  warnings: {
    ...
    warning: {
      ...
      mbti2: '⚠️ Neplatný typ MBTI',
      message:
        '⚠️ Zjištěno \\${outdatedPosts.length} zastaralých příspěvků, které je potřeba aktualizovat\n',
      message2: '⚠️ Poznámka: Toto je \\${testInfo}\\${testTitle}, \\${accuracy}.\n\n',
      message3:
        '⚠️ Prosím dlouze stiskněte zprávu, kterou chcete zablokovat, a odpovězte příkazem\n\n',
      message4:
        '⚠️ Prosím dlouze stiskněte zprávu, kterou chcete nahlásit, a odpovězte příkazem\n\n',
      message5: '⚠️ **Zpráva obsahuje zakázané odkazy**\n\n',
      register:
        '⚠️ Uživatelův profil nebyl nalezen, prosím, nejprve se zaregistrujte pomocí /start.',
      register2:
        '⚠️ Nejprve prosím dokončete registrační proces.\n\nPoužijte /start pro pokračování registrace.',
    ...
    BROADCAST: {
      ...
      NO_MATCHES:
        '⚠️ Nebyli nalezeni žádní uživatelé odpovídající kritériím.\nKritéria filtru: {filters}',
      TOO_MANY_USERS:
        '⚠️ Příliš mnoho cílových uživatelů ({count} lidí), momentálně je omezeno na odeslání {max} lidem najednou.',
      START_SENDING: '🚀 Spouští se vysílání #{id}\n🎯 Cíl: {filters}\n👥 Počet lidí: {count}',
      COMPLETED:
        '✅ Vysílání #{id} bylo dokončeno!\nÚspěšně: {sent}\nNeúspěšně: {failed}\nBlokováno: {blocked}',
    },
    push: {
      throwReminder:
        '🌊 Ahoj! Už je to chvíli, co jsi hodil láhev se zprávou, pláž je velmi tichá...',
      catchReminder:
        '🎣 Na pláži se objevilo několik nových lahví se zprávou, chceš se na ně jít podívat?',
      onboardingReminder:
        '👋 Tvoje registrace ještě není dokončena, jsi téměř u cíle! (Krok: {step})',
      messageReminderA:
        '👋 Ahoj {masked_partner_name}, stále čeká na vaši odpověď! Nenechte konverzaci vychladnout～',
      messageReminderB:
        '📩 Máte nepřečtenou zprávu od {masked_partner_name}:\n> "{last_message_preview}..."\n(Už to trvá více než 24 hodin!)',
    ...
    match: {
      ...
      reason: {
        zodiac: {
          ...
          earth_affinity:
            'Stabilita zemských znamení v kombinaci s jemností vodních znamení vytváří dokonalý proud.',
          air_affinity:
            'Obratnost vzdušných znamení se setkává s vášní ohnivých znamení, což inspirová nekonečnou kreativitu!',
          water_affinity:
            'Emoce vodních znamení a praktičnost zemských znamení vytvářejí nejteplejší podporu.',
        },
        mbti: {
          sj_affinity: 'Společenské (SJ) a Objevitelé (SP), dokonalý doplněk stability a vzrušení!',
          sp_affinity:
            'Objevitelé (SP) a Společenské (SJ), nejlepší partneři pro kamarády a pečovatele!',
        ...
        blood: {
          a_affinity:
            'Pečlivost typu A se setkává s tolerancí typu O, což vytváří nejpohodlnější interakce.',
          b_affinity:
            'Sebevědomí typu B se setkává se snadnou povahou typu O, bez stresu a uvolněné.',
  ...
  push: {
    ...
    actionReply: '💬 Odpovědět {masked_partner_name}',
    throwReminder:
      '🌊 Ahoj! Už je to chvíli, co jste hodili láhev se zprávou, pláž je tak tichá...',
    ...
    messageReminderA:
      '👋 Ahoj {masked_partner_name}, stále čekáme na vaši odpověď! Nenechte konverzaci vychladnout～',
    messageReminderB:
