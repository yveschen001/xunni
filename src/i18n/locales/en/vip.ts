export default {
  ...
  "mbti": "🎯 Precise filtering to meet the right person\n• When sending a message bottle, you can specify the recipient's MBTI, zodiac sign, and blood type.\nIn the vast sea of people, accurately pinpoint your ideal type.",
  ...
  "text": "- Prefer to use OpenAI GPT model translation (high quality)\n🔮 AI astrology privileges\nDaily free access to unlock fortune details (regular users once a week).\nObtain in-depth career and interest analysis reports.\n🚫 Pure experience\nCompletely ad-free interference.",
  ...
  "vip6": "Subscribe to XunNi VIP Membership (One-time Purchase)",
