export default {
  ...
  "bottle2": "❌ Your account has been banned and cannot pick Blessing Bottles.\n\nIf you have questions, please use /appeal to appeal.",
  ...
  "quota": "❌ Today's blessing Blessing Bottle quota has been used up ({quotaDisplay})\n\n💡 Ways to earn more quotas:",
  "quota2": "❌ Today's conversation message quota has been used up ({usedToday}/{dailyLimit})\n\n",
  "quota3": "❌ Today's quota for Blessing Bottle blessings has been used up ({quotaDisplay})",
  ...
  "register3": "❌ Please complete the registration process before you can pick Blessing Bottles.\n\nUse /start to continue registering.",
