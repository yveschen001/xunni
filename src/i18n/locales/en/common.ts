export default {
  ...
  "bottle12": "What kind of person are you looking for when throwing a message bottle?",
  ...
  "bottle16": "💡 Next time you throw a message bottle, this setting will be used automatically.",
  "bottle17": "🌊 Throw a message bottle - /throw",
  "bottle18": "🎣 Pick up a message bottle - /catch",
  ...
  "bottle20": "✏️ Please enter the new message bottle content:",
  "bottle21": "• Use /catch to pick up a new message bottle",
  "bottle22": "• /throw - Throw a message bottle",
  "bottle23": "• /catch - Pick up a message bottle",
  "bottle24": "• /throw - Throw message bottle",
  "bottle25": "• /catch - Pick up message bottle",
  "bottle26": "• Send draft content to throw a message bottle",
  "bottle27": "📦 **Throw Message Bottle**\n",
  "bottle28": "🎣 **Pick up message bottle**",
  "bottle29": "💡 Complete tasks to receive extra bottles",
  "bottle3": "• Message bottles: {bottlesCount?.count }",
  ...
  "bottle4": "Anonymous message bottle dating platform that helps you find like-minded friends through MBTI and astrology",
  ...
  "bottle9": "Check out other people's message bottles, and if you're interested, reply to start chatting",
