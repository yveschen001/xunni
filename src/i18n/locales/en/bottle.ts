export default {
  "bottle13": "Blessings Blessing Bottle content",
  ...
  "catch": {
    ...
    "bottle": "😔 Currently, there are no suitable blessing Blessing Bottles",
    "bottle2": "• Or throw a Blessing Bottle with your own blessing: /throw",
    "bottle3": "🎣 Someone has found your Blessing Bottle!",
    "bottle4": "🧴 You found a Blessing Bottle of blessings!",
    "bottle5": "💡 Let's come back tomorrow to collect more blessing Blessing Bottles!",
    "bottleTaken": "❌ This Blessing Bottle has already been picked up by someone else. Please try other bottles!",
    ...
    "notRegistered": "❌ Please complete the registration process before collecting Blessing Bottles.\n\nUse /start to continue the registration.",
    "originalContent": "Original: {content}",
    "originalLanguage": "Original language: {language}",
    "quotaExhausted": "❌ Today's blessing Blessing Bottle quota has been used up (\\{quotaDisplay})",
    ...
    "text4": "• If you no longer want to chat, you can use /block to block\n\n",
    "text5": "Original text: \\{bottle.content}\n",
    "text6": "💬 The translation service is temporarily experiencing issues, backup translation has been used\n",
    ...
    "translationServiceFallback": "💬 Translation service is temporarily experiencing issues, backup translation has been used.",
  ...
  "throw": {
    ...
    "bottle10": "🍾 The blessing Blessing Bottle has been thrown out! In this vast sea of people, who will receive my blessings~",
    "bottle11": "🍾 Send a Blessing Bottle with blessings",
    "bottle2": "🎯 Your Blessing Bottle has been sent to **3 recipients**:",
    "bottle3": "🍾 **Throwing your blessing Blessing Bottle...**",
    "bottle4": "🍾 **Send Blessing Blessing Bottle** #THROW",
    "bottle5": "Bottle ID: #{bottleId}",
    "bottle6": "📝 **Please enter the content of your blessings for a stranger**",
    "bottle7": "1️⃣ Click the button \"🍾 Send Blessing Blessing Bottle\" below",
    ...
    "message6": "Hello! I am someone who loves music and movies,\nhope to get to know some of you who have stories as well.\nWishing you who sees this message bottle all the best and may your wishes come true 🌟",
    ...
    "text2": "• 🆕 Triple exposure opportunity! Throwing one message bottle triggers 3 targets.",
    "text20": "💬 **Example**:\n",
