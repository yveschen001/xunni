export default {
  ...
  "back": "Main Menu",
  "banned": "❌ Your account has been banned and you cannot catch any Blessing Bottles.\n\nIf you have questions, please use /appeal to appeal.",
  ...
  "bottle3": "🎣 Someone found your Blessing Bottle!",
  "bottle4": "🧴 You have found a blessing Blessing Bottle!",
  ...
  "notRegistered": "❌ Please complete the registration process before you can pick up Blessing Bottles.\n\nUse /start to continue the registration.",
  "originalContent": "Original text: {content}",
  "originalLanguage": "Original language: {language}",
  "quotaExhausted": "❌ Today's Blessing Bottle blessing quota has been exhausted ({quotaDisplay})",
  ...
  "translationServiceUnavailable": "⚠️ Translation service is temporarily unavailable (Original text shown above)",
  "unknown": "Unknown",
