export default {
  ...
  "bottle": "Use /catch to pick up a Blessing Bottle and start a happy chat!",
  "bottle2": "• Use /catch to pick up a new Blessing Bottle",
  "cancelButton": "❌ Cancel",
  ...
  "conversationEnded": "❌ This conversation has ended.\n\nUse /catch to pick a new Blessing Bottle to start a new conversation.",
  ...
  "settings5": "Not set",
  "short": "Blocked after:\n",
  "selectNumber": "Please click the corresponding number below to view details:",
  "short2": "Unknown user",
  "short3": "Just now",
  ...
  "historyPost": "📜 Conversation History #{id}",
  "historyPostSuffix": " (click to view details)",
  "newMessageNotification": "📩 You have a new message!",
  "newMessageNotificationSuffix": " (from {sender})",
