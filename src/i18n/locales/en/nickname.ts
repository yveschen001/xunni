export default {
  ...
  "genderHint": "⚠️ Note: Gender settings cannot be changed once selected, please choose carefully!\n- To use astrological readings and Blessing Bottle matching features, please provide your gender at birth.",
