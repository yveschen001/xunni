export default {
  ...
  "bottle7": "1️⃣ Click the button below '🍾 Throw Message Bottle', and you will see a response to this message. Directly in the chat input box, leave the content of your message bottle.",
