export default {
  ...
  "admin2": "Admin ban",
  "admin3": "- Add as regular admin",
  "admin4": "- Remove regular admin",
  "admin5": "`/admin_add 123456789` - Add as regular admin",
  ...
  "text32": "This command requires manual modification of the configuration file.",
  ...
  "grant": {
    "successVip": "✅ Successfully granted VIP access to user {userId} ({nickname}) for 30 days.",
    "successBottles": "✅ Successfully added 50 fortune bottles to user {userId} ({nickname}).",
    "invalidId": "❌ Invalid user ID.",
    "userNotFound": "❌ User {userId} not found.",
    "onlySuperAdmin": "❌ This command is for super administrators only.",
    "usageVip": "Usage: /add_vip [userID] (leave blank for yourself)",
    "usageBottles": "Usage: /add_bottles [userID] (leave blank for yourself)"
  }
};
