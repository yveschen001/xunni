export default {
  ...
  "bottle3": "• You can send and collect a limited number of blessing Blessing Bottles each day.",
  ...
  "bottle7": "/throw - Throw a Blessing Bottle",
  "bottle8": "/catch - Catch a Blessing Bottle",
  "bottle9": "🍾 **Blessing Bottle System**",
  ...
  "profile3": "👤 **Profile**\n",
  "quota": "🔢 Daily High Quota\n• Start with 30 Blessing Bottles per day (only 10 for regular users).\n• Inviting friends can permanently increase the quota, with a total maximum of 100!\n• Daily limit of 100 conversation messages, chat without barriers.",
  "quota2": "• Daily quota of 30 Blessing Bottles",
  ...
  "superAdminMaintenanceEnable": "• `/maintenance_enable <minutes> [reason]` - Enable maintenance mode",
  "devToolsTitle": "🛠️ **Developer Tools**",
  "devInfo": "/dev_info - View system information",
