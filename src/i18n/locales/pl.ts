...
export const translations: Translations = {
  ...
  "analytics": {
    ...
    "complete": "• Wskaźnik zakończeń: {rate}%",
    "complete2": "• Zakończenia: {completions}",
    ...
    "message4": "• Wskaźnik konwersji: {rate}%",
    "message5": "• Wskaźnik błędów: {rate}%",
    "message6": "• Żądania: {requests}",
    ...
    "text": "• Liczba użytkowników: {userCount}",
  ...
  "mbtiTest": {
    ...
    "fullTestInfo": "💡 To jest pełny test ({questions}), wynik jest dokładniejszy.\nPo zakończeniu rejestracji możesz użyć /mbti, aby powtórzyć test.",
    ...
    "quickTestInfo": "💡 To jest szybki test ({questions}), wynik jest tylko do wglądu.\nPo zakończeniu rejestracji możesz użyć /mbti, aby powtórzyć test.",
  ...
  "success": {
    ...
    "success2": "🎉 **Weryfikacja zakończona pomyślnie!**\n\n✅ Zdobyto **+${ad.reward_quota} stałego kwoty**\n💎 Dziękujemy za dołączenie do naszej społeczności!\n\n📊 **Twoja kwota:**\n• Podstawowa kwota: ${user.is_vip ? 'Nieograniczona' : '10'}/dzień\n• Stała kwota: +${ad.reward_quota}\n\n💡 W społeczności możesz:\n• Komunikować się z innymi użytkownikami\n• Uzyskiwać najnowsze aktualizacje funkcji\n• Uczestniczyć w działaniach w celu uzyskania większych nagród",
  ...
  "throw": {
    ...
    "mbti7": "• MBTI: {mbti}",
    "mbtiLabel": "• MBTI: {mbti}",
    "message": "B bieżący wybór: ${currentGender === 'male' ? '👨 Mężczyzna' : currentGender === 'female' ? '👩 Kobieta' : '🌈 Każdy'}",
    "message2": "B bieżący wybór: ${currentGender === 'male' ? '👨 Mężczyzna' : currentGender === 'female' ? '👩 Kobieta' : '🌈 Każda'}",
    "message3": "Wybrane: ${selectedZodiac.length > 0 ? selectedZodiac.map((z) => ZODIAC_NAMES[z]).join(",
