...
export const translations: Translations = {
  ...
  "admin": {
    ...
    "message2": "• Zaktualizowano o: ${avatarInfo.avatar_updated_at ? new Date(avatarInfo.avatar_updated_at).toLocaleString('zh-TW') : 'Nieznane'}",
    ...
    "removeCommand": "`/admin_usun <user_id>` `/admin_remove <user_id>`",
  ...
  "analytics": {
    ...
    "message3": "**📈 Ogólny wskaźnik konwersji: ${report.overall_conversion_rate.toFixed(1)}%**",
  ...
  "common": {
    ...
    "close": "❌ Zamknij",
    "complete": "🎉 **Oglądanie reklam zakończone!**\n\n✅ Uzyskano **+1 kwotę**\n📊 Dzisiaj obejrzano: **${updated.ads_watched}/20** razy\n🎁 Uzyskana kwota dzisiaj: **${updated.quota_earned}**\n📈 Pozostałe wyświetlenia: **${result.remaining_ads}** razy\n\n${result.remaining_ads > 0 ? '💡 Kontynuuj oglądanie reklam, aby zdobyć więcej kwot!' : '✅ Osiągnięto dzienny limit reklam'}",
    ...
    "register": "💡 To jest szybki test (${testInfo}), wyniki są tylko do celów informacyjnych.\nPo rejestracji możesz powtórzyć test za pomocą /mbti.",
    ...
    "start5": "Start: ${startTime.toLocaleString(\",\n\n✅ Weryfikacja potrzebna: Kliknij przycisk 'Weryfikuj' po dołączeniu do grupy/kanalu",
    ...
    "text16": "✅ Wymagana weryfikacja: Kliknij przycisk 'Weryfikuj' po dołączeniu do grupy/kanału",
  ...
  "mbtiTest": {
    ...
    "quickTestInfo": "💡 To jest szybki test ({questions}), wynik jest tylko do informacji.\nPo zakończeniu rejestracji możesz użyć /mbti, aby powtórzyć test.",
  ...
  "officialAd": {
    ...
    "requiresVerification": "✅ Wymagana weryfikacja: Kliknij przycisk 'Weryfikuj' po dołączeniu do grupy/kanalu",
  ...
  "throw": {
    ...
    "gender5": "👤 Filtr płci",
    "genderLabel": "• Płeć: {gender}\n",
    "mbti": "• MBTI: ${selectedMBTI.length > 0 ? selectedMBTI.join(', ') : 'Brak limitu'}",
    "mbti2": "Wybrane: ${selectedMBTI.length > 0 ? selectedMBTI.join(', ') : 'Brak'}",
    "mbti3": "Wybrane: ${selectedMBTI.length > 0 ? selectedMBTI.join(",
    "mbti4": "🧠 **Filtr MBTI**\n\n",
  ...
  "vip": {
    ...
    "refundAdminCommands": "Czas ważności: ${expireDate} <ID> `/admin_approve_refund <ID>` `/admin_reject_refund <ID> <przyczyna>` `/admin_reject_refund <ID> <原因>`",
  ...
  "warnings": {
    ...
    "BROADCAST": {
      "FILTER_ERROR": "❌ Błąd formatu.\nPrzykład: `/broadcast_filter gender=female,country=TW test message` `/broadcast_filter gender=female,country=TW 測試訊息`",
