...
export const translations: Translations = {
  ...
  "admin": {
    ...
    "message2": "• Last updated: ${avatarInfo.avatar_updated_at ? new Date(avatarInfo.avatar_updated_at).toLocaleString('zh-TW') : 'Unknown'}",
  ...
  "bottle": {
    ...
    "catch": {
      ...
      "catch": "📊 Caught today: \\${newCatchesCount}/\\${quota}",
  ...
  "common": {
    ...
    "close": "❌ Close",
    "complete": "🎉 **Ad view completed!**\n\n✅ Earned **+1 quota**\n📊 Ads viewed today: **${updated.ads_watched}/20** times\n🎁 Quotas earned today: **${updated.quota_earned}**\n📈 Remaining views: **${result.remaining_ads}** times\n\n${result.remaining_ads > 0 ? '💡 Continue watching ads to earn more quotas!' : '✅ Daily ad limit reached'}",
    ...
    "newUser": "New user",
    "next": "Next Page",
    "nickname": "💡 Please enter a simple nickname, do not include links such as http:// or https://.",
  ...
  "menu": {
    ...
    "levelVip": "💎 VIP Member",
    "message": "https://t.me/share/url?url=https://t.me/${botUsername}?start=invite_${inviteCode}&text=Come to XunNi to throw message bottles together! 🍾 Use my invitation code to join, and we can both get more quotas! https://t.me/share/url?url=https://t.me/${botUsername}?start=invite_${inviteCode}&text=來",
    "message2": "https://t.me/share/url?url=https://t.me/${botUsername}?start=invite_${inviteCode}&text=Come to XunNi to throw message bottles together! https://t.me/share/url?url=https://t.me/${botUsername}?start=invite_${inviteCode}&text=來",
    "notRegistered": "Not Registered",
    "notSet": "Not Set",
  ...
  "profile": {
    ...
    "message": "https://t.me/share/url?url=https://t.me/${botUsername}?start=invite_${inviteCode}&text=Come to XunNi to throw message bottles together! 🍾 Use my invitation code: ${inviteCode} https://t.me/share/url?url=https://t.me/${botUsername}?start=invite_${inviteCode}&text=來",
    ...
    "message7": "https://t.me/share/url?url=https://t.me/${botUsername}?start=invite_${inviteCode}&text=Come to XunNi to throw message bottles together! https://t.me/share/url?url=https://t.me/${botUsername}?start=invite_${inviteCode}&text=來",
  ...
  "tasks": {
    ...
    "bottle2": "Reward: +${task.reward_amount} message bottles (the ${task.reward_type ===",
  ...
  "throw": {
    ...
    "vip7": "✨ VIP privileges activating\n",
    "zodiac": "• Zodiac Sign: ${selectedZodiac.length > 0 ? selectedZodiac.map((z) => ZODIAC_NAMES[z]).join(', ') : 'Unlimited'}",
    "zodiac2": "⭐ Zodiac: ${matchResult.user.zodiac ||",
    "zodiac3": "⭐ Zodiac: ${user.zodiac_sign ||",
    "zodiac4": "⭐ **Zodiac filter**\n\n",
  ...
  "vip": {
    ...
    "refundAdminCommands": "💡 Use the following commands to handle:\n• Approve: `/admin_approve_refund <ID>`\n• Reject: `/admin_reject_refund <ID> <reason>` `/admin_reject_refund <ID> <原因>`",
