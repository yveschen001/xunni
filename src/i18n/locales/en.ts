...
export const translations: Translations = {
  ...
  admin: {
    ...
    banSuccess:
      '✅ User {userId} ({nickname}) has been banned\n\nBan duration: {duration}\nUnban time: {unbanTime}',
    ...
    diagnose: {
      ...
      historyPostsHint:
        '💡 Conversation history posts are created only when there are new messages',
    ...
    message:
      "• Updated at: ${new Date(post.updated_at).toLocaleString('zh-TW', { month: '2-digit', day: '2-digit', hour: '2-digit', minute: '2-digit' })}\n\n",
    ...
    message2:
      "• Update time: ${avatarInfo.avatar_updated_at ? new Date(avatarInfo.avatar_updated_at).toLocaleString('en-US') : 'Unknown'}",
    ...
    message40:
      "• Update time: ${new Date(post.updated_at).toLocaleString('en-US', { month: '2-digit', day: '2-digit', hour:",
  ...
  appeal: {
    ...
    reasonTooLong:
      '❌ The reason for the appeal is too long, please keep it within 500 characters.',
    reasonTooShort:
      '❌ The reason for the appeal is too short, please enter at least 10 characters.',
  ...
  block: {
    ...
    ensureReply:
      'Please ensure you are replying to the message sent by the other party (marked with a # identifier).',
  ...
  bottle: {
    ...
    cancelled: '❌ Canceled ${zodiac}',
      ...
      banned:
        '❌ Your account has been banned and cannot pick up message bottles.\n\nFor any questions, please use /appeal to appeal.',
      ...
      bottleTaken:
        '❌ This message bottle has already been picked up by someone else, please try other message bottles!',
      catch: "📊 Today's catches: \\${newCatchesCount}/\\${quota}",
      conversation:
        'An anonymous conversation has been created for you, come and start chatting!\n\n',
      ...
      notRegistered:
        '❌ Please complete the registration process before picking up message bottles.\n\nUse /start to continue registration.',
      ...
      text6:
        '💬 Translation service is temporarily experiencing issues, backup translation has been used\n',
      ...
      translationServiceFallback:
        '💬 Translation service is temporarily experiencing issues, fallback translation used',
      translationServiceUnavailable:
        '⚠️ Translation service is temporarily unavailable, below is the original text',
      unknown: 'Unknown',
    ...
    inappropriate:
      'Message bottle content contains inappropriate content, please modify and resubmit',
    ...
    throw: {
      ...
      gender:
        "• Gender: \\${selectedGender === 'male' ? '👨 Male' : selectedGender === 'female' ? '👩 Female' : '🌈 Any'}",
      ...
      message2:
        "Current selection: \\${currentGender === 'male' ? '👨 Male' : currentGender === 'female' ? '👩 Female' : '🌈 Any'}",
      message3:
        'Selected: \\${selectedZodiac.length > 0 ? selectedZodiac.map((z) => ZODIAC_NAMES[z]).join(',
      message4: 'Current selection: \\${bloodTypeDisplay[currentBloodType]}\n\n',
      message5: '👤 Partner: \\${vipMatchInfo.matcherNickname}\n',
      message6:
        '"Hello! I\'m someone who loves music and movies, hoping to meet like-minded friends!"\n\n',
      ...
      zodiac:
        "• Zodiac: \\${selectedZodiac.length > 0 ? selectedZodiac.map((z) => ZODIAC_NAMES[z]).join(', ') : 'No Limit'}",
    ...
    tips: '💡 Tip:',
    tooLong:
      'Message bottle content is too long, maximum ${max} characters allowed (currently ${current} characters)',
    tooShort:
      'Message bottle content is too short, at least ${min} characters required (currently ${current} characters)',
  },
  broadcast: {
    ...
    filter: {
      ...
      invalidAgeMinMax:
        'Invalid age range: {value} (minimum age cannot be greater than maximum age)',
      invalidAgeRange: 'Invalid age range: {value} (age must be between 18-99)',
      invalidCountry:
        'Invalid country code: {value} (must be 2 uppercase letters, e.g., TW, US, JP)',
    ...
    filterCreatedSending:
      'The broadcast will be sent in the background, use /broadcast_status {id} to check the progress.',
    ...
    maxUsersExceeded:
      '❌ The current broadcast system only supports broadcasts to ${max} users or less.\n\nTarget user count: ${current}',
    ...
    upgradeRequired:
      'Large-scale broadcasting requires system architecture upgrade, please refer to BROADCAST_SYSTEM_REDESIGN.md',
    usageError: '❌ Incorrect usage\n\n',
  ...
  buttons: {
    ...
    bottleTaken:
      '❌ This message bottle has already been picked up by someone else; please try another bottle!',
    ...
    translationServiceFallback:
      '💬 Translation service is temporarily having issues, fallback translation is in use',
    translationServiceUnavailable:
      '⚠️ Translation service is temporarily unavailable, below is the original text',
    unknown: 'Unknown',
  ...
  channelMembership: {
    ...
    oneTimeReward:
      "💡 This is a one-time reward, it will be added to today's quota after claiming.",
  ...
  common: {
    ...
    bloodTypeO: '🩸 Type O',
    bottle:
      'The message bottle content is too short, at least ${MIN_BOTTLE_LENGTH} characters required (currently ${trimmedContent.length} characters)',
    ...
    bottle14:
      'The message bottle content contains inappropriate content, please modify it and resubmit.',
    ...
    bottle2:
      'The message bottle content is too long, up to ${MAX_BOTTLE_LENGTH} characters allowed (currently ${content.length} characters)',
    ...
    bottle3: '• message bottle: ${bottlesCount?.count }',
    ...
    bottle4:
      'An anonymous message bottle social platform, helping you find like-minded friends through MBTI and zodiac signs\n\n',
    bottle5:
    ...
    bottle9:
      "Check out others' message bottles and reply if you're interested to start chatting\n\n",
    broadcast:
      'Broadcast will be sent in the background, use /broadcast_status ${broadcastId} to check progress.',
    ...
    broadcast2:
      'Large-scale broadcasts require system architecture upgrades, please refer to BROADCAST_SYSTEM_REDESIGN.md',
    ...
    conversation:
      '📨 ${formatIdentifier(conv.identifier)} conversation (${conv.message_count} messages)\n',
    ...
    conversation6:
      'Your avatar cache has been refreshed. The latest avatar will display next time you view conversation history.\n\n',
    conversation7:
      '💡 To protect privacy and security, only plain text messages are allowed in conversations.\n\n',
    conversation8: 'Use /history to view all conversations\n\n',
    conversation9: '🔄 Refreshing all conversation history...\n\n',
    country:
      'Invalid country code: ${trimmedValue} (must be 2 uppercase letters, e.g., TW, US, JP)',
    ...
    message23:
      "💡 Please long press the message you want to reply to, select 'Reply' from the menu that appears, and enter your reply in the chat box.",
    ...
    message32:
      'Commander - Bold, imaginative, and strong-willed leaders who always find or create solutions.',
    message33: '💡 Use /broadcast_status <id> to view details',
    message34: '🏷️ Interest tags: ${updatedUser.interests ||',
    message35:
      'Governor - Compassionate, popular, and helpful individuals who are always eager to contribute to the community.',
    message36: '/broadcast_filter <filter> <message content>',
    message37: '**Message Content:**\n${broadcastMessage}',
    message38: '• Total messages: ${stats.total_messages}',
    message39:
      'Campaigner - Passionate, creative, and social free spirits who always find a reason to smile.',
    message4:
      '💡 Use /history ${formatIdentifier(conversations[0].identifier)} to view the full conversation',
    message40: 'Remaining time: ${remaining.remainingText}\n',
    message41:
      'Performer - Spontaneous, energetic, and enthusiastic individuals who never make life boring.',
    ...
    message48:
      'Entrepreneur - Smart, energetic, and insightful individuals who truly enjoy living on the edge.',
    ...
    message54:
      '• If you changed your Telegram profile picture, the system will automatically detect it\n',
    ...
    message59:
      'Guardian - Highly focused and warm protectors, always ready to safeguard their loved ones.',
    message6:
      '• Impressions: ${stats.total_views} | Clicks: ${stats.total_clicks} (${stats.ctr}%)\n',
    message60:
      'Explorer - A flexible and charming artist, always ready to explore and experience new things.',
    ...
    newUser: 'New user',
    next: 'Next Page',
    nickname: '💡 Please enter a simple nickname without including links like http:// or https://.',
    ...
    register:
      '💡 This is a quick quiz (${testInfo}), and the results are for reference only.\nAfter completing registration, you can retake the quiz using /mbti.',
    register10: '🎉 Congratulations on completing registration!\n\n',
    register2:
      '💡 This is a complete test (${testInfo}), and the results will be more accurate.\nAfter completing registration, you can use /mbti to retake the test.',
    ...
    text13:
      '💡 This will be displayed on your profile card to help other users understand you better.\n',
    ...
    text16: "✅ Verification needed: Click the 'Verify' button after joining the group/channel",
    ...
    text22:
      'Write down your feelings or thoughts, and the system will help you find the right person\n\n',
    text23:
      'Logistics Specialist - A practical and fact-focused individual with unquestionable reliability.',
  ...
  conversation: {
    ...
    anonymousCardHint:
      '💡 This is an anonymous profile card and will not display the true identity information of others.',
    ...
    conversation3:
      "💡 Click the 'Reply' button on the other party's message to continue the conversation\n",
    ...
    report2:
      "💡 This will not report the other party, it's just that you don't want to chat anymore.",
  ...
  country: {
    ...
    confirmHint:
      '💡 This will be displayed on your profile card to help other users get to know you better. \n',
  ...
  error: {
    ...
    bottle2:
      '❌ Your account has been banned and you cannot pick message bottles.\n\nIf you have questions, please use /appeal to appeal.',
    bottle3:
      '❌ This message bottle has already been picked up by someone else, please try another bottle!',
    broadcast:
      '❌ The current broadcast system only supports broadcasts for up to ${MAX_SAFE_USERS} users.\n\n',
    broadcast2: '❌ Broadcast ID must be a number.',
    broadcast3: '❌ Broadcast record not found.',
    cancel:
      '❌ Nickname is too long, please enter a nickname with no more than 36 characters.\n\nPlease re-enter or cancel editing:',
    cancel2:
      '❌ Personal profile is too long, please enter no more than 200 characters.\n\nPlease re-enter or cancel editing:',
    cancel3:
      '❌ Location name is too long, please enter no more than 50 characters.\n\nPlease re-enter or cancel editing:',
    cancel4:
      '❌ Nickname is too short, at least 4 characters are required.\n\nPlease re-enter or cancel editing:',
    cancel5:
      '❌ Each tag can have a maximum of 20 characters.\n\nPlease re-enter or cancel editing:',
    ...
    failed2:
      '❌ Failed to create filtered broadcast\n${error instanceof Error ? error.message : String(error)}',
    failed20: '❌ Confirmation failed.',
    failed21: '❌ Setting failed.',
    failed22: '❌ Skip failed.',
    failed23: '❌ Operation failed.',
    failed24:
      '❌ Failed to send daily report: ${error instanceof Error ? error.message : String(error)}',
    ...
    failed3:
      '❌ Failed to process broadcast queue: ${error instanceof Error ? error.message : String(error)}',
    ...
    failed4:
      '❌ Failed to query broadcast status: ${error instanceof Error ? error.message : String(error)}',
    failed40: '❌ Submission failed, please try again later.',
    failed41: '❌ Failed to create chat, please try again later.',
    failed5:
      '❌ Failed to cancel broadcast: ${error instanceof Error ? error.message : String(error)}',
    failed6:
      '❌ Failed to clear broadcast: ${error instanceof Error ? error.message : String(error)}',
    ...
    message4:
      "❌ Sorry, you must be at least 18 years old to use this service.\n\nPlease come back when you're of age!",
    ...
    quota:
      "❌ Today's message bottle quota has been used up (${quotaDisplay})\n\n💡 Ways to gain more quota: \n",
    quota2:
      "❌ Today's conversation message quota has been used up (${usedToday}/${dailyLimit})\n\n",
    ...
    register3:
      '❌ You must complete the registration process to pick up message bottles.\n\nUse /start to continue registration.',
  ...
  errors: {
    ...
    error: {
      ...
      bottle2:
        '❌ Your account has been banned and you cannot pick up Drift Bottles.\n\nIf you have questions, please use /appeal to appeal.',
      bottle3:
        '❌ This bottle has already been picked up by someone else. Please try other bottles!',
      broadcast:
        '❌ The current broadcasting system only supports broadcasting to \\${MAX_SAFE_USERS} users or fewer.\n\n',
      broadcast2: '❌ Broadcast ID must be a number',
      broadcast3: '❌ Broadcast record not found',
      cancel:
        '❌ Nickname too long, please enter a nickname no more than 36 characters.\n\nPlease re-enter or cancel the edit:',
      cancel2:
        '❌ Personal profile too long, please enter no more than 200 characters.\n\nPlease re-enter or cancel the edit:',
      cancel3:
        '❌ Region name too long, please enter no more than 50 characters.\n\nPlease re-enter or cancel the edit:',
      cancel4:
        '❌ Nickname too short, at least 4 characters required.\n\nPlease re-enter or cancel the edit:',
      ...
      cancel9: '❌ Cancel',
      conversation:
        '❌ Conversation with identifier \\${formatIdentifier(identifier)} not found\n\n',
      ...
      message3:
        '❌ An error occurred, please try again later.\n\nError message: \\${error instanceof Error ? error.message : String(error)}',
      message4:
        "❌ We're sorry, you must be at least 18 years old to use this service.\n\nPlease come back when you're an adult!",
      ...
      register2: '❌ User data not found, please use /start to register first.',
      register3:
        '❌ You must complete the registration process to pick up a message bottle.\n\nUse /start to continue the registration.',
      settings:
        '❌ You can set a maximum of 5 interest tags.\n\nPlease re-enter or cancel editing:',
      short: '❌ Invalid language code',
      short10: '❌ Insufficient permissions',
      ...
      text16: '❌ Duration must be a positive integer or',
      text17:
        '❌ A system error occurred while processing the payment, please contact customer support.\n\n',
      text18: '❌ The refund reason must be at least 10 characters, please re-enter:',
  ...
  history: {
    ...
    noHistory:
      '💬 You have no conversation history yet\n\nGo throw a message bottle to meet new friends! /throw\n\n🏠 Return to Main Menu: /menu',
  ...
  invite: {
    ...
    upgradePrompt: '💎 Upgrade to VIP for more invitation slots',
    userType: '{type}',
  },
  maintenance: {
  ...
  mbti: {
    ...
    share: {
      welcome:
        '👋 Your friend invites you to take the MBTI test!\n\nCome and see your personality type～',
  ...
  mbtiTest: {
    ...
    fullTestInfo:
      '💡 This is the complete test ({questions}), and the results are more accurate.\nAfter completing registration, you can retake the test using /mbti.',
    ...
    quickTestInfo:
      '💡 This is a quick quiz ({questions}), and the results are for reference only.\nAfter completing registration, you can retake the quiz via /mbti.',
  ...
  menu: {
    ...
    levelVip: '💎 VIP Member',
    message:
      "Let's throw message bottles together on XunNi! 🍾 Use my invite code to join, and we can both get more quotas!",
    message2:
      'https://t.me/share/url?url=https://t.me/${botUsername}?start=invite_${inviteCode}&text=Come to XunNi and throw a message bottle together ',
    notRegistered: 'Not Registered',
    notSet: 'Not Set',
  ...
  nickname: {
    ...
    genderHint:
      '⚠️ Note: Gender selection cannot be changed after it is set, please choose carefully!',
  ...
  officialAd: {
    ...
    claimRewardSuccess:
      '✅ Reward claimed successfully! You have received +{quota} permanent quotas!',
  ...
  onboarding: {
    ...
    agreeTerms:
      'Click the button below to indicate that you have read and agreed to the above terms.',
    antiFraud: {
    ...
    antiFraudQuestions:
      'To protect the safety of all users, please confirm that you understand the following: \n\n',
    antiFraudYes: '✅ Yes, I understand and will pay attention to safety',
    back: '⬅️ Back',
    birthday:
      'If you believe this is an error, please check if your birthday format is correct (YYYY-MM-DD).',
    ...
    birthdayCheck:
      'If you think this is an error, please check if your birthday format is correct (YYYY-MM-DD).',
    birthdayError: '❌ {error}',
    birthdayFormatError: '❌ Birthday format is incorrect\n\nPlease re-enter (format: YYYY-MM-DD):',
    birthdayRetry: 'Please re-enter your birthday (format: YYYY-MM-DD):',
    birthdayWarning:
      "⚠️ The birthday cannot be modified after setting, please confirm it's correct!",
    bloodType: {
    ...
    confirm:
      "To protect all users' safety, please confirm that you understand the risks of online dating.\n\n",
    ...
    settings:
      '💡 Tip: You can use the /mbti command at any time to set or test your MBTI type.\n\n',
    ...
    understandRisks:
      'To protect the safety of all users, please confirm that you understand the risks of online dating.\n\n',
  ...
  profile: {
    ...
    completeOnboarding:
      '⚠️ Please complete the registration process first.\n\nUse /start to continue registration.',
    conversation:
      '💡 This is the data card you display to the other person in the conversation\n\n',
    ...
    message:
      'https://t.me/share/url?url=https://t.me/${botUsername}?start=invite_${inviteCode}&text=Come to XunNi to throw message bottles together! 🍾 Use my invitation code: ${inviteCode}',
    ...
    message7:
      'https://t.me/share/url?url=https://t.me/${botUsername}?start=invite_${inviteCode}&text=Come join XunNi and toss a message bottle ',
    ...
    success:
      '💡 For each successful invitation of 1 person, your daily quota increases by +1 permanently\n',
  ...
  report: {
    ...
    conversationNotFound:
      '⚠️ This conversation cannot be found\n\nThe conversation may have ended or does not exist.',
    ensureReply:
      'Please ensure you are replying to the message sent by the other party (with the # identifier).',
    ...
    reasonSpam: '📢 Spam',
    replyRequired:
      '⚠️ Please long press the message you want to report and then reply with the command\n\n',
  ...
  session: {
    ...
    timeoutOnboarding:
      '⏰ Registration process has timed out\n\nPlease use /start to restart registration.',
    timeoutThrowBottle:
      '⏰ Message bottle throwing process has timed out\n\nPlease use /throw to restart.',
  ...
  stats: {
    ...
    register:
      "📅 **Registration time**: ${new Date(user.created_at).toLocaleDateString('zh-TW')}\n",
  ...
  success: {
    ...
    verify2:
      '✅ Verification Successful! You have received +\\${ad.reward_quota} permanent credits!',
  ...
  tasks: {
    ...
    description: {
      ...
      invite_progress:
        'For each person invited, permanent daily quota +1 (free for up to 10 people, VIP up to 100 people)',
    ...
    message2:
      'Click the button below to join the XunNi official channel for the latest news and events!\n\n',
    name: {
  ...
  throw: {
    ...
    message6:
      '"Hello! I am someone who loves music and movies, hoping to meet like-minded friends～"',
    ...
    vip7: '✨ VIP privileges activating\n',
    zodiac:
      "• Zodiac: ${selectedZodiac.length > 0 ? selectedZodiac.map((z) => ZODIAC_NAMES[z]).join(', ') : 'No restriction'}",
    zodiac2: '⭐ Zodiac: ${matchResult.user.zodiac ||',
    zodiac3: '⭐ Zodiac: ${user.zodiac_sign ||',
    zodiac4: '⭐ **Zodiac filter**\n\n',
  ...
  tutorial: {
    ...
    howToBecomeFriendsDesc:
      'You pick up a bottle and reply → They reply too → Start anonymous chatting',
    ...
    whatIsXunNiDesc:
      'An anonymous message bottle social platform that helps you find like-minded friends through MBTI and zodiac signs.',
  },
  vip: {
    admin:
      '⏳ You have a pending refund request. Please wait patiently for the admin to review it.',
    bottle:
      "📝 Message bottle content: ${bottle.content.substring(0, 50)}${bottle.content.length > 50 ? '...' : ''}\n\n",
    bottle2:
      '📝 Message bottle content: ${bottle.content.substring(0, 50)}${bottle.content.length > 50 ?',
    ...
    conversation2:
      '🔄 Updating your conversation history, clear avatar will be displayed soon...\n\n',
    ...
    message12:
      "💬 **Please long press this message, select 'Reply', and enter your content to start chatting with the other party**",
    ...
    refundRejected:
      '❌ **Refund application has been rejected**\n\nReason: ${reason}\n\nIf you have any questions, please contact customer support.',
    refundRejectedAdmin:
    ...
    reminderGracePeriod:
      '📌 Grace period: Renewal within 3 days after expiration will not interrupt service.',
    ...
    text9:
      '📌 Grace Period: Service will not be interrupted if renewed within 3 days after expiration.',
  ...
  vipTripleBottle: {
    ...
    replyHint:
      "💬 **Please long press this message, select 'Reply', and enter content to start chatting with the other party**",
  ...
  warnings: {
    ...
    warning: {
      ...
      message3: '⚠️ Please long-press the message you want to block and reply with the command\n\n',
      message4:
        '⚠️ Please long-press the message you want to report and reply with the command\n\n',
      message5: '⚠️ **Message contains prohibited links**\n\n',
    ...
    BROADCAST: {
      ...
      TOO_MANY_USERS:
        '⚠️ Too many target users ({count} people), currently limited to sending to {max} people at once.',
      START_SENDING:
        '🚀 Starting broadcast #{id}\n🎯 Target: {filters}\n👥 Number of people: {count}',
      COMPLETED:
        '✅ Broadcast #{id} completed!\nSuccess: {sent}\nFailed: {failed}\nBlocked: {blocked}',
    },
    push: {
      throwReminder:
        '🌊 Hey! It’s been a while since you tossed a message bottle, the beach is very quiet...',
      catchReminder:
        '🎣 Some new message bottles have washed up at the beach, want to go check them out?',
      onboardingReminder:
        "👋 Your registration is not yet complete, you're almost there! (Step: {step})",
      messageReminderA:
        "👋 Hey {masked_partner_name} is still waiting for your reply! Don't let the conversation cool down～",
      messageReminderB:
        '📩 You have an unread message from {masked_partner_name}:\n> "{last_message_preview}..."\n(It has been over 24 hours!)',
    ...
    match: {
      ...
      reason: {
        zodiac: {
          fire_affinity:
            'As fellow fire signs, your passion burns bright and your connection is strong!',
          earth_affinity:
            'The stability of earth signs combined with the gentleness of water signs creates the perfect flow.',
          air_affinity:
            'The agility of air signs meets the passion of fire signs, inspiring endless creativity!',
          water_affinity:
            'The emotions of water signs and the practicality of earth signs build the warmest support.',
        },
        mbti: {
          sj_affinity:
            'Socializers (SJ) and Explorers (SP), a perfect complement of stability and excitement!',
          sp_affinity:
            'Explorers (SP) and Socializers (SJ), the best partners of playmates and caretakers!',
          nf_affinity: 'Idealists (NF) and Rationalists (NT), a deep collision of soul and wisdom!',
          nt_affinity:
            'Rationalists (NT) and Idealists (NF), a resonance of thoughts and feelings!',
        },
        blood: {
          a_affinity:
            "Type A's meticulousness meets Type O's tolerance, creating the most comfortable interactions.",
          b_affinity:
            "Type B's self-assertion meets Type O's easygoing nature, stress-free and relaxed.",
  ...
  push: {
    ...
    actionReply: '💬 Reply to {masked_partner_name}',
    throwReminder:
      "🌊 Hey! It's been a while since you tossed a message bottle, the beach is so quiet...",
    catchReminder: '🎣 Some new bottles have drifted to the shore, want to take a look?',
    onboardingReminder:
      '👋 Your registration is not yet complete, just a little bit more! (Step: {step})',
    messageReminderA:
      "👋 Hey {masked_partner_name}, we're still waiting for your reply! Don't let the conversation go cold～",
    messageReminderB:
