export default {
  ...
  "mbti": "🎯 تصفية دقيقة للعثور على الشخص المناسب\n• عند إرسال زجاجة رسائل، يمكنك تحديد نوع MBTI، علامة الأبراج، وفصيلة الدم للشخص المستلم.\nفي بحر الناس الواسع، حدّد بدقة نوعك المثالي.",
  ...
  "quota": "• حصة يومية من 30 زجاجة البركة (يمكن لدعوة الأصدقاء زيادة هذا العدد، حتى 100 يومياً)",
  "quota2": "• حصة يومية من 30 زجاجة البركة (حتى 100 يومياً)",
  ...
  "text": "- يفضل استخدام نموذج ترجمة OpenAI GPT (جودة عالية)\n🔮 امتيازات الأبراج الذكية\nالوصول اليومي المجاني لفتح تفاصيل الحظ (للمستخدمين العاديين مرة واحدة في الأسبوع).\nالحصول على تقارير تحليل مفصل للمسيرة المهنية والاهتمامات.\n🚫 تجربة خالصة\nتجربة خالية تمامًا من الإعلانات.",
  ...
  "text14": "└ 1 مطابقة ذكية + 2 زجاجة البركة بركة عامة تعرض: يضيف 2 نقطة عرض إضافية، في انتظار الأشخاص المحظوظين لالتقاطها.\nزيادة فرصة رؤية زجاجتك بنسبة 300%!",
  ...
  "vip6": "اشترك في عضوية XunNi VIP (شراء لمرة واحدة)",
