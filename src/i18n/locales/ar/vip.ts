export default {
  ...
  "text14": "└ 1 تطابق ذكي + 2 زجاجة رسائل عامة في مجموعة العرض: مكانان إضافيان للعرض، في انتظار شخص مقدر له أن يلتقطهما.\nزيادة فرص رؤية زجاجة رسالتك بنسبة 300%!",
  ...
  "benefit_daily_fortune": "• 1 قراءة تنجيم بالذكاء الاصطناعي مجانية يومياً (حصرياً لأعضاء VIP)"
};
