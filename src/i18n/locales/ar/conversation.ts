export default {
  ...
  "backToMenuCommand": "🏠 القائمة الرئيسية",
  ...
  "blockSuccessMessage": "تم حظر الطرف الآخر، لن يتم مطابقتكما مرة أخرى.\n\n💡 هل ترغب في بدء محادثة جديدة؟\n• استخدم التقاط زجاجة البركة جديدة",
  "blockSuccessNewConversation": "💬 **انتهت المحادثة**\n\nأنهى الطرف الآخر هذه المحادثة.\n\n💡 هل ترغب في بدء محادثة جديدة؟\n• استخدم التقاط زجاجة البركة جديدة",
  "blockSuccessTitle": "✅ **تم حظر المستخدم**",
  "blocked": "✅ محظور",
  "bloodType": "🩸 فصيلة الدم: {partnerInfo.bloodType}\n",
  "bloodType2": "🩸 فصيلة الدم: {bloodTypeText}\n",
  "bottle": "استخدم /catch لالتقاط زجاجة البركة وبدء دردشة سعيدة!",
  "bottle2": "• استخدم /catch لالتقاط زجاجة البركة جديدة",
  "cancelButton": "❌ إلغاء",
  ...
  "conversationEnded": "❌ هذه المحادثة قد انتهت.\n\nاستخدم التقاط زجاجة البركة لبدء محادثة جديدة.",
  "conversationInfoError": "❌ معلومات المحادثة غير صحيحة.",
  "editProfileCommand": "✏️ تحرير الملف الشخصي: /edit_profile",
  "endedMessage": "أنهى الطرف الآخر هذه المحادثة.\n\n💡 هل ترغب في بدء محادثة جديدة؟\n• استخدم التقاط زجاجة البركة جديدة",
  ...
  "reportSuccessMessage": "شكرًا على بلاغك، سنقوم بمراجعته في أقرب وقت ممكن.\n\n💡 هل ترغب في بدء محادثة جديدة؟\n• استخدم التقاط زجاجة البركة جديدة",
  ...
  "settings5": "غير محدد",
  "short": "بعد الحظر:\n",
  "selectNumber": "يرجى النقر على الرقم المناسب أدناه للاطلاع على التفاصيل:",
  ...
  "historyPost": "📜 تاريخ المحادثة #{id}",
  "historyPostSuffix": " (انقر للاطلاع على التفاصيل)",
  "newMessageNotification": "📩 لديك رسالة جديدة!",
  "newMessageNotificationSuffix": " (من {sender})",
  "replyToUser": "رد على المستخدم"
};
