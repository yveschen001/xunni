export default {
  ...
  "example": {
    "birthday": "على سبيل المثال: 2000-12-25"
  },
  "gender": {
    "female": "أنثى",
    "label": "• الجنس: {gender}\n",
  ...
  "info": {
    "age18": "• يجب أن تكون على الأقل 18 عامًا لاستخدام هذه الخدمة\n- لتتمكن من استخدام المطابقة وقراءة الطالع، يجب تقديم معلومات دقيقة للحصول على نتائج جيدة.\n\n- أدخل تاريخ ميلادك (مثل: 2000-12-15)",
    "city": "🌍 المنطقة: {city}"
  },
  ...
  "notCompleted": "⚠️ يرجى إكمال عملية التسجيل أولاً.",
  ...
  "stepBirthday": "📅 الرجاء إدخال تاريخ ميلادك (التنسيق: YYYY-MM-DD، مثل: 2000-12-25)",
  ...
  "terms": {
    "agree_button": "✅ أوافق",
    "english_only_note": "📋 المستندات القانونية متاحة باللغة الإنجليزية فقط.",
  ...
  "vip": "💡 يمكن استخدام إدخال فصيلة دمك في ميزات مطابقة فصيلة الدم المستقبلية (ميزات إضافية، مطابقة فلكية)",
  "warning": {
