export default {
  ...
  "bottle3": "• يمكنك أن ترسل وتلتقط عدد محدود من زجاجات البركة يوميًا\n",
  ...
  "bottle7": "/throw - أرسل زجاجة البركة",
  "bottle8": "/catch - استلم زجاجة البركة",
  "bottle9": "🍾 **نظام زجاجة البركة**\n",
  ...
  "message8": "/بث <message> - بث لجميع المستخدمين",
  "profile": "/edit_profile - تعديل الملف الشخصي\n",
  "profile2": "/profile - عرض الملف الشخصي\n",
  "profile3": "👤 **الملف الشخصي**\n",
  "quota": "🔢 الحصة اليومية العالية\n• ابدأ بـ 30 زجاجة البركة يوميًا (فقط 10 للمستخدمين العاديين).\n• يمكن أن يؤدي دعوة الأصدقاء إلى زيادة الحصة بشكل دائم، بحد أقصى إجمالي 100!\n• الحد اليومي هو 100 رسالة محادثة، تواصل بدون حواجز.",
  "quota2": "• الحصة اليومية من 30 زجاجة البركة",
  ...
  "superAdminTitle": "المسؤول الفائق",
  "superAdminMaintenance": "🔧 **صيانة النظام**",
  "superAdminMaintenanceDisable": "• `/maintenance_disable` - تعطيل وضع الصيانة",
  "superAdminMaintenanceEnable": "• `/maintenance_enable <minutes> [reason]` - تمكين وضع الصيانة",
  "devToolsTitle": "🛠️ **أدوات المطورين**",
  "devInfo": "/dev_info - عرض معلومات النظام",
  "devReset": "/dev_reset - إعادة تعيين المستخدم الحالي",
  "devRestart": "/dev_restart - إعادة تشغيل النسخة",
  "devSkip": "/dev_skip - تخطي البرنامج التعليمي",
  "fortune": "/fortune - 🔮 الحظ اليومي وتحليل علم الفلك المتعمق",
  "clearFortune": "/clear_fortune - حذف سجلات الحظ",
  "adminGrantSection": "🔧 **توفير الموارد**",
  "addVip": "/add_vip - تفعيل VIP (30 يومًا)",
  "addBottles": "/add_bottles - إضافة 50 زجاجة الحظ"
};
