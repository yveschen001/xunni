export default {
  ...
  "quota": "🔢 الحصة اليومية العالية\n• ابدأ بـ 30 زجاجة رسائل يوميًا (فقط 10 للمستخدمين العاديين).\n• دعوة الأصدقاء يمكن أن تزيد حصتك بشكل دائم، حتى حد أقصى قدره 100!\n• الحد اليومي من 100 رسالة دردشة، الدردشة بدون حواجز.",
