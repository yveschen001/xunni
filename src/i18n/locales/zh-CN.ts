...
export const translations: Translations = {
  ...
  admin: {
    ...
    message:
      "• 更新时间：${new Date(post.updated_at).toLocaleString('zh-TW', { month: '2-digit', day: '2-digit', hour: '2-digit', minute: '2-digit' })}\n\n",
    ...
    message2:
      "• 更新时间：${avatarInfo.avatar_updated_at ? new Date(avatarInfo.avatar_updated_at).toLocaleString('zh-TW') : '未知'}\n",
    ...
    message40:
      "• 更新时间：${new Date(post.updated_at).toLocaleString('zh-TW', { month: '2-digit', day: '2-digit', hour:",
  ...
  bottle: {
    ...
    throw: {
      ...
      gender:
        "• 性别：\\${selectedGender === 'male' ? '👨 男生' : selectedGender === 'female' ? '👩 女生' : '🌈 任何人'}\n",
      gender2: '👤 **性别筛选**\n\n',
      gender3: '• 性别：筛选性别\n\n',
      gender4: '💡 选择你想要的性别：',
      gender5: '👤 性别筛选',
      ...
      mbtiLabel: '• MBTI：{mbti}',
      message:
        "已选择：\\${selectedZodiac.length > 0 ? selectedZodiac.map((z) => ZODIAC_NAMES[z]).join(', ') : '无'}",
      message2:
        "当前选择：\\${currentGender === 'male' ? '👨 男生' : currentGender === 'female' ? '👩 女生' : '🌈 任何人'}\n\n",
      message3:
        '已选择：\\${selectedZodiac.length > 0 ? selectedZodiac.map((z) => ZODIAC_NAMES[z]).join(',
      ...
      vip7: '✨ VIP 特权启动中\n',
      zodiac:
        "• 星座：\\${selectedZodiac.length > 0 ? selectedZodiac.map((z) => ZODIAC_NAMES[z]).join(', ') : '无限制'}",
  ...
  common: {
    ...
    bloodTypeO: '🩸 O型',
    bottle:
      '瓶子内容太短，至少需要 ${MIN_BOTTLE_LENGTH} 个字符（目前 ${trimmedContent.length} 个字符）',
    ...
    confirm7: '请确认：',
    conversation:
      '📨 ${formatIdentifier(conv.identifier)} 的对话（${conv.message_count} 则讯息）\n',
  ...
  throw: {
    ...
    vip7: '✨ VIP 特权启动中\n',
    zodiac:
      "• 星座: ${selectedZodiac.length > 0 ? selectedZodiac.map((z) => ZODIAC_NAMES[z]).join(', ') : '不限'}",
    zodiac2: '⭐ 星座: ${matchResult.user.zodiac ||',
    zodiac3: '⭐ 星座: ${user.zodiac_sign ||',
    zodiac4: '⭐ **星座筛选**\n\n',
    zodiac5: '• 星座：筛选特定星座\n',
  ...
  vip: {
    ...
    bottle:
      "📝 瓶子内容：${bottle.content.substring(0, 50)}${bottle.content.length > 50 ? '...' : ''}\n\n",
  ...
  warnings: {
    ...
    push: {
      ...
      messageReminderB:
        '📩 你有一条来自 {masked_partner_name} 的未读消息：\n> "{last_message_preview}..."\n（已超过24小时！）',
  ...
  push: {
    ...
    onboardingReminder: '👋 你的注册还没完成，只差一点点了！ (步骤: {step})',
    messageReminderA:
      '👋 Hey {masked_pa​​rtner_name} 还在等你回覆喔！别让对话冷掉了～ {masked_partner_name}',
    messageReminderB:
      '📩 你有一则来自 {masked_pa​​rtner_name} 的未读讯息：\n> "{last_message_preview}..."\n(已经过了 24 小时啰！) {masked_partner_name}',
