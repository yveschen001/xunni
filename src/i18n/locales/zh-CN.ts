...
export const translations: Translations = {
  ...
  "analytics": {
    ...
    "conversionStepsTitle": "[需要翻译自 zh-TW.ts]",
    ...
    "message2": "📊 **每日运营报表**\n📅 日期：{date}\n\n⚠️ **今日还没有数据**\n\n这可能是因为：\n• 系统刚部署，还没有用户活动\n• 今天还没有用户使用 Bot\n• 数据追踪功能尚未启用\n\n💡 **数据何时会出现？ **\n• 需要用户执行以下任一操作：\n - 发送 /start 注册\n - 丢瓶子或捡瓶子\n - 观看广告\n - 购买 VIP\n\n• 建议等待用户开始使用后再查看\n• 或者在测试环境中模拟用户行为",
    "message3": "**📈 总体转化率: ${report.overall_conversion_rate.toFixed(1)}%**",
  ...
  "common": {
    ...
    "catch4": "捡瓶流程",
    "close": "❌ 关闭",
    "complete": "🎉 **广告观看完成！**\n\n✅ 获得 **+1 配额**\n📊 今天观看次数: **${updated.ads_watched}/20** 次\n🎁 今天获得的配额: **${updated.quota_earned}**\n📈 剩余观看次数: **${result.remaining_ads}** 次\n\n${result.remaining_ads > 0 ? '💡 继续观看广告以获得更多配额！' : '✅ 日广告上限已达'}",
    ...
    "message11": "${banHours} ${user.language_pref === 'en' ? '小时' : '小时'}",
    ...
    "message17": "状态: ${maintenance.isActive ? '✅ 正在维护中' : '❌ 不活跃'}",
    ...
    "message26": "• 激活: ${inviteStats?.activated || 0}",
    "message27": "• 待处理: ${inviteStats?.pending || 0}",
    ...
    "message33": "💡 使用 /broadcast_status <id> 查看详情",
    ...
    "quota3": "• 🎁 邀请好友（每人 +1 配额）\n",
    "quota4": "• ✨ 完成任务（获得永久配额）\n",
    "register": "💡 这是一项快速测试 (${testInfo})，结果仅供参考。\n注册后，您可以通过 /mbti 重新测试。",
    "register10": "🎉 恭喜完成注册！\n\n",
    "register2": "💡 这是一项完整测试 (${testInfo})，结果更为准确。\n注册后，您可以通过 /mbti 重新测试。",
  ...
  "help": {
    ...
    "appeal": "/admin_reject <id> [note] - 拒绝申诉",
  ...
  "mbtiTest": {
    ...
    "fullQuestions": "36 题",
    "fullTest": "MBTI 完整测验",
    "fullTestInfo": "💡 这是一个完整的测试（{questions}），结果更为准确。\n完成注册后，你可以使用 /mbti 重新参加测试。",
    "fullTestTitle": "完整测验",
    ...
    "quickQuestions": "12 题",
    "quickTest": "MBTI 快速测验",
    "quickTestInfo": "💡 这是一个快速测试（{questions}），结果仅供参考。\n完成注册后，你可以使用 /mbti 重新参加测试。",
    "quickTestTitle": "快速测验",
  ...
  "menu": {
    ...
    "levelFree": "🆓 免费会员",
    "levelVip": "💎 VIP 会员",
    "message": "https://t.me/share/url?url=https://t.me/${botUsername}?start=invite_${inviteCode}&text=来 XunNi 丢一个漂流瓶！🍾 使用我的邀请码加入，我们都能获得更多配额！ https://t.me/share/url?url=https://t.me/${botUsername}?start=invite_${inviteCode}&text=來 https://t.me/share/url?url=https://t.me/${botUsername}?start=invite_${inviteCode}&text=Come",
    "message2": "https://t.me/share/url?url=https://t.me/${botUsername}?start=invite_${inviteCode}&text=来加入 XunNi 丢一个漂流瓶 https://t.me/share/url?url=https://t.me/${botUsername}?start=invite_${inviteCode}&text=Come https://t.me/share/url?url=https://t.me/${botUsername}?start=invite_${inviteCode}&text=來",
    "notRegistered": "未注册",
    "notSet": "未设置",
    "quota": "• 你们都获得每日配额 +1\n\n",
  ...
  "profile": {
    ...
    "message": "https://t.me/share/url?url=https://t.me/${botUsername}?start=invite_${inviteCode}&text=来 XunNi 丢一个漂流瓶！🍾 使用我的邀请码：${inviteCode} https://t.me/share/url?url=https://t.me/${botUsername}?start=invite_${inviteCode}&text=來 https://t.me/share/url?url=https://t.me/${botUsername}?start=invite_${inviteCode}&text=Come",
    ...
    "message7": "https://t.me/share/url?url=https://t.me/${botUsername}?start=invite_${inviteCode}&text=来XunNi和我们一起投掷漂流瓶 https://t.me/share/url?url=https://t.me/${botUsername}?start=invite_${inviteCode}&text=Come https://t.me/share/url?url=https://t.me/${botUsername}?start=invite_${inviteCode}&text=來",
  ...
  "success": {
    ...
    "success2": "🎉 **验证成功！**\n\n✅ 获得 **+${ad.reward_quota} 永久配额**\n💎 感谢您加入我们的社区！\n\n📊 **您的配额:**\n• 基本配额: ${user.is_vip ? '无限制' : '10'}/天\n• 永久配额: +${ad.reward_quota}\n\n💡 在社区您可以：\n• 与其他用户沟通\n• 获取最新功能更新\n• 参与活动以获得更多奖励",
  ...
  "tasks": {
    ...
    "task2": "📱 **社交媒体任务** (${completedCount}/${socialTasks.length})",
  ...
  "throw": {
    ...
    "mbti7": "🧠 MBTI 筛选",
    "mbtiLabel": "• MBTI: {mbti}",
    "message": "当前选择: ${currentGender === 'male' ? '👨 男性' : currentGender === 'female' ? '👩 女性' : '🌈 任何人'}",
    "message2": "当前选择：${currentGender === 'male' ? '👨 男生' : currentGender === 'female' ? '👩 女生' : '🌈 任何人'}\n\n",
    "message3": "已选择：${selectedZodiac.length > 0 ? selectedZodiac.map((z) => ZODIAC_NAMES[z]).join(",
    "message4": "当前选择：${bloodTypeDisplay[currentBloodType]}\n\n",
    "message5": "👤 对方：${vipMatchInfo.matcherNickname}\n",
  ...
  "vip": {
    ...
    "refundAdminCommands": "过期时间: ${expireDate} <ID> `/admin_approve_refund <ID>` `/admin_reject_refund <ID> ` `/admin_reject_refund <ID> <原因>`",
  ...
  "warnings": {
    ...
    "BROADCAST": {
      "FILTER_ERROR": "❌ 格式错误。\n范例：`/broadcast_filter gender=female,country=TW 测试讯息` ",
      "NO_CONTENT": "❌ 请输入广播内容。",
