export default {
  ...
  "bottle3": "• 每天可以丟出和撿起有限數量的祝福漂流瓶\n",
  "bottle4": "• VIP 用戶：每天 30 個瓶子\n",
  "bottle5": "• 瓶子在 24 小時內有效\n\n",
  "bottle6": "• 免費用戶：每天 3 個瓶子\n",
  "bottle7": "/throw - 丟出祝福漂流瓶\n",
  "bottle8": "/catch - 撿起祝福漂流瓶\n",
  "bottle9": "🍾 **祝福漂流瓶系統**\n",
  ...
  "profile3": "👤 **個人資料**\n",
  "quota": "🔢 每日超高額度\n• 每日 30 個 祝福漂流瓶起步（普通用戶僅 10 個）。\n• 邀請好友可永久增加額度，總最高可達 100 個！\n• 每日 100 則 對話訊息額度，暢聊無阻。\n",
  "quota2": "• 每天 30 個祝福漂流瓶配額\n",
  ...
  "devSkip": "\n/dev_skip - 跳過教學",
  "fortune": "\n/fortune - 🔮 每日運勢與深度命理分析",
  "clearFortune": "\n/clear_fortune - 清除算命記錄",
  "adminGrantSection": "🔧 **資源補給**",
  "addVip": "\n/add_vip - 開通 VIP (30天)",
  "addBottles": "\n/add_bottles - 增加 50 個算命瓶"
};
