export default {
  ...
  "bottle11": "你們將不會再被匹配到對方的祝福漂流瓶。\n\n",
  "bottle12": "你想要送祝福漂流瓶時配對什麼樣的對象？\n\n",
  "bottle13": "使用 /throw 送出祝福漂流瓶開始第一步幸福的聊天吧！",
  "bottle14": "瓶子內容包含不適當的內容，請修改後重新提交",
  "bottle15": "點擊下方按鈕領取獎勵：+1 瓶子\n\n",
  "bottle16": "💡 下次丟祝福漂流瓶時將自動使用此設置。",
  "bottle17": "🌊 送出祝福漂流瓶 - /throw\n",
  "bottle18": "🎣 撿起祝福漂流瓶 - /catch\n",
  "bottle19": "🎉 確認後可獲得 +1 瓶子獎勵！",
  "bottle2": "瓶子內容太長，最多 {MAX_BOTTLE_LENGTH} 個字符（目前 {content.length} 個字符）",
  "bottle20": "✏️ 請輸入新的祝福漂流瓶內容：\n\n",
  "bottle21": "• 使用 /catch 撿新的祝福漂流瓶",
  "bottle22": "• /throw - 丟出祝福漂流瓶\n",
  "bottle23": "• /catch - 撿起祝福漂流瓶\n",
  "bottle24": "• /throw - 丟祝福漂流瓶\n",
  "bottle25": "• /catch - 撿祝福漂流瓶\n",
  "bottle26": "• 發送草稿內容來丟出祝福漂流瓶",
  "bottle27": "📦 **丟出祝福漂流瓶**\n",
  "bottle28": "🎣 **撿起祝福漂流瓶**\n",
  "bottle29": "💡 完成任務可獲得額外祝福漂流瓶",
  ...
  "bottle33": "丟出第一個瓶子",
  "bottle34": "撿起第一個瓶子",
  "bottle4": "匿名祝福漂流瓶交友平台，透過彼此祝福，以及 MBTI 和星座幫你找到志同道合屬性合適的朋友\n\n",
  "bottle5": "⏰ 對話已超時\n\n對方可能已離開。使用 /catch 撿新的瓶子吧！",
  "bottle6": "💡 使用 /catch 撿新的祝福漂流瓶開始新對話。",
  "bottle7": "🍾 丟祝福漂流瓶\n\n你想要尋找什麼樣的聊天對象？先給遠方的他/她送上祝福吧~幸福會回到你身上的~",
  "bottle8": "快去丟祝福漂流瓶，和新朋友彼此祝福吧！ /throw\n\n",
  "bottle9": "看看別人的祝福漂流瓶，彼此祝福~回覆開始聊天\n\n",
