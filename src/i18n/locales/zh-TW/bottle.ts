export default {
  ...
  "catch": {
    ...
    "bottle": "😔 目前沒有適合的祝福漂流瓶\n\n",
    "bottle2": "• 或者自己丟一個祝福漂流瓶子：/throw",
    "bottle3": "🎣 有人撿到你的祝福漂流瓶了！\n\n",
    "bottle4": "🧴 你撿到了一個祝福漂流瓶！\n\n",
    "bottle5": "💡 明天再來撿更多祝福漂流瓶吧！",
    "bottleTaken": "❌ 這個祝福漂流瓶已經被其他人撿走了，請試試其他瓶子！",
  ...
  "throw": {
    ...
    "bloodType5": "🌈 任何血型",
    "bottle": "\n💡 這個瓶子和你非常合拍！\n\\n",
    "bottle10": "🍾 祝福漂流瓶已丟出！茫茫人海，誰能收到我的祝福~\n\n",
    "bottle11": "🍾 送出祝福漂流瓶",
    "bottle2": "🎯 你的祝福漂流瓶已發送給 **3 個對象**：\n",
    "bottle3": "🍾 **正在丟出你的祝福漂流瓶...**\n\n",
    "bottle4": "🍾 **送出祝福漂流瓶** #THROW\n\n",
    "bottle5": "瓶子 ID：#{bottleId}",
    "bottle6": "📝 **請輸入給陌生對象的祝福的內容**\n\n",
    "bottle7": "1️⃣ 點擊下方「🍾 送祝福漂流瓶」按鈕\n",
    "bottle8": "📝 請輸入你的祝福漂流瓶內容：\n\n",
    "bottle9": "📝 請輸入你的祝福漂流瓶內容：",
