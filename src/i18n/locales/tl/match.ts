export default {
  "resultTitle": "💘 **Tugma sa Kapalaran kay {target}**",
  "score": "💫 Indeks ng Tugma: {score} puntos",
  "analysis": "📊 **Detalyadong Pagsusuri:**",
  "high": "✨ **Perpektong Tugma!**\nAng inyong mga katangian ay labis na nakukumpleto ang isa't isa, magiging napakadali at masaya ang inyong pakikisalamuha. Anuman ang inyong papel bilang magkaibigan o magkasintahan, may mataas na potensyal para sa pag-unlad!",
  "medium": "⚖️ **Nagdadala ng Suporta sa Isa't Isa**\nMay mga aspeto kayong tumutugma, ngunit sa iba ay kailangan ng ilang pagsasaayos. Basta't magtutulungan, magiging matatag ang inyong relasyon.",
  "low": "🔥 **Sparks ng Pagsasalungat**\nMalaki ang pagkakaiba ng inyong mga katangian, na maaaring magdulot ng ilang hamon. Ngunit ang pagkakaibang ito ay maaaring magbigay ng hindi inaasahang mga sparks!",
  "vipRequired": "🔒 Kailangan ng VIP para makita ang detalyadong resulta ng tugma",
