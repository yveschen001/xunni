export default {
  ...
  "mbti": "🎯 Pembaruan tepat untuk menemukan orang yang tepat\n• Saat mengirim botol pesan, Anda dapat menentukan MBTI, zodiak, dan tipe darah penerima.\nDi lautan orang yang luas, temukan tipe ideal Anda dengan akurat.",
  ...
  "text": "- Lebih suka menggunakan terjemahan model OpenAI GPT (kualitas tinggi)\n🔮 Privilege astrologi AI\nAkses gratis harian untuk membuka rincian keberuntungan (pengguna biasa sekali seminggu).\nDapatkan laporan analisis karir dan minat yang mendalam.\n🚫 Pengalaman murni\nSepenuhnya bebas dari gangguan iklan.",
