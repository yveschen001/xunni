export default {
  ...
  "bottle11": "Anda tidak akan lagi dip配angkan dengan botol pesan satu sama lain.",
  "bottle12": "Jenis orang seperti apa yang Anda cari saat melempar botol pesan?",
  ...
  "bottle16": "💡 Lain kali Anda melempar botol pesan, pengaturan ini akan digunakan secara otomatis.",
  ...
  "bottle22": "• /throw - Buang botol pesan",
  "bottle23": "• /catch - Ambil botol pesan",
  "bottle24": "• /throw - Buang botol pesan",
  "bottle25": "• /catch - Ambil botol pesan",
  "bottle26": "• Kirim konten draf untuk membuang botol pesan",
  "bottle27": "📦 **Lempar Botol Pesan**\n",
  "bottle28": "🎣 **Ambil botol pesan**",
  "bottle29": "💡 Selesaikan tugas untuk menerima botol tambahan",
  "bottle3": "• Botol pesan: {bottlesCount?.count }",
  ...
  "bottle4": "Platform kencan botol pesan anonim yang membantu Anda menemukan teman seide melalui MBTI dan astrologi",
  ...
  "bottle9": "Lihat botol pesan orang lain, dan jika Anda tertarik, balas untuk mulai mengobrol.",
