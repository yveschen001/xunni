export default {
  ...
  "bloodTypeB": "🩸 Tipe B",
  "bloodTypeO": "🩸 Tipe O",
  "bottle": "Isi botol terlalu pendek, setidaknya {MIN_BOTTLE_LENGTH} karakter diperlukan (sekarang {trimmedContent.length} karakter)",
  "bottle10": "Reward: +1 botol pesan (ditambahkan ke kuota hari ini)",
  "bottle11": "Anda tidak akan lagi dipasangkan dengan Botol Berkah berkah satu sama lain.",
  "bottle12": "Jenis penerima apa yang ingin Anda padankan saat mengirim Botol Berkah berkah?",
  "bottle13": "Gunakan /throw untuk mengirim Botol Berkah dan mulai langkah pertama menuju obrolan yang bahagia!",
  "bottle14": "Konten botol berisi materi yang tidak pantas. Harap ubah dan kirim ulang.",
  "bottle15": "Klik tombol di bawah untuk menerima hadiah Anda: +1 botol",
  "bottle16": "💡 Selanjutnya, ketika Anda mengirim Botol Berkah, pengaturan ini akan digunakan secara otomatis.",
  "bottle17": "🌊 Kirim berkat Botol Berkah - /throw",
  "bottle18": "🎣 Ambil Botol Berkah Berkat - /catch",
  "bottle19": "🎉 Mengonfirmasi akan memberi Anda hadiah +1 botol!",
  "bottle2": "Konten botol terlalu panjang, dengan maksimum {MAX_BOTTLE_LENGTH} karakter (saat ini {content.length} karakter)",
  "bottle20": "✏️ Silakan masukkan konten baru Botol Berkah:",
  "bottle21": "• Gunakan /catch untuk mengambil botol berkah baru.",
  "bottle22": "• /throw - Lempar Botol Berkah",
  "bottle23": "• /catch - Tangkap Botol Berkah",
  "bottle24": "• /throw - Toss Botol Berkah",
  "bottle25": "• /catch - Ambil Botol Berkah",
  "bottle26": "• Kirim konten draf untuk mengeluarkan Botol Berkah",
  "bottle27": "📦 **Keluarkan Botol Berkah**",
  "bottle28": "🎣 **Ambil Botol Berkah**",
  "bottle29": "💡 Menyelesaikan tugas akan memberi Anda Botol Berkah tambahan.",
  "bottle3": "• Botol Berkah Berkah: {bottlesCount?.count }",
  "bottle30": "Isi botol tidak boleh mengandung tautan",
  "bottle31": "🍾 Lemparkan sebuah berkat Botol Berkah",
  "bottle32": "Konten botol tidak boleh kosong",
  "bottle33": "Lempar botol pertamamu",
  "bottle34": "Ambil botol pesan pertama",
  "bottle4": "Sebuah platform Botol Berkah berkah anonim yang membantu Anda menemukan teman senasib dengan sifat yang kompatibel melalui berkah timbal balik, serta MBTI dan tanda zodiak.",
  "bottle5": "⏰ Obrolan telah waktu habis\n\nPihak lainnya mungkin telah pergi. Gunakan /catch untuk mengambil botol baru!",
  "bottle6": "💡 Gunakan /catch untuk mengambil Botol Berkah baru dan memulai percakapan baru.",
  "bottle7": "🍾 Kirim Botol Berkah\n\nApa jenis teman chat yang kamu cari? Kirimkan berkat kepada mereka yang jauh terlebih dahulu~ Kebahagiaan akan kembali padamu~",
  "bottle8": "Ayo lempar Botol Berkah berisi berkah dan saling mendoakan yang terbaik dengan teman-teman baru! /throw",
  "bottle9": "Lihat botol-Botol Berkah berkah lainnya dan kirimkan berkah Anda~ Balas untuk mulai mengobrol",
  "broadcast": "Siaran akan dikirim di latar belakang. Gunakan /broadcast_status {broadcastId} untuk memeriksa kemajuan.",
  ...
  "country": "Kode negara/region tidak valid: {trimmedValue} (harus terdiri dari 2 huruf kapital, seperti US, JP)",
  "country2": "🌍 **Silakan pilih negara/wilayah Anda**",
  "country3": "Negara/Region: {filters.country}",
  ...
  "message": "3. Harap laporkan setiap penipuan segera",
  ...
  "message2": "4. Pejabat tidak akan secara pribadi meminta informasi.",
  ...
  "message28": "/pengaktifan_perawatan <durasi (menit)> [Pesan Perawatan] <duration (minutes)>",
  ...
  "register": "💡 Ini adalah tes cepat ({testInfo}), dan hasilnya hanya untuk referensi.\nSetelah menyelesaikan registrasi, Anda dapat mengambil tes lagi dengan /mbti.",
  "register10": "🎉 Selamat telah menyelesaikan pendaftaran!\n\n",
  "register2": "💡 Ini adalah tes lengkap ({testInfo}), dan hasilnya lebih akurat.\nSetelah menyelesaikan pendaftaran, Anda dapat menggunakan /mbti untuk mengulang tes.",
  ...
  "text14": "XunNi berkomitmen untuk menyediakan lingkungan kencan yang aman. Harap perhatikan poin-poin berikut:",
  ...
  "text15": "2. Harap berhati-hati saat berhubungan dengan transaksi moneter.",
  "text150": "📋 Dokumen hukum hanya tersedia dalam versi bahasa Inggris.",
  "text16": "5. Jika Anda menemukan pengguna yang melanggar aturan, silakan gunakan /report",
  "text17": "Jika Anda menemui situasi mencurigakan, harap blokir dan laporkan pengguna tersebut segera.",
  ...
  "fortuneBottle": "botol ramalan ramalan",
  "weeklyFree": "Gratis minggu ini",
  "additional": "Ekstra",
  "confirm_action": "Konfirmasi Operasi",
  "continue": "Lanjutkan",
  "done": "Selesaikan",
  "edit": "Edit",
  "ok": "OK",
