export default {
  ...
  "bottle3": "• Anda dapat mengirim dan mengumpulkan sejumlah Botol Berkah berkah yang terbatas setiap hari.",
  ...
  "bottle7": "/throw - Lempar Botol Berkah",
  "bottle8": "/catch - Tangkap Botol Berkah",
  "bottle9": "🍾 **Sistem Botol Berkah**",
  ...
  "profile3": "👤 **Profil**\n",
  "quota": "🔢 Kuota Harian Tinggi\n• Mulai dengan 30 Botol Berkah per hari (hanya 10 untuk pengguna biasa).\n• Mengundang teman dapat secara permanen meningkatkan kuota, dengan total maksimum 100!\n• Batas harian 100 pesan percakapan, chat tanpa batas.",
  "quota2": "• Kuota harian 30 Botol Berkah Berkah",
  ...
  "superAdminMaintenance": "🔧 **Pemeliharaan Sistem**",
  "superAdminMaintenanceDisable": "• `/maintenance_disable` - Nonaktifkan mode pemeliharaan",
  "superAdminMaintenanceEnable": "• `/maintenance_enable <menit> [alasan]` - Aktifkan mode pemeliharaan <minutes>",
  "devToolsTitle": "🛠️ **Alat Pengembang**",
  "devInfo": "/dev_info - Lihat informasi sistem",
