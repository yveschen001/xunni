export default {
  ...
  "quietHoursVipOnly": "🔒 Ώρες Ησυχίας (Μόνο για VIP)",
  "upgradeForQuietHours": "Αναβαθμίστε σε VIP για να ορίσετε ώρες ησυχίας και να αποφύγετε τις διαταραχές κατά τη διάρκεια της ξεκούρασης!",
  "blocklist": {
    "title": "🚫 Λίστα Αποκλεισμένων",
    "empty": "Δεν υπάρχει τρέχουσα λίστα αποκλεισμένων",
    "unblock": "Αποκλεισμός"
  }
};
