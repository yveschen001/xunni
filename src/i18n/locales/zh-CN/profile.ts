export default {
  ...
  "message": "XunNi 一起丢祝福漂流瓶吧！🍾 使用我的邀请码：{inviteCode}",
  ...
  "zodiac": "⭐ 星座: {zodiac}",
  "fortuneQuota": "🔮 {fortuneBottle}: {total} (本周免费: {weekly}/{limit} | 额外: {additional})",
  "vipWithDays": "💎 VIP 会员 (剩余 {days} 天, 到期: {expireDate})",
  "driftBottleInfo": "🍾 祝福漂流瓶：{remaining} / {total}",
  "ageRange": "年龄：{min}-{max}",
  "fortuneMatchButton": "💘 算命速配",
  "giftVipButton": "🎁 赠送VIP",
  "giftFortuneBottleButton": "🔮 赠送算命瓶",
  "moreOptions": "⚙️ 更多选项...",
  "blockUser": "🚫 封锁用户",
  "reportUser": "⚠️ 举报",
  "moreOptionsTitle": "⚙️ **更多选项**",
  "giftedVipNote": "🎁 曾经赠送你VIP"
};
