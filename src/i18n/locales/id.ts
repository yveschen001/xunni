...
export const translations: Translations = {
  ...
  admin: {
    ...
    addAlreadySuperAdmin:
      '❌ Pengguna ini sudah menjadi super administrator, tidak perlu ditambahkan.',
    ...
    appealReviewCommands:
      '/admin_approve <appeal_id> [catatan]\n/admin_reject <appeal_id> [catatan]',
    ...
    ban: {
      ...
      viewHistory:
        '💡 Gunakan /admin_bans <user_id> untuk melihat riwayat larangan pengguna tertentu',
    ...
    banSuccess:
      '✅ Pengguna {userId} ({nickname}) telah dilarang\n\nDurasi larangan: {duration}\nWaktu pemulihan: {unbanTime}',
    ...
    conversation4:
      'Silakan periksa apakah riwayat percakapan telah diperbarui untuk menghapus avatar.',
    ...
    message:
      "• Diperbarui pada: ${new Date(post.updated_at).toLocaleString('zh-TW', { month: '2-digit', day: '2-digit', hour: '2-digit', minute: '2-digit' })}\n\n",
    ...
    message2:
      "• Waktu pembaruan: ${avatarInfo.avatar_updated_at ? new Date(avatarInfo.avatar_updated_at).toLocaleString('en-US') : 'Tidak diketahui'}",
    ...
    message40:
      "• Waktu pembaruan: ${new Date(post.updated_at).toLocaleString('en-US', { month: '2-digit', day: '2-digit', hour:",
  ...
  appeal: {
    alreadyExists:
      '⏳ Anda memiliki banding yang tertunda (ID: #${appealId})\n\nStatus: ${status}\nDikirim pada: ${time}\n\nSilakan tunggu untuk ulasan administrator.',
  ...
  block: {
    ...
    catchNewBottle:
      '💡 Gunakan /catch untuk memilih botol pesan baru untuk memulai percakapan baru.',
    ...
    ensureReply:
      'Silakan pastikan Anda membalas pesan yang dikirim oleh pihak lain (ditandai dengan identifikasi #).',
  ...
  bottle: {
    ...
    cancelled: '❌ Dibatalkan ${zodiac}',
      ...
      bottleTaken:
        '❌ Botol pesan ini telah diambil oleh orang lain, silakan coba botol pesan lainnya!',
      catch: '📊 Tangkapan hari ini: \\${newCatchesCount}/\\${quota}',
      conversation:
        'Sebuah percakapan anonim telah dibuat untuk Anda, datang dan mulai obrolan!\n\n',
      ...
      notRegistered:
        '❌ Silakan selesaikan proses pendaftaran sebelum mengambil botol pesan.\n\nGunakan /start untuk melanjutkan pendaftaran.',
      ...
      report:
        '• Jika Anda mendapati konten yang tidak pantas, mohon laporkan menggunakan /report\n',
      ...
      text6:
        '💬 Layanan terjemahan sedang mengalami masalah sementara; terjemahan cadangan telah digunakan.\n',
      ...
      translationServiceFallback:
        '💬 Layanan terjemahan sedang mengalami masalah sementara, terjemahan cadangan digunakan',
      translationServiceUnavailable:
        '⚠️ Layanan terjemahan sedang tidak tersedia, berikut adalah teks asli',
      unknown: 'Tidak dikenal',
    ...
    inappropriate:
      'Konten botol pesan mengandung konten yang tidak pantas, mohon modifikasi dan ajukan ulang',
    ...
    throw: {
      ...
      gender:
        "• Gender: \\${selectedGender === 'male' ? '👨 Laki-laki' : selectedGender === 'female' ? '👩 Perempuan' : '🌈 Siapa saja'}",
      ...
      mbtiLabel: '• MBTI: {mbti}',
      message:
        "Dipilih: \\${selectedZodiac.length > 0 ? selectedZodiac.map((z) => ZODIAC_NAMES[z]).join(', ') : 'Tidak ada'}",
      message2:
        "Pilihan saat ini: \\${currentGender === 'male' ? '👨 Laki-laki' : currentGender === 'female' ? '👩 Perempuan' : '🌈 Siapa saja'}",
      message3:
        'Terpilih: \\${selectedZodiac.length > 0 ? selectedZodiac.map((z) => ZODIAC_NAMES[z]).join(',
      message4: 'Pilihan saat ini: \\${bloodTypeDisplay[currentBloodType]}\n\n',
      message5: '👤 Mitra: \\${vipMatchInfo.matcherNickname}\n',
      message6:
        '"Halo! Saya seseorang yang menyukai musik dan film, berharap dapat bertemu teman yang sejalan!"\n\n',
      ...
      start: '✍️ Mulai ulang',
      success:
        'Membuang botol pesan ke 3 target secara signifikan meningkatkan tingkat keberhasilan pencocokan.\n\n',
      ...
      text3:
        '💡 Ini mungkin memerlukan beberapa detik, kami sedang mencari orang yang paling sesuai untuk Anda',
      ...
      zodiac:
        "• Zodiac: \\${selectedZodiac.length > 0 ? selectedZodiac.map((z) => ZODIAC_NAMES[z]).join(', ') : 'Tanpa batasan'}",
    ...
    tips: '💡 Tips:',
    tooLong:
      'Konten botol pesan terlalu panjang, maksimum ${max} karakter diizinkan (saat ini ${current} karakter)',
    tooShort:
      'Konten botol pesan terlalu pendek, setidaknya ${min} karakter diperlukan (saat ini ${current} karakter)',
  },
  broadcast: {
    ...
    filter: {
      ...
      genderOther: 'Lainnya',
      invalidAgeFormat:
        'Rentang usia tidak valid: {value} (format harus min-maks, misalnya, 18-25)',
      invalidAgeMinMax:
        'Rentang usia tidak valid: {value} (usia minimum tidak boleh lebih besar dari usia maksimum)',
      invalidAgeRange: 'Rentang usia tidak valid: {value} (usia harus antara 18-99)',
      invalidCountry:
        'Kode negara tidak valid: {value} (harus 2 huruf kapital, misalnya, TW, US, JP)',
    ...
    filterCreatedSending:
      'Siaran akan dikirim di latar belakang, gunakan /status_siara {id} untuk mengecek progresnya.',
    ...
    maxUsersExceeded:
      '❌ Sistem siaran saat ini hanya mendukung siaran kepada ${max} pengguna atau kurang.\n\nJumlah pengguna target: ${current}',
    ...
    upgradeRequired:
      'Siaran skala besar memerlukan peningkatan arsitektur sistem, silakan lihat BROADCAST_SYSTEM_REDESIGN.md',
  ...
  buttons: {
    ...
    back: '🏠 Kembali ke Menu Utama: /menu',
    banned:
      '❌ Akun Anda telah dibanned dan tidak dapat mengambil botol pesan.\n\nJika Anda memiliki pertanyaan, silakan gunakan /appeal untuk mengajukan banding.',
    ...
    nickname2: '📝 Nama Panggilan: ${catcherNickname}\n',
    notRegistered:
      '❌ Harap selesaikan proses pendaftaran sebelum mengambil botol pesan.\n\nGunakan /start untuk melanjutkan pendaftaran.',
    ...
    replyMethods: '💡 **Dua Cara untuk Membalas**:\n',
    report:
      '• Jika Anda menemui konten yang tidak pantas, harap gunakan /report untuk melaporkan\n',
    ...
    translationServiceFallback:
      '💬 Layanan terjemahan saat ini mengalami masalah, terjemahan cadangan sedang digunakan',
    translationServiceUnavailable:
      '⚠️ Layanan terjemahan saat ini tidak tersedia, berikut adalah teks asli',
    unknown: 'Tidak diketahui',
  ...
  channelMembership: {
    ...
    leftChannel:
      '❌ Mendeteksi bahwa Anda telah meninggalkan saluran, tidak dapat mengklaim hadiah.',
    notJoined:
      '❌ Tidak mendeteksi bahwa Anda bergabung dengan saluran, silakan bergabung terlebih dahulu dan coba lagi',
    oneTimeReward:
      '💡 Ini adalah hadiah satu kali, akan ditambahkan ke kuota hari ini setelah diklaim.',
  ...
  common: {
    ...
    bloodTypeO: '🩸 Tipe O',
    bottle:
      'Konten botol pesan terlalu pendek, minimal ${MIN_BOTTLE_LENGTH} karakter diperlukan (saat ini ${trimmedContent.length} karakter)',
    ...
    bottle14:
      'Konten botol pesan mengandung konten yang tidak pantas, silakan ubah dan kirim kembali.',
    bottle15: 'Klik tombol di bawah untuk mengklaim hadiah: +1 botol pesan\n\n',
    bottle16:
      '💡 Pengaturan ini akan secara otomatis digunakan untuk pelemparan botol pesan Anda berikutnya.',
    ...
    bottle4:
      'Sebagai platform sosial botol pesan anonim, membantu kamu menemukan teman sepenanggungan melalui MBTI dan tanda zodiak\n\n',
    bottle5:
      '⏰ Obrolan telah waktu habis\n\nPihak lainnya mungkin telah pergi. Gunakan /catch untuk mengambil botol baru!',
    ...
    broadcast2:
      'Siaran besar memerlukan peningkatan arsitektur sistem, silakan lihat BROADCAST_SYSTEM_REDESIGN.md',
    ...
    confirm:
      'Untuk memastikan keselamatan semua pengguna, harap konfirmasi bahwa kamu memahami yang berikut ini:\n\n',
    ...
    conversation:
      '📨 ${formatIdentifier(conv.identifier)} percakapan (${conv.message_count} pesan)\n',
    ...
    conversation6:
      'Cache avatar Anda telah diperbarui. Avatar terbaru akan ditampilkan saat Anda melihat riwayat percakapan.\n\n',
    conversation7:
      '💡 Untuk melindungi privasi dan keamanan, hanya pesan teks biasa yang diperbolehkan dalam percakapan.\n\n',
    conversation8: 'Gunakan /history untuk melihat semua percakapan\n\n',
    conversation9: '🔄 Memperbarui semua riwayat percakapan...\n\n',
    country:
      'Kode negara tidak valid: ${trimmedValue} (harus 2 huruf kapital, misalnya, TW, US, JP)',
    ...
    gender2:
      'Nilai jenis kelamin tidak valid: ${trimmedValue} (harus laki-laki, perempuan, atau lain-lain)',
    ...
    loading: '✅ Memuat......',
    login:
      'Pengguna biasa tidak akan dapat menggunakan layanan ini; hanya administrator yang dapat log in.',
    male: 'Pria',
    ...
    message23:
      "💡 Silakan tekan lama pesan yang ingin Anda balas, pilih 'Balas' dari menu yang muncul, dan masukkan balasan Anda di kotak obrolan.",
    ...
    message32:
      'Komandan - Pemimpin yang berani, imajinatif, dan berkemauan keras yang selalu menemukan atau menciptakan solusi.',
    message33: '💡 Gunakan /broadcast_status <id> untuk melihat detail',
    message34: '🏷️ Tag minat: ${updatedUser.interests ||',
    message35:
      'Gubernur - Individu yang penuh kasih, populer, dan membantu yang selalu siap berkontribusi pada komunitas.',
    ...
    message39:
      'Penggagas - Jiwa bebas yang penuh semangat, kreatif, dan sosial yang selalu menemukan alasan untuk tersenyum.',
    message4:
      '💡 Gunakan /history ${formatIdentifier(conversations[0].identifier)} untuk melihat percakapan lengkap',
    message40: 'Waktu tersisa: ${remaining.remainingText}\n',
    message41:
      'Penampil - Individu spontan, energik, dan antusias yang tidak pernah membuat hidup membosankan.',
    message42: 'Total pengguna: ${broadcast.total_users}',
    message43: '• Anda mengirim: ${stats.user_messages} pesan',
    message44:
      'Mediator - Seorang altruist puitis, baik hati yang dengan penuh semangat bekerja untuk keadilan.',
    ...
    message48:
      'Pengusaha - Individu cerdas, energik, dan tajam yang benar-benar menikmati hidup di tepi.',
    ...
    message54:
      '• Jika Anda mengubah foto profil Telegram Anda, sistem akan mendeteksinya secara otomatis\n',
    ...
    message58:
      'Penganjur - Pendiam dan misterius, sekaligus menjadi idealis yang menginspirasi dan tanpa lelah.',
    message59:
      'Penjaga - Pelindung yang sangat fokus dan hangat, selalu siap melindungi orang yang mereka cintai.',
    message6: '• Tayangan: ${stats.total_views} | Klik: ${stats.total_clicks} (${stats.ctr}%)\n',
    message60:
      'Penjelajah - Seniman yang fleksibel dan memikat, selalu siap untuk menjelajahi dan mengalami hal-hal baru.',
    message61:
      '• Tekan lama pada pesan pihak lain untuk membalas /block untuk memblokir pengguna ini\n',
    message62:
      'Silakan pastikan Anda membalas pesan yang dikirim oleh pihak lain (ditandai dengan ID #).',
    ...
    message8:
      '• Hadiah yang didistribusikan: ${stats.total_rewards}\n• Tingkat hadiah: ${stats.reward_rate}%',
    message9: '• Sisa tampilan: ${ad.max_views - ad.current_views}/${ad.max_views}',
    newUser: 'Pengguna baru',
    next: 'Halaman Berikutnya',
    nickname:
      '💡 Silakan masukkan nama panggilan sederhana tanpa menyertakan tautan seperti http:// atau https://.',
    ...
    text12:
      'Manajer Umum - Seorang manajer luar biasa, tak tertandingi dalam menangani urusan atau personel.',
    text120: '💡 **Tip:**',
    ...
    text13:
      '💡 Ini akan ditampilkan di kartu profil Anda untuk membantu pengguna lain memahami Anda dengan lebih baik.\n',
    ...
    text16:
      "✅ Verifikasi diperlukan: Klik tombol 'Verifikasi' setelah bergabung dengan grup/saluran",
    ...
    text22:
      'Tuliskan perasaan atau pikiran Anda, dan sistem akan membantu Anda menemukan orang yang tepat\n\n',
    text23:
      'Spesialis Logistik - Individu praktis dan berfokus pada fakta dengan keandalan yang tidak diragukan.',
    text24: 'Pakar - Eksperimen berani dan praktis, mahir menggunakan berbagai alat.',
    text25:
      '💡 Ini adalah hadiah satu kali yang akan ditambahkan ke kuota hari ini setelah diklaim.',
    ...
    text37:
      "🇺🇳 Jika Anda tidak dapat menemukannya, Anda dapat memilih 'bendera Perserikatan Bangsa-Bangsa'",
    ...
    text6:
      'Arsitek - Seorang pemikir imajinatif dan strategis yang merencanakan segalanya dengan cermat.',
    ...
    throw:
      '⏰ Proses melempar botol pesan telah melebihi batas waktu\n\nSilakan gunakan /throw untuk memulai ulang.',
    ...
    yes: 'Ya',
    zodiac:
      "Tanda zodiak tidak valid: ${trimmedValue} (harus salah satu dari: ${VALID_ZODIACS.join(', ')})",
  },
  conversation: {
    age: '🎂 Rentang usia: ${ageRange} tahun\n',
    anonymousCardHint:
      '💡 Ini adalah kartu profil anonim dan tidak akan menampilkan informasi identitas sebenarnya dari orang lain.',
    ...
    reportSuccessMessage:
      'Terima kasih atas laporan Anda, kami akan meninjaunya sesegera mungkin.\n\n💡 Ingin memulai percakapan baru?\n• Gunakan /catch untuk mengambil botol pesan baru',
    ...
    vipUnlockAvatar:
      '🔒 Tingkatkan ke VIP untuk membuka gambar profil yang lebih jelas dari pengguna lain',
  ...
  country: {
    ...
    confirmHint:
      '💡 Ini akan ditampilkan di kartu profil Anda untuk membantu pengguna lain mengenal Anda lebih baik.\n',
  ...
  error: {
    ...
    bottle2:
      '❌ Akun Anda telah dibanned dan Anda tidak dapat memilih botol pesan.\n\nJika memiliki pertanyaan, silakan gunakan /appeal untuk mengajukan banding.',
    bottle3: '❌ Botol pesan ini sudah diambil oleh orang lain, silakan coba botol lainnya!',
    broadcast:
      '❌ Sistem siaran saat ini hanya mendukung siaran untuk hingga ${MAX_SAFE_USERS} pengguna.\n\n',
    broadcast2: '❌ ID siaran harus berupa angka.',
    broadcast3: '❌ Rekor siaran tidak ditemukan.',
    cancel:
      '❌ Nama panggilan terlalu panjang, silakan masukkan nama panggilan tidak lebih dari 36 karakter.\n\nSilakan masukkan kembali atau batalkan pengeditan:',
    cancel2:
      '❌ Profil pribadi terlalu panjang, silakan masukkan tidak lebih dari 200 karakter.\n\nSilakan masukkan kembali atau batalkan pengeditan:',
    cancel3:
      '❌ Nama lokasi terlalu panjang, silakan masukkan tidak lebih dari 50 karakter.\n\nSilakan masukkan kembali atau batalkan pengeditan:',
    cancel4:
      '❌ Nama panggilan terlalu pendek, minimal 4 karakter diperlukan.\n\nSilakan masukkan kembali atau batalkan pengeditan:',
    cancel5:
      '❌ Setiap tag dapat memiliki maksimal 20 karakter.\n\nSilakan masukkan kembali atau batalkan pengeditan:',
    cancel6: '❌ Batalkan pengeditan',
    cancel7: '❌ Dibatalkan ${ZODIAC_NAMES[zodiacSign]}',
    cancel8: '❌ Dibatalkan ${mbtiType}',
    cancel9: '❌ Batalkan',
    conversation:
      '❌ Percakapan dengan pengidentifikasi ${formatIdentifier(identifier)} tidak ditemukan\n\n',
    ...
    failed2:
      '❌ Gagal membuat siaran terfilter\n${error instanceof Error ? error.message : String(error)}',
    failed20: '❌ Konfirmasi gagal.',
    failed21: '❌ Pengaturan gagal.',
    failed22: '❌ Lewati gagal.',
    failed23: '❌ Operasi gagal.',
    failed24:
      '❌ Gagal mengirim laporan harian: ${error instanceof Error ? error.message : String(error)}',
    ...
    failed3:
      '❌ Gagal memproses antrean siaran: ${error instanceof Error ? error.message : String(error)}',
    ...
    failed4:
      '❌ Gagal menanyakan status siaran: ${error instanceof Error ? error.message : String(error)}',
    failed40: '❌ Pengiriman gagal, silakan coba lagi nanti.',
    failed41: '❌ Gagal membuat obrolan, silakan coba lagi nanti.',
    failed5:
      '❌ Gagal membatalkan siaran: ${error instanceof Error ? error.message : String(error)}',
    failed6:
      '❌ Gagal membersihkan siaran: ${error instanceof Error ? error.message : String(error)}',
    ...
    message4:
      '❌ Maaf, Anda harus berusia minimal 18 tahun untuk menggunakan layanan ini.\n\nSilakan kembali saat Anda sudah dewasa!',
    ...
    quota:
      '❌ Kuota botol pesan hari ini telah habis (${quotaDisplay})\n\n💡 Cara untuk mendapatkan lebih banyak kuota:\n',
    ...
    register:
      '❌ Harap selesaikan proses pendaftaran terlebih dahulu.\n\nGunakan /start untuk melanjutkan pendaftaran.',
    register2:
      '❌ Data pengguna tidak ditemukan, harap gunakan /start untuk mendaftar terlebih dahulu.',
    register3:
      '❌ Anda harus menyelesaikan proses pendaftaran untuk mengambil botol pesan.\n\nGunakan /start untuk melanjutkan pendaftaran.',
    settings:
      '❌ Anda dapat menetapkan hingga 5 tag minat.\n\nSilakan masukkan kembali atau batal pengeditan:',
    ...
    text17:
      '❌ Terjadi kesalahan saat memproses pembayaran, silakan hubungi dukungan pelanggan.\n\n',
    ...
    text23:
      '❌ Kami mohon maaf, Anda harus berusia minimal 18 tahun untuk menggunakan layanan ini.\n\n',
  ...
  errors: {
    ...
    error: {
      ...
      cancel2:
        '❌ Profil pribadi terlalu panjang, silakan masukkan tidak lebih dari 200 karakter.\n\nSilakan masukkan ulang atau batalkan penyuntingan:',
      cancel3:
        '❌ Nama daerah terlalu panjang, silakan masukkan tidak lebih dari 50 karakter.\n\nSilakan masukkan ulang atau batalkan penyuntingan:',
      cancel4:
        '❌ Nama panggilan terlalu pendek, minimal 4 karakter diperlukan.\n\nSilakan masukkan ulang atau batalkan penyuntingan:',
      cancel5:
        '❌ Setiap tag dibatasi hingga 20 karakter.\n\nSilakan masukkan ulang atau batalkan penyuntingan:',
      ...
      failed2:
        '❌ Gagal untuk membuat siaran terfilter\n\n\\${error instanceof Error ? error.message : String(error)}',
      failed20: '❌ Konfirmasi gagal.',
      failed21: '❌ Pengaturan gagal.',
      ...
      failed3:
        '❌ Gagal memproses antrian siaran: \\${error instanceof Error ? error.message : String(error)}',
      ...
      message3:
        '❌ Terjadi kesalahan, silakan coba lagi nanti.\n\nPesan kesalahan: \\${error instanceof Error ? error.message : String(error)}',
      message4:
        '❌ Kami mohon maaf, Anda harus berusia setidaknya 18 tahun untuk menggunakan layanan ini.\n\nSilakan kembali ketika Anda sudah dewasa!',
      ...
      quota:
        '❌ Kuota botol pesan hari ini telah terpakai (\\${quotaDisplay})\n\n💡 Cara untuk mendapatkan lebih banyak kuota:\n',
      quota2: '❌ Kuota pesan percakapan hari ini telah habis (\\${usedToday}/\\${dailyLimit})\n\n',
      quota3: '❌ Kuota botol pesan hari ini telah habis (\\${quotaDisplay})\n\n',
      register:
        '❌ Harap selesaikan proses pendaftaran terlebih dahulu.\n\nGunakan /start untuk melanjutkan pendaftaran.',
      register2:
        '❌ Data pengguna tidak ditemukan, silakan gunakan /start untuk mendaftar terlebih dahulu.',
      register3:
        '❌ Anda harus menyelesaikan proses pendaftaran untuk mengambil botol pesan.\n\nGunakan /start untuk melanjutkan pendaftaran.',
      settings:
        '❌ Anda dapat menetapkan maksimal 5 tag minat.\n\nSilakan masukkan ulang atau batal pengeditan:',
      short: '❌ Kode bahasa tidak valid',
      ...
      text16: '❌ Durasi harus berupa bilangan bulat positif atau',
      text17:
        '❌ Terjadi kesalahan sistem saat memproses pembayaran, silakan hubungi dukungan pelanggan.\n\n',
      ...
      text23:
        '❌ Kami mohon maaf, Anda harus berusia di atas 18 tahun untuk menggunakan layanan ini.\n\n',
      text24: '❌ Terjadi kesalahan, silakan masukkan kembali.',
      text25: '❌ Harap jawab pertanyaan dengan serius\n\n',
      text3:
        '❌ Tidak terdeteksi keanggotaan saluran Anda, silakan bergabung terlebih dahulu sebelum mencoba lagi',
    ...
    userNotFoundRegister:
      '⚠️ Pengguna tidak ada, silakan daftar menggunakan /start terlebih dahulu.',
  ...
  history: {
    ...
    conversationNotFound:
      '❌ Percakapan dengan pengenal {identifier} tidak ditemukan\n\nGunakan /history untuk melihat semua percakapan\n\n🏠 Kembali ke menu utama: /menu',
  ...
  mbti: {
    ...
    share: {
      welcome:
        '👋 Teman Anda mengundang Anda untuk mengikuti tes MBTI!\n\nAyo lihat tipe kepribadian Anda～',
  ...
  menu: {
    ...
    message:
      'Ayo kirim botol pesan bersama di XunNi! 🍾 Gunakan kode undangan saya untuk bergabung, dan kita berdua bisa mendapatkan lebih banyak kuota!',
    message2:
      'https://t.me/share/url?url=https://t.me/${botUsername}?start=invite_${inviteCode}&text=Datanglah ke XunNi dan lempar botol pesan bersama',
    notRegistered: 'Belum Terdaftar',
  ...
  nickname: {
    ...
    genderHint:
      '⚠️ Catatan: Pemilihan gender tidak dapat diubah setelah ditetapkan, silakan pilih dengan hati-hati!',
    genderSelection:
      'Bagus! Nama panggilan Anda adalah: {nickname}\n\nSekarang silakan pilih jenis kelamin Anda:\n\n',
  ...
  onboarding: {
    ...
    ageRestriction:
      '❌ Kami mohon maaf, Anda harus berusia setidaknya 18 tahun untuk menggunakan layanan ini.\n\n',
    agreeTerms:
      'Klik tombol di bawah ini untuk menunjukkan bahwa Anda telah membaca dan menyetujui syarat di atas.',
    antiFraud: {
    ...
    antiFraudQuestions:
      'Untuk melindungi keamanan semua pengguna, silakan konfirmasi bahwa Anda memahami hal berikut:\n\n',
    antiFraudYes: '✅ Ya, saya mengerti dan akan memperhatikan keselamatan',
    back: '⬅️ Kembali',
    birthday:
      'Jika Anda yakin ini adalah kesalahan, silakan periksa apakah format tanggal lahir Anda benar (YYYY-MM-DD).',
    ...
    birthdayCheck:
      'Jika Anda merasa ini adalah kesalahan, silakan periksa apakah format tanggal lahir Anda benar (YYYY-MM-DD).',
    birthdayError: '❌ {error}',
    birthdayFormatError:
      '❌ Format tanggal lahir tidak benar\n\nSilakan masukkan ulang (format: YYYY-MM-DD):',
    birthdayRetry: 'Silakan masukkan ulang tanggal lahir Anda (format: YYYY-MM-DD):',
    birthdayWarning:
      '⚠️ Tanggal lahir tidak dapat diubah setelah disetting, silakan konfirmasi bahwa itu benar!',
    bloodType: {
    ...
    confirm:
      'Untuk melindungi keselamatan semua pengguna, silakan konfirmasi bahwa Anda memahami risiko berkencan online.\n\n',
    ...
    genderMale: '👨 Laki-laki',
    genderWarning:
      '⚠️ Catatan: Jenis kelamin tidak dapat diubah setelah disetting, silakan pilih dengan hati-hati!',
    ...
    settings:
      '💡 Tips: Anda dapat menggunakan perintah /mbti kapan saja untuk mengatur atau menguji jenis MBTI Anda.\n\n',
    settings2: '🧠 Sekarang mari kita atur jenis kepribadian MBTI Anda!\n\n',
    settings3: 'Oke, Anda dapat mengatur MBTI Anda nanti.\n\n',
    settings4:
      'Jika Anda tidak yakin, Anda dapat mengambil tes terlebih dahulu atau mengaturnya nanti.',
    ...
    stats: '📊 Statistik',
    stepAntiFraud:
      '🛡️ Silakan klik tombol di atas untuk mengonfirmasi masalah keamanan anti-penipuan',
    stepBirthday:
      '📅 Silakan masukkan tanggal lahir Anda (format: YYYY-MM-DD, misalnya, 1995-06-15)',
    ...
    text2:
      '💡 Anda dapat menggunakan perintah /mbti kapan saja untuk mengulang tes atau melakukan perubahan.',
    ...
    text7:
      'Klik tombol di bawah untuk menunjukkan bahwa Anda telah membaca dan menyetujui syarat di atas.',
    ...
    understandRisks:
      'Untuk melindungi keamanan semua pengguna, silakan konfirmasi bahwa Anda memahami risiko berkencan online.\n\n',
    ...
    warning: {
      birthday:
        '⚠️ Tanggal lahir tidak dapat diubah setelah ditentukan, harap konfirmasi bahwa itu benar!',
    },
  ...
  profile: {
    ...
    completeOnboarding:
      '⚠️ Harap selesaikan proses pendaftaran terlebih dahulu.\n\nGunakan /start untuk melanjutkan pendaftaran.',
    conversation:
      '💡 Ini adalah kartu data yang Anda tampilkan kepada orang lain dalam percakapan\n\n',
    ...
    message:
      'https://t.me/share/url?url=https://t.me/${botUsername}?start=invite_${inviteCode}&text=Datang ke XunNi dan toss botol pesan!🍾 Gunakan kode undangan saya: ${inviteCode}',
    ...
    message7:
      'https://t.me/share/url?url=https://t.me/${botUsername}?start=invite_${inviteCode}&text=Datang bergabung dengan XunNi dan lontarkan botol pesan',
    ...
    profile2: '👤 **Profil**\n\n',
    quota:
      '💡 Lengkapi tugas untuk mendapatkan kuota harian tambahan (gunakan /tasks untuk melihat)\n',
    ...
    success:
      '💡 Untuk setiap undangan sukses 1 orang, kuota harian Anda meningkat +1 secara permanen\n',
  ...
  report: {
    ...
    completeOnboarding:
      '⚠️ Silakan selesaikan proses pendaftaran terlebih dahulu.\n\nGunakan /start untuk melanjutkan pendaftaran.',
    conversationInfoError: '⚠️ Informasi percakapan tidak benar.',
    conversationInfoError2: '⚠️ Informasi percakapan tidak benar',
    conversationNotExists: '⚠️ Percakapan tidak ada',
    conversationNotFound:
      '⚠️ Percakapan ini tidak dapat ditemukan\n\nPercakapan mungkin telah berakhir atau tidak ada.',
    ensureReply:
      'Silakan pastikan Anda membalas pesan yang dikirim oleh pihak lain (dengan identifier #).',
    ...
    reasonSpam: '📢 Spam',
    replyRequired:
      '⚠️ Silakan tekan lama pesan yang ingin Anda laporkan dan kemudian balas dengan perintah\n\n',
  ...
  success: {
    ...
    bloodType:
      '✅ Golongan darah telah diperbarui menjadi ${getBloodTypeDisplay(bloodType as any)}',
  ...
  tasks: {
    ...
    bottle4:
      '• Reward permanen: ${inviteProgress.current} botol pesan (didistribusikan setiap hari)\n',
    ...
    description: {
      ...
      invite_progress:
        'Untuk setiap orang yang diundang, kuota harian permanen +1 (gratis untuk hingga 10 orang, VIP hingga 100 orang)',
    ...
    message2:
      'Klik tombol di bawah untuk bergabung dengan saluran resmi XunNi untuk berita dan acara terbaru!\n\n',
    name: {
  ...
  throw: {
    ...
    conversation: '💬 Identifikasi Percakapan: ${vipMatchInfo.conversationIdentifier}\n\n',
    conversation2:
      '💡 Tip: Setiap percakapan berdiri sendiri dan dapat terjadi secara bersamaan\n\n',
    conversation3: '💡 Anda dapat menerima **hingga 3 percakapan**!\n',
    conversation4: '💬 Anda dapat menerima **hingga 3 percakapan**!\n',
    conversation5: 'Gunakan /chats untuk melihat semua percakapan\n\n',
    conversation6: '📊 Gunakan /chats untuk melihat semua percakapan',
    ...
    gender:
      "• Jenis Kelamin: ${selectedGender === 'male' ? '👨 Pria' : selectedGender === 'female' ? '👩 Wanita' : '🌈 Semua'}",
    gender2: '👤 **Filter Jenis Kelamin**\n\n',
    gender3: '• Jenis Kelamin: Filter berdasarkan jenis kelamin\n\n',
    ...
    mbtiLabel: '• MBTI: {mbti}',
    message:
      "Terpilih: ${selectedZodiac.length > 0 ? selectedZodiac.map((z) => ZODIAC_NAMES[z]).join(', ') : 'Tidak ada'}",
    message2:
      "Pilihan saat ini: ${currentGender === 'male' ? '👨 Pria' : currentGender === 'female' ? '👩 Wanita' : '🌈 Siapa saja'}",
    message3:
      'Dipilih: ${selectedZodiac.length > 0 ? selectedZodiac.map((z) => ZODIAC_NAMES[z]).join(',
    message4: 'Pilihan saat ini: ${bloodTypeDisplay[currentBloodType]}',
    message5: '👤 Lawan: ${vipMatchInfo.matcherNickname}',
    message6:
      '"Halo! Saya adalah seseorang yang mencintai musik dan film, berharap bisa bertemu teman sejiwa～"',
    ...
    start: '✍️ Mulai ulang',
    success:
      'Melempar satu botol pesan = 3 objek, sangat meningkatkan tingkat keberhasilan pencocokan\n\n',
    success2: '✨ **Privileges VIP diaktifkan! Pencocokan cerdas berhasil!**\n\n',
    ...
    text24: 'Kondisi filter saat ini:\n\n',
    text3:
      '💡 Ini mungkin memakan waktu beberapa detik, kami sedang mencari orang yang paling sesuai untuk Anda',
    text4: 'Pilihan Saat Ini: ${currentGender ===',
    ...
    zodiac:
      "• Zodiac: ${selectedZodiac.length > 0 ? selectedZodiac.map((z) => ZODIAC_NAMES[z]).join(', ') : 'Tidak ada batasan'}",
    zodiac2: '⭐ Zodiak: ${matchResult.user.zodiac ||',
    zodiac3: '⭐ Zodiak: ${user.zodiac_sign ||',
  ...
  tutorial: {
    ...
    catchBottleDesc:
      'Periksa botol pesan orang lain dan balas jika Anda tertarik untuk mulai bercakap-cakap.',
    ...
    howToBecomeFriendsDesc:
      'Anda mengambil botol dan membalas → Mereka juga membalas → Mulai obrolan anonim',
    ...
    whatIsXunNiDesc:
      'Platform sosial botol pesan anonim yang membantu Anda menemukan teman yang sefrekuensi melalui MBTI dan tanda zodiak.',
  },
  vip: {
    admin:
      '⏳ Anda memiliki permintaan pengembalian yang tertunda. Harap tunggu dengan sabar untuk admin meninjaunya.',
    bottle:
      "📝 Konten botol pesan: ${bottle.content.substring(0, 50)}${bottle.content.length > 50 ? '...' : ''}\n\n",
    bottle2:
      '📝 Konten botol pesan: ${bottle.content.substring(0, 50)}${bottle.content.length > 50 ?',
    ...
    conversation2:
      '🔄 Memperbarui riwayat percakapan Anda, avatar kosong akan segera ditampilkan...\n\n',
    ...
    message12:
      "💬 **Silakan tekan lama pesan ini, pilih 'Balas', dan masukkan konten Anda untuk memulai obrolan dengan pihak lain**",
    ...
    quota:
      '• Kuota 30 botol pesan per hari (undang teman untuk meningkatkan, hingga 100 per hari)\n',
    quota2: '• Kuota 30 botol pesan per hari (hingga 100 per hari)\n',
    refundAdminCommands:
      '💡 Gunakan perintah berikut untuk melanjutkan:\n• Setujui: `/admin_approve_refund <ID>`\n• Tolak: `/admin_reject_refund <ID> <reason>`',
    refundApproved:
    ...
    refundPending:
      '⏳ Anda memiliki permintaan pengembalian dana yang tertunda, harap bersabar sementara admin meninjau.',
    refundPendingList: '📋 **Permintaan pengembalian dana yang tertunda** (${count})',
    refundReasonTooShort:
      '❌ Alasan pengembalian dana harus minimal 10 karakter, silakan masukkan kembali:',
    refundRejected:
      '❌ **Permohonan pengembalian dana ditolak**\n\nAlasan: ${reason}\n\nJika Anda memiliki pertanyaan, silakan hubungi dukungan pelanggan.',
    refundRejectedAdmin:
    ...
    reminderGracePeriod:
      '📌 Masa tenggang: Pembaruan dalam 3 hari setelah kadaluarsa tidak akan mengganggu layanan.',
    ...
    settings:
      '💡 Untuk membatalkan langganan Anda, silakan pergi ke Pengaturan Telegram > Manajemen Langganan\n\n',
    settings2:
      '💡 Untuk membatalkan langganan Anda, silakan pergi ke Pengaturan Telegram > Manajemen Langganan',
    ...
    text4:
      '🔄 **Pembaruan Otomatis**: Dikenakan biaya otomatis setiap bulan, tidak perlu pembaruan manual\n',
    ...
    text9:
      '📌 Periode Tenggang: Layanan tidak akan terputus jika diperbarui dalam waktu 3 hari setelah masa berlaku.',
  ...
  vipTripleBottle: {
    ...
    replyHint:
      "💬 **Silakan tekan lama pesan ini, pilih 'Balas', dan masukkan konten untuk mulai mengobrol dengan pihak lainnya**",
  ...
  warning: {
    ...
    conversation4:
      '⚠️ Tidak dapat menemukan percakapan yang ditentukan, mungkin telah berakhir atau kadaluarsa.',
    ...
    register:
      '⚠️ Profil pengguna tidak ditemukan, silakan daftarkan terlebih dahulu menggunakan /start.',
    register2:
      '⚠️ Harap selesaikan proses pendaftaran terlebih dahulu.\n\nGunakan /start untuk melanjutkan pendaftaran.',
    ...
    settings:
      '⚠️ Pengingat: Pengaturan jenis kelamin **tidak akan pernah bisa dimodifikasi** setelah ini!\n\n',
    settings2:
      '⚠️ Pengaturan tanggal lahir tidak dapat dimodifikasi, harap konfirmasi bahwa itu benar!',
    settings3:
      '⚠️ Catatan: Pengaturan jenis kelamin tidak dapat dimodifikasi, harap pilih dengan hati-hati!',
  ...
  warnings: {
    ...
    warning: {
      ...
      conversation4:
        '⚠️ Tidak dapat menemukan percakapan yang ditentukan, mungkin telah berakhir atau kedaluwarsa.',
      ...
      message2: '⚠️ Catatan: Ini adalah \\${testInfo}\\${testTitle}, \\${accuracy}.\n\n',
      message3:
        '⚠️ Silakan tekan lama pada pesan yang ingin Anda blokir dan balas dengan perintah\n\n',
      message4:
        '⚠️ Silakan tekan lama pada pesan yang ingin Anda laporkan dan balas dengan perintah\n\n',
      message5: '⚠️ **Pesan mengandung tautan terlarang**\n\n',
      register:
        '⚠️ Data pengguna tidak ditemukan, harap daftarkan diri terlebih dahulu menggunakan /start.',
      register2:
      ...
      settings2:
        '⚠️ Tanggal lahir tidak dapat diubah setelah ditetapkan, harap konfirmasi bahwa itu benar!',
      settings3:
        '⚠️ Catatan: Gender tidak dapat diubah setelah ditetapkan, harap pilih dengan bijak!',
      short: '⚠️ Urutan pertanyaan tidak benar',
      short2: '⚠️ Pilihan tidak dikenal',
      short3: '⚠️ Permintaan tidak valid',
    ...
    BROADCAST: {
      ...
      NO_MATCHES:
        '⚠️ Tidak ada pengguna yang cocok dengan kriteria yang ditemukan.\nKriteria filter: {filters}',
      TOO_MANY_USERS:
        '⚠️ Terlalu banyak pengguna target ({count} orang), saat ini dibatasi untuk mengirim ke {max} orang sekaligus.',
    ...
    push: {
      ...
      catchReminder:
        '🎣 Beberapa botol pesan baru telah terdampar di pantai, mau pergi melihatnya?',
      onboardingReminder:
        '👋 Pendaftaran kamu belum lengkap, kamu hampir sampai! (Langkah: {step})',
      messageReminderA:
        '👋 Hai {masked_partner_name}, masih menunggu balasanmu! Jangan biarkan percakapan dingin～',
      messageReminderB:
        '📩 Kamu memiliki pesan yang belum dibaca dari {masked_partner_name}:\n> "{last_message_preview}..."\n(Sudah lebih dari 24 jam!)',
    ...
    match: {
      ...
      reason: {
        zodiac: {
          ...
          earth_affinity:
            'Kestabilan tanda bumi yang dipadukan dengan kelembutan tanda air menciptakan aliran sempurna.',
          air_affinity:
            'Ketangkasan tanda udara bertemu dengan semangat tanda api, menginspirasi kreativitas tanpa henti!',
          water_affinity:
            'Emosi tanda air dan praktikalitas tanda bumi membangun dukungan terhangat.',
        },
        mbti: {
          sj_affinity:
            'Sosialis (SJ) dan Penjelajah (SP), pasangan sempurna stabilitas dan kegembiraan!',
          sp_affinity:
            'Penjelajah (SP) dan Sosialis (SJ), pasangan terbaik untuk teman bermain dan pengasuh!',
          nf_affinity:
            'Idealistis (NF) dan Rasionalis (NT), tabrakan mendalam antara jiwa dan kebijaksanaan!',
          nt_affinity:
            'Rasionalis (NT) dan Idealistis (NF), resonansi antara pemikiran dan perasaan!',
        },
        blood: {
          a_affinity:
            'Ketelitian Tipe A bertemu dengan toleransi Tipe O, menciptakan interaksi yang paling nyaman.',
          b_affinity:
            'Pernyataan diri Tipe B bertemu dengan sifat santai Tipe O, tanpa stres dan santai.',
      ...
      btn: {
        ...
        vip_upsell:
          '💡 Upgrade ke VIP untuk menentukan pengiriman ke {target}, untuk pencocokan yang tepat!',
      },
    },
  },
  push: {
    ...
    onboardingReminder:
      '👋 Pendaftaran Anda belum lengkap, tinggal sedikit lagi! (Langkah: {step})',
    messageReminderA:
      '👋 Hai {masked_partner_name}, kami masih menunggu balasan Anda! Jangan biarkan percakapan menjadi dingin～',
    messageReminderB:
      '📩 Anda memiliki pesan yang belum dibaca dari {masked_partner_name}:\n> "{last_message_preview}..."\n(Sudah 24 jam berlalu!)',
