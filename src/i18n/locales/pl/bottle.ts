export default {
  ...
  "catch": {
    ...
    "bottle": "😔 Obecnie nie ma odpowiednich butelek z błogosławieństwami",
    "bottle2": "• Lub wrzuć Butelkę Błogosławieństwa z własnym błogosławieństwem: /throw",
    "bottle3": "🎣 Ktoś znalazł twoją wiadomość w butelce!",
    "bottle4": "🧴 Znalazłeś butelkę błogosławieństw!",
    "bottle5": "💡 Wróćmy jutro, aby zebrać więcej Butelek Błogosławieństwa!",
    "bottleTaken": "❌ Ta Butelka Błogosławieństwa została już odebrana przez kogoś innego. Proszę spróbować innych butelek!",
    ...
    "notRegistered": "❌ Proszę ukończyć proces rejestracji przed odebraniem Butelek Błogosławieństwa.\n\nUżyj /start, aby kontynuować rejestrację.",
    "originalContent": "Tekst oryginalny: {content}",
    "originalLanguage": "Język oryginalny: {language}",
    "quotaExhausted": "❌ Dzienna kwota Buteleczki Błogosławieństwa została wykorzystana (\\{quotaDisplay})",
    ...
    "text4": "• Jeśli nie chcesz już rozmawiać, możesz użyć /block, aby zablokować\n\n",
    "text5": "Oryginalny tekst: \\{bottle.content}\n",
    "text6": "💬 Usługa tłumaczenia ma chwilowe problemy, użyto zapasowego tłumaczenia\n",
    "text7": "Tłumaczenie: \\{bottleContent}",
    "text8": "💡 **Dwa sposoby odpowiedzi**：",
    "translatedContent": "Tłumaczenie: {content}",
    "translatedLanguage": "Język tłumaczenia: {language}",
    "translationServiceFallback": "💬 Usługa tłumaczenia tymczasowo doświadcza problemów, użyto tłumaczenia zapasowego.",
  ...
  "throw": {
    ...
    "bottle10": "🍾 Błogosławieństwo butelki z błogosławieństwem zostało rzucone! W tym ogromnym morzu ludzi, kto otrzyma moje błogosławieństwa~",
    "bottle11": "🍾 Wyślij butelkę z wiadomością z błogosławieństwami",
    "bottle2": "🎯 Twoja butelka z błogosławieństwem została wysłana do **3 odbiorców**:",
    "bottle3": "🍾 **Wysyłanie Twojego błogosławieństwa w butelce błogosławieństwa...**",
    "bottle4": "🍾 **Wyślij Butelkę Błogosławieństwa** #THROW",
    "bottle5": "ID butelki: #{bottleId}",
    "bottle6": "📝 **Proszę wprowadzić treść swoich błogosławieństw dla nieznajomego**",
    "bottle7": "1️⃣ Kliknij przycisk poniżej '🍾 Wyślij wiadomość w butelce z życzeniami'",
    "bottle8": "📝 Proszę wprowadzić treść swojej wiadomości w butelce:",
    "bottle9": "📝 Proszę wprowadzić treść swojej butelki z wiadomością:",
    ...
    "message6": "Cześć! Jestem kimś, kto uwielbia muzykę i filmy,\nhoping poznać niektórych z was, którzy również mają swoje historie.\nŻyczę wszystkim, którzy widzą tę wiadomość w butelce, wszystkiego najlepszego i niech wasze marzenia się spełnią 🌟",
    ...
    "text2": "• 🆕 Możliwość potrójnej ekspozycji! Rzucenie jednej message bottle uruchamia 3 cele.",
    "text20": "💬 **Przykład**:\n",
