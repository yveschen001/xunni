export default {
  ...
  "bottle11": "Nie będziecie już dostawać dopasowanych Butelek Życzeń.",
  "bottle12": "Jakiego typu osobę chciałbyś dopasować do wysyłki Butelki Życzeń?",
  "bottle13": "Użyj, aby wysłać Butelkę Życzeń i rozpocząć szczęśliwą rozmowę!",
  ...
  "bottle16": "💡 Przy następnym wysłaniu Butelki Życzeń, to ustawienie zostanie automatycznie użyte.",
  ...
  "bottle26": "• Wyślij treść roboczą, aby wysłać Butelkę Życzeń",
  "bottle27": "📦 **Wyślij Butelkę Życzeń**",
  "bottle28": "🎣 **Złap Butelkę Życzeń**",
  "bottle29": "💡 Ukończ zadanie, aby zdobyć dodatkowe Butelki Życzeń.",
  ...
  "bottle4": "Anonymowa platforma do znajdowania przyjaciół przez Butelki Życzeń, dzięki wzajemnym życzeniom oraz MBTI i znakom zodiaku pomogą Ci znaleźć odpowiednich przyjaciół.",
  ...
  "bottle7": "🍾 Wyślij Butelkę Życzeń\n\nJakiego rozmówcę szukasz? Najpierw wyślij życzenia do tej szczególnej osoby z daleka, a szczęście do Ciebie wróci.",
  "bottle8": "Wyślij Butelkę Życzeń i dziel się życzeniami z nowymi przyjaciółmi!",
  "bottle9": "Zobacz Butelki Życzeń innych, dzielcie się życzeniami i zaczynaj rozmowę.",
