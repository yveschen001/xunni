export default {
  ...
  "admin2": "Zabranie administratora",
  "admin3": "- Dodaj jako zwykłego administratora",
  "admin4": "- Usuń zwykłego administratora",
  "admin5": "`/admin_add 123456789` - Dodaj jako zwykłego administratora",
  ...
  "analyticsTitle": "Analiza danych",
  "adPerformanceTitle": "Wydajność reklamy",
  "vipFunnelTitle": "Lejek VIP",
  "grant": {
    "successVip": "✅ Pomyślnie przyznano dostęp VIP użytkownikowi {userId} ({nickname}) na 30 dni.",
    "successBottles": "✅ Pomyślnie dodano 50 butelek z fortune do użytkownika {userId} ({nickname}).",
    "invalidId": "❌ Nieprawidłowy identyfikator użytkownika.",
    "userNotFound": "❌ Użytkownik {userId} nie został znaleziony.",
    "onlySuperAdmin": "❌ Ta komenda jest przeznaczona tylko dla super administratorów.",
    "usageVip": "Użycie: /add_vip [userID] (pozostaw puste dla siebie)",
    "usageBottles": "Użycie: /add_bottles [userID] (pozostaw puste dla siebie)"
  }
};
