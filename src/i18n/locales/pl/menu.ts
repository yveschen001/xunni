export default {
  ...
  "message": "XunNi, rzućmy razem Butelki Życzeń! 🍾 Użyj mojego kodu zaproszenia, aby dołączyć, a wszyscy zyskamy więcej błogosławieństw!",
  "message2": "XunNi, rzućmy razem Butelki Życzeń! 🍾 Użyj mojego kodu zaproszenia, aby dołączyć, a wszyscy zyskamy więcej błogosławieństw!",
