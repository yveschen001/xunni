export default {
  ...
  "buttonThrow": "🌊 Rzuć Butelkę Życzeń",
  "buttonVip": "💎 VIP",
  ...
  "message": "XunNi, rzućmy Butelkę Życzeń razem! 🍾 Użyj mojego kodu zaproszenia, aby się dołączyć, wszyscy zyskamy więcej błogosławieństw!",
  "message2": "XunNi, rzućmy Butelkę Życzeń razem! 🍾 Użyj mojego kodu zaproszenia, aby się dołączyć, wszyscy zyskamy więcej błogosławieństw!",
