export default {
  ...
  "name": {
    ...
    "confirm_country": "Potwierdź swój kraj/region",
  ...
  "profile": "👤 **Zadania Profilowe** ({completed}/{total})\n",
  "quota": "Obecna dzienna kwota: {quota} jednostek\n",
  "short": "(Do odebrania)",
  "short2": "Ważne na dzisiaj",
  "short3": "Ważne na zawsze",
  "task": "• Zadanie zapraszające: {inviteProgress.current}/{inviteProgress.max} w toku\n\n",
  "task2": "📱 **Zadania w Mediach Społecznościowych** ({completed}/{total})\n",
  "task3": "🎯 **Zadania Zachowań** ({completed}/{total})\n",
