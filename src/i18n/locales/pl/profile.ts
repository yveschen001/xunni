export default {
  ...
  "message": "XunNi, razem rzućmy Butelka Życzeń! 🍾 Użyj mojego kodu zaproszenia: {inviteCode}",
  ...
  "driftBottleInfo": "🍾 Butelka Życzeń: {remaining} / {total}",
  ...
  "reportUser": "⚠️ Zgłoś",
  "moreOptionsTitle": "⚙️ Więcej opcji",
  "giftedVipNote": "🎁 Ktoś podarował ci VIP"
};
