export default {
  ...
  "bottle2": "❌ Twoje konto zostało zablokowane, nie możesz złapać Butelki Życzeń.\n\nW przypadku pytań skontaktuj się z nami.",
  ...
  "quota": "❌ Dzisiaj wykorzystano już pełną kwotę Butelek Życzeń ({quotaDisplay})\n\n💡 Sposoby na zdobycie większej kwoty:\n",
  "quota2": "❌ Dzienny limit wiadomości został wykorzystany ({usedToday}/{dailyLimit})\n\n",
  "quota3": "❌ Dzisiaj wykorzystano już pełną kwotę Butelek Życzeń ({quotaDisplay})\n\n",
  ...
  "register3": "❌ Proszę najpierw ukończyć proces rejestracji, aby móc złapać Butelkę Życzeń.\n\nUżyj ",
