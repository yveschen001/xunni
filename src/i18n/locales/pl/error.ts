export default {
  ...
  "bottle2": "❌ Twoje konto zostało zablokowane, nie możesz zbierać Butelek Życzeń.\n\nW przypadku pytań, skorzystaj z 'Odwołanie'.",
  ...
  "quota": "❌ Dzienny limit Butelek Życzeń został osiągnięty ({quotaDisplay})\n\n💡 Sposoby na uzyskanie większego limitu:\n",
  "quota2": "❌ Dzienny limit wiadomości został wykorzystany ({usedToday}/{dailyLimit})\n\n",
  "quota3": "❌ Dzienny limit Butelek Życzeń został osiągnięty ({quotaDisplay})\n\n",
  ...
  "register3": "❌ Proszę najpierw ukończyć proces rejestracji, aby móc zbierać Butelki Życzeń.\n\nUżyj 'Rejestracja', aby kontynuować.",
