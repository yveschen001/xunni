export default {
  ...
  "back": "Main Menu",
  "banned": "❌ Twoje konto zostało zablokowane, nie możesz zbierać Butelka Życzeń.\n\nW razie wątpliwości, skorzystaj z opcji odwołania.",
  "block": "• Jeśli nie chcesz już czatować, możesz użyć /block, aby zablokować\n",
  "bottle": "😔 Obecnie nie ma dostępnych Butelka Życzeń dla Ciebie\n\n",
  "bottle2": "• Lub możesz samodzielnie rzucić butelkę: /throw",
  "bottle3": "🎣 Ktoś znalazł Twoją Butelka Życzeń!\n\n",
  "bottle4": "🧴 Znalazłeś Butelka Życzeń!\n\n",
  ...
  "notRegistered": "❌ Najpierw zakończ proces rejestracji, aby móc zbierać Butelka Życzeń.\n\nUżyj opcji rejestracji.",
  "originalContent": "Oryginalny tekst: {content}",
  "originalLanguage": "Oryginalny język: {language}",
  "quotaExhausted": "❌ Dzienne limity Butelka Życzeń zostały wyczerpane ({quotaDisplay})",
