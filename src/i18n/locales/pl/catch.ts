export default {
  ...
  "notRegistered": "❌ Najpierw musisz zakończyć proces rejestracji, aby móc zbierać Butelki Życzeń.\n\nUżyj 'Start', aby kontynuować rejestrację.",
  "originalContent": "Oryginalny tekst: {content}",
  "originalLanguage": "Oryginalny język: {language}",
  "quotaExhausted": "❌ Dzisiejszy limit Butelek Życzeń został wyczerpany ({quotaDisplay})",
