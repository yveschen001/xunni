export default {
  ...
  "catch": {
    ...
    "bottle": "😔 Aktuálně nejsou k dispozici žádné vhodné požehnání z Blessing Bottles",
    "bottle2": "• Nebo hoďte Lahvičku požehnání s vaším vlastním požehnáním: /throw",
    "bottle3": "🎣 Někdo našel vaši zprávu v láhvi!",
    "bottle4": "🧴 Našli jste láhev požehnání s požehnáními!",
    "bottle5": "💡 Vraťme se zítra pro další požehnání z lahví s požehnáním!",
    "bottleTaken": "❌ Tato lahev požehnání byla již vyzvednuta někým jiným. Zkuste prosím jiné lahve!",
    ...
    "notRegistered": "❌ Prosím, dokončete registrační proces před vyzvednutím Lahví požehnání.\n\nPoužijte /start pro pokračování registrace.",
    "originalContent": "Původní text: {content}",
    "originalLanguage": "Originální jazyk: {language}",
    "quotaExhausted": "❌ Dnešní požehnání kvóta lahvičky požehnání byla vyčerpána (\\{quotaDisplay})",
  ...
  "throw": {
    ...
    "bottle10": "🍾 Požehnání láhev požehnání byla vyhozena! V tomto rozlehlém moři lidí, kdo dostane mé požehnání~",
    "bottle11": "🍾 Odešlete zprávu v láhvi se požehnáním",
    "bottle2": "🎯 Vaše láhev s požehnáním byla odeslána **3 příjemcům**:",
    "bottle3": "🍾 **Hodit vaši požehnání do lahve s požehnáním...**",
    "bottle4": "🍾 **Odeslat požehnání lahvičku** #THROW",
    "bottle5": "ID láhve: #{bottleId}",
    "bottle6": "📝 **Prosím zadejte obsah svých požehnání pro cizího člověka**",
    "bottle7": "1️⃣ Klikněte na tlačítko níže '🍾 Odeslat požehnání vzkazová láhev'",
    "bottle8": "📝 Prosím zadejte obsah vaší zprávy v láhvi:",
    "bottle9": "📝 Prosím, zadejte obsah vaší zprávy v láhvi:",
    ...
    "message6": "Ahoj! Jsem někdo, kdo miluje hudbu a filmy,\ndoufám, že se seznámím s některými z vás, kteří máte také příběhy.\nPřeji všem, kteří vidí tuto zprávu v láhvi, vše nejlepší a ať se vám splní vaše přání 🌟",
