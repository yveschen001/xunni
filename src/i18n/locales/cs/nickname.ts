export default {
  ...
  "genderHint": "⚠️ Upozornění: Po nastavení pohlaví nelze změnit, prosím, vyberte opatrně!\n- Pro použití funkce astrologie a párování s Láhví Přání prosím vyplňte pohlaví při narození.",
