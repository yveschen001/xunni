export default {
  ...
  "admin2": "Administrátorské zakázání",
  "admin3": "- Přidat jako běžného administrátora",
  "admin4": "- Odebrat běžného administrátora",
  "admin5": "`/admin_add 123456789` - Přidat jako běžného administrátora",
  ...
  "grant": {
    "successVip": "✅ Úspěšně poskytnut VIP přístup uživateli {userId} ({nickname}) na 30 dní.",
    "successBottles": "✅ Úspěšně přidáno 50 lahví s zprávami uživateli {userId} ({nickname}).",
    "invalidId": "❌ Neplatné ID uživatele.",
    "userNotFound": "❌ Uživatel {userId} nebyl nalezen.",
    "onlySuperAdmin": "❌ Tento příkaz je určen pouze pro superadministrátory.",
    "usageVip": "Použití: /add_vip [userID] (nechte prázdné pro sebe)",
    "usageBottles": "Použití: /add_bottles [userID] (nechte prázdné pro sebe)"
  }
};
