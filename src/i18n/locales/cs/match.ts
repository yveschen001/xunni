export default {
  "resultTitle": "💘 **Rychlé výsledky horoskopu s {target}**",
  "score": "💫 Rychlostní index: {score} bodů",
  "analysis": "📊 **Podrobná analýza:**",
  "high": "✨ **Skvělé spojení!**\nVaše osobnosti se výborně doplňují, společně si užijete příjemný čas. Ať už jako přátelé, nebo jako partneři, máte vysoký potenciál k rozvoji!",
  "medium": "⚖️ **Vzájemná podpora**\nV některých ohledech si rozumíte, ale v jiných budete potřebovat trochu ladění. Pokud si budete navzájem chápat, vztah bude stabilní.",
