export default {
  "resultTitle": "💘 **{target} ile falınıza hızlı eşleşme sonucu**",
  "score": "💫 Eşleşme Skoru: {score} puan",
  "analysis": "📊 **Detaylı Analiz:**",
  "high": "✨ **Mükemmel Eşleşme!**\nKarakterleriniz oldukça tamamlayıcı, birlikte vakit geçirmek çok keyifli olacak. İster arkadaş ister partner olarak, yüksek gelişim potansiyeliniz var!",
  "medium": "⚖️ **Karşılıklı Destek**\nBazı alanlarda uyumlu olsanız da, diğer alanlarda biraz uyum sağlamanız gerekebilir. Birbirinize tolerans gösterdiğiniz sürece, ilişkiniz oldukça stabil olacaktır.",
  "low": "🔥 **Çatışmalar**\nKarakterleriniz arasında büyük farklılıklar olabilir, bu da bazı zorluklar getirebilir. Ancak bu farklılıklar, beklenmedik bir kıvılcımı da doğurabilir!",
  ...
  "btn": {
    "throw": "🍾 Dilek Şişesi At",
    "vip_throw": "💎 VIP Şişe At"
  }
};
