...
export const translations: Translations = {
  ...
  "admin": {
    ...
    "message2": "• تم التحديث في: ${avatarInfo.avatar_updated_at ? new Date(avatarInfo.avatar_updated_at).toLocaleString('zh-TW') : 'غير معروف'}",
  ...
  "analytics": {
    "ad": "• الإعلانات الرسمية: \n - مرات الظهور: {officialImpressions} مرة\n - النقرات: {officialClicks} مرة\n - معدل النقر: {officialCtr}%\n - المكافآت الممنوحة: {officialRewardsGranted} موقع\n\n• مشاهدات الصفحة المميزة: {vipPageViews} مرة\n• نوايا الشراء: {vipPurchaseIntents} مرة\n• التحويلات الناجحة: {vipConversions} مرة\n• معدل التحويل: {vipConversionRate}%\n• الإيرادات: \\\\\\\\\\$${vipRevenue}",
    ...
    "message3": "**📈 معدل التحويل الإجمالي: ${report.overall_conversion_rate.toFixed(1)}%**",
    "message4": "• معدل التحويل: ${step.conversion_rate.toFixed(1)}%",
    "message5": "• معدل الخطأ: ${provider.error_rate.toFixed(1)}%",
    "message6": "• الطلبات: ${provider.total_requests} مرة",
  ...
  "bottle": {
    ...
    "catch": {
      ...
      "catch": "📊 صيد اليوم: \\\\$${newCatchesCount}/\\${quota}\n\n",
  ...
  "common": {
    ...
    "close": "❌ إغلاق",
    "complete": "🎉 **تم الانتهاء من عرض الإعلان!**\n\n✅ تم كسب **+1 حصة**\n📊 تمت المشاهدة اليوم: **${updated.ads_watched}/20** مرات\n🎁 الحصة المكتسبة اليوم: **${updated.quota_earned}**\n📈 مشاهدات متبقية: **${result.remaining_ads}** مرات\n\n${result.remaining_ads > 0 ? '💡 استمر في مشاهدة الإعلانات لكسب المزيد من الحصص!' : '✅ تم الوصول إلى حد الإعلانات اليومية'}",
    ...
    "message11": "${banHours} ${user.language_pref === 'en' ? 'ساعات' : '小時'}",
    ...
    "message15": "${days} ${user.language_pref === 'en' ? 'أيام' : '天'}",
    "message16": "الهدف: ${getBroadcastTargetName(broadcast.targetType)}\n",
    "message17": "الحالة: ${maintenance.isActive ? '✅ تحت الصيانة' : '❌ غير نشط'}",
    ...
    "message46": "/broadcast_filter {user.nickname } ${user.nickname }\n",
  ...
  "errors": {
    ...
    "message": "${statusEmoji} **${provider.provider_display_name}**\n${healthEmoji} حالة الصحة: ${health.is_healthy ? 'جيد' : 'يحتاج إلى اهتمام'}\n📊 معدل الإكمال: ${stats.completion_rate}%\n❌ معدل الخطأ: ${stats.error_rate}%\n📈 إجمالي الطلبات: ${stats.total_requests}\n✅ إجمالي الإ completions: ${stats.total_completions}\n💡 التوصية: ${health.recommendation}",
  ...
  "officialAd": {
    ...
    "requiresVerification": "✅ التحقق مطلوب: انقر على زر 'تحقق' بعد الانضمام إلى المجموعة/القناة",
  ...
  "success": {
    ...
    "success2": "🎉 **تم التحقق بنجاح!**\n\n✅ تم كسب **+${ad.reward_quota} حصة دائمة**\n💎 شكراً لانضمامك لمجتمعنا!\n\n📊 **حصة لديك:**\n• الحصة الأساسية: ${user.is_vip ? 'غير محدودة' : '10'}/يوم\n• الحصة الدائمة: +${ad.reward_quota}\n\n💡 في المجتمع يمكنك:\n• التواصل مع مستخدمين آخرين\n• الحصول على أحدث تحديثات الميزات\n• المشاركة في الأنشطة للحصول على المزيد من المكافآت",
  ...
  "throw": {
    ...
    "mbti7": "🧠 فلتر MBTI",
    "mbtiLabel": "• MBTI: {mbti}",
    "message": "التحديد الحالي: ${currentGender === 'male' ? '👨 ذكر' : currentGender === 'female' ? '👩 أنثى' : '🌈 أي شخص'}",
    "message2": "التحديد الحالي: ${currentGender === 'male' ? '👨 ذكر' : currentGender === 'female' ? '👩 أنثى' : '🌈 أي'}",
    "message3": "المحدد: ${selectedZodiac.length > 0 ? selectedZodiac.map((z) => ZODIAC_NAMES[z]).join(",
    "message4": ") : 'لا شيء'} {bloodTypeDisplay[currentBloodType]} ${bloodTypeDisplay[currentBloodType]}\n\n",
    "message5": "👤 الخصم: ${vipMatchInfo.matcherNickname}\n",
    ...
    "zodiac": "• علامة زودياك: ${selectedZodiac.length > 0 ? selectedZodiac.map((z) => ZODIAC_NAMES[z]).join(', ') : 'لا حدود'}",
  ...
  "vip": {
    ...
    "message3": "الاختيار الحالي: ${bloodTypeDisplay[currentBloodType]} {expireDate} ${expireDate}\n\n",
    ...
    "refundAdminCommands": "وقت الانتهاء: ${expireDate} <ID> `/admin_approve_refund <ID>` `/admin_reject_refund <ID> ` `/admin_reject_refund <ID> <原因>`",
