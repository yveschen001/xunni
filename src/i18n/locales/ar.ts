...
export const translations: Translations = {
  ...
  "admin": {
    ...
    "vip3": "• حالة العضوية المميزة: ${isVip ? '✅ نعم' : '❌ لا'}",
  ...
  "analytics": {
    ...
    "message3": "**📈 معدل التحويل الكلي: ${report.overall_conversion_rate.toFixed(1)}%**",
  ...
  "bottle": {
    ...
    "throw": {
      ...
      "zodiac": "• برجي: \\${selectedZodiac.length > 0 ? selectedZodiac.map((z) => ZODIAC_NAMES[z]).join(', ') : 'لا توجد قيود'}",
  ...
  "broadcast": {
    ...
    "filter": {
      ...
      "invalidCountry": "رمز دولة غير صالح: {value} (يجب أن يتكون من حرفين كبيرين، مثل TW، US، JP)",
  ...
  "common": {
    ...
    "close": "❌ إغلاق",
    "complete": "🎉 **تم الانتهاء من مشاهدة الإعلان!**\n\n✅ حصلت على **+1 حصة**\n📊 تمت المشاهدة اليوم: **${updated.ads_watched}/20** مرات\n🎁 الحصة المكتسبة اليوم: **${updated.quota_earned}**\n📈 المشاهدات المتبقية: **${result.remaining_ads}** مرات\n\n${result.remaining_ads > 0 ? '💡 استمر في مشاهدة الإعلانات لكسب المزيد من الحصص!' : '✅ تم الوصول إلى حد الإعلان اليومي'}",
    ...
    "confirm": "لضمان سلامة جميع المستخدمين، يرجى التأكيد بأنك تفهم ما يلي:",
    ...
    "country": "رمز دولة غير صالح: ${trimmedValue} (يجب أن يكون مكونًا من حرفين كبيرين، مثل TW، US، JP)",
    ...
    "message11": "${banHours} ${user.language_pref === 'en' ? 'ساعات' : '小时'}",
    ...
    "message2": "الحالة: ${maintenance.isActive ? '✅ تحت الصيانة' : '❌ غير نشط'}",
  ...
  "officialAd": {
    ...
    "requiresVerification": "✅ verification مطلوب: انقر على زر 'تحقق' بعد الانضمام إلى المجموعة/القناة",
  ...
  "throw": {
    ...
    "gender5": "👤 فلتر الجنس",
    "genderLabel": "• الجنس: {gender}\n",
    "mbti": "• MBTI: ${selectedMBTI.length > 0 ? selectedMBTI.join(', ') : 'لا توجد حدود'}",
    "mbti2": "المحدد: ${selectedMBTI.length > 0 ? selectedMBTI.join(', ') : 'لا شيء'}",
    "mbti3": "المحدد: ${selectedMBTI.length > 0 ? selectedMBTI.join(",
    "mbti4": "🧠 **فلتر MBTI**\n\n",
    ...
    "mbti7": "🧠 فلتر MBTI",
    "mbtiLabel": "• MBTI: {mbti}",
    "message": "الاختيار الحالي: ${currentGender === 'male' ? '👨 ذكر' : currentGender === 'female' ? '👩 أنثى' : '🌈 أي شخص'}",
    "message2": "الاختيار الحالي: ${currentGender === 'male' ? '👨 ذكر' : currentGender === 'female' ? '👩 أنثى' : '🌈 أي'}",
    "message3": "المحدد: ${selectedZodiac.length > 0 ? selectedZodiac.map((z) => ZODIAC_NAMES[z]).join(",
    ...
    "zodiac": "• برج: ${selectedZodiac.length > 0 ? selectedZodiac.map((z) => ZODIAC_NAMES[z]).join(', ') : 'بلا حدود'}",
  ...
  "vip": {
    ...
    "refundAdminCommands": "مدة الصلاحية: ${expireDate} <ID> `/admin_approve_refund <ID>` `/admin_reject_refund <ID> ` `/admin_reject_refund <ID> <原因>`",
