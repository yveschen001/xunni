...
export const translations: Translations = {
  ...
  "bottle": {
    ...
    "catch": {
      ...
      "translationServiceUnavailable": "⚠️ خدمة الترجمة غير متاحة مؤقتًا، النص الأصلي أدناه",
      "unknown": "غير معروف",
    ...
    "throw": {
      ...
      "mbti2": "المختار: \\${selectedMBTI.length > 0 ? selectedMBTI.join(', ') : 'لا شيء'}\n\n",
      ...
      "mbti7": "🧠 فلتر MBTI",
      "mbtiLabel": "• MBTI: {mbti}\n",
      "message": "المختار: \\${selectedZodiac.length > 0 ? selectedZodiac.map((z) => ZODIAC_NAMES[z]).join(', ') : 'لا شيء'}\n\n",
  ...
  "broadcast": {
    ...
    "filter": {
      ...
      "invalidCountry": "رمز البلد غير صحيح: {value} (يجب أن يكون مكونًا من حرفين كبيرين، مثل TW، US، JP)",
  ...
  "common": {
    ...
    "cancelled": "ملغى",
    "catch": "يرجى إعادة الإدخال أو إلغاء التحرير:",
    "catch2": "• المحتوى الودي والاحترامي أكثر احتمالاً لأن يتم التقاطه!",
    "catch3": "عملية زجاجة الرسائل",
    "catch4": "عملية زجاجة رسائل",
    "close": "❌ إغلاق",
    "complete": "⏰ عملية زجاجة الرسائل قد انتهت \n\nيرجى استخدام /catch لإعادة البدء. {updated.ads_watched} {updated.quota_earned} {result.remaining_ads} ${updated.ads_watched} ${updated.quota_earned} ${result.remaining_ads}",
    ...
    "confirm": "🎉 **اكتملت مشاهدة الإعلان!**\n\n✅ حصلت على **+1 حصة**\n📊 مشاهدات اليوم: **${updated.ads_watched}/20** مرة\n🎁 الحصص المكتسبة اليوم: **${updated.quota_earned}**\n📈 المشاهدات المتبقية: **${result.remaining_ads}** مرة\n\n${result.remaining_ads > 0 ? '💡 استمر في مشاهدة الإعلانات لكسب المزيد من الحصص!' : '✅ تم الوصول إلى الحد اليومي للإعلانات'}\n\n",
    ...
    "country": "لضمان سلامة جميع المستخدمين، يرجى تأكيد أنك تفهم ما يلي: {trimmedValue} ${trimmedValue}",
    ...
    "female": "أنثى",
    "free": "مجاني",
    "gender": "رمز الدولة غير صالح: ${trimmedValue} (يجب أن يكون مكوناً من حرفين كبيرين، مثل TW، US، JP) {gender} ${gender}\n",
    ...
    "invite2": "👤 الجنس: ${gender} {user.invite_code } ${user.invite_code }\n",
    "invite3": "رمز الدعوة: ${user.invite_code } {user.invited_by } ${user.invited_by }\n\n",
    ...
    "message": "تمت الدعوة بواسطة: ${user.invited_by } {typeEmoji} {ad.title} {statusEmoji} {status} {stats.total_views} {stats.total_clicks} {stats.ctr} ${typeEmoji} ${ad.title} ${statusEmoji} ${status} ${stats.total_views} ${stats.total_clicks} ${stats.ctr}",
    "message10": "/broadcast_filter gender=female,age=18-25,country=TW مرحبًا للجميع!\n",
    "message11": "${typeEmoji} **${ad.title}**\n${statusEmoji} الحالة: ${status}\n\n📊 **الإحصائيات**\n• الانطباعات: ${stats.total_views}\n• النقرات: ${stats.total_clicks}\n• معدل النقر (CTR): ${stats.ctr}% {banHours} ${banHours}",
    ...
    "message15": "${banHours} ${user.language_pref === 'en' ? 'ساعات' : '小時'} {days} ${days}",
    "message16": "الهدف: ${getBroadcastTargetName(broadcast.targetType)}\n",
    "message17": "${days} ${user.language_pref === 'en' ? 'أيام' : '天'}\n",
    ...
    "message36": "💡 استخدم /broadcast_status <id> لعرض التفاصيل\n\n",
    ...
    "settings2": "🧠 MBTI: ${updatedUser.mbti_result } (إعادة الاختبار متاحة) {updatedUser.interests} ${updatedUser.interests}\n",
    ...
    "settings3": "🏷️ علامات الاهتمام: ${updatedUser.interests}",
    ...
    "start6": "وقت البدء: ${broadcast.started_at}\n\n",
    ...
    "vip5": "البحث عن مستخدمين متطابقين...\n",
  ...
  "conversation": {
    ...
    "message10": "VIP: ${user.is_vip ? 'نعم' : 'لا'} {conversationId} ${conversationId}",
    ...
    "reported": "✅ تم الإبلاغ",
    "separator": "━━━━━━━━━━━━━━━━",
    "settings": "conv_block_confirm_${conversationId} {otherUser.mbti_result } ${otherUser.mbti_result }\n",
    "settings2": "غير محدد",
    "settings3": "غير محدد",
    "settings4": "غير محدد",
    "settings5": "غير محدد",
    ...
    "text6": "🧠 MBTI: ${otherUser.mbti_result } {identifier} ${identifier}",
  ...
  "conversationHistory": {
    ...
    "mbti": "conv_reply_${identifier} {mbti} ${mbti}",
  ...
  "officialAd": {
    ...
    "requiresVerification": "✅ التحقق مطلوب: انقر على زر 'التحقق' بعد الانضمام إلى المجموعة/القناة",
  ...
  "throw": {
    ...
    "gender": "• الجنس: ${selectedGender === 'male' ? '👨 ذكر' : selectedGender === 'female' ? '👩 أنثى' : '🌈 أي أحد'}\n",
    "gender2": "👤 **فلتر الجنس**\n\n",
    "gender3": "• الجنس: تصفية حسب الجنس\n\n",
    ...
    "mbti7": "🧠 فلتر MBTI",
    "mbtiLabel": "• MBTI: {mbti}\n",
    "message": "الاختيار الحالي: ${currentGender === 'male' ? '👨 ذكر' : currentGender === 'female' ? '👩 أنثى' : '🌈 أي أحد'}\n\n",
    ...
    "zodiac": "• البرج: ${selectedZodiac.length > 0 ? selectedZodiac.map((z) => ZODIAC_NAMES[z]).join(', ') : 'لا حدود'}\n",
