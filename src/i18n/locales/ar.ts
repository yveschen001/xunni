...
export const translations: Translations = {
  ...
  admin: {
    ...
    banSuccess:
      '✅ تم حظر المستخدم {userId} ({nickname})\n\nمدة الحظر: {duration}\nوقت إزالة الحظر: {unbanTime}',
    ...
    message:
      "• تم التحديث في: ${new Date(post.updated_at).toLocaleString('zh-TW', { month: '2-digit', day: '2-digit', hour: '2-digit', minute: '2-digit' })}\n\n",
    ...
    message2:
      "• وقت التحديث: ${avatarInfo.avatar_updated_at ? new Date(avatarInfo.avatar_updated_at).toLocaleString('en-US') : 'غير معروف'}",
    ...
    message4:
      "تاريخ انتهاء الصلاحية الجديد: ${new Date(data.expire_date).toLocaleDateString('zh-TW')}\n",
    message40:
      "• وقت التحديث: ${new Date(post.updated_at).toLocaleString('en-US', { month: '2-digit', day: '2-digit', hour:",
  ...
  bottle: {
    ...
    cancelled: '❌ تم الإلغاء ${zodiac}',
      ...
      banned:
        '❌ تم حظر حسابك ولا يمكنك التقاط زجاجات الرسائل.\n\nلأي أسئلة، يرجى استخدام /appeal لتقديم استئناف.',
      ...
      bottleTaken:
        '❌ تم التقاط هذه الزجاجة الرسائل بالفعل من قبل شخص آخر، يرجى تجربة زجاجات رسائل أخرى!',
      ...
      notRegistered:
        '❌ يرجى إكمال عملية التسجيل قبل التقاط زجاجات الرسائل.\n\nاستخدم /start لمتابعة التسجيل.',
    ...
    throw: {
      ...
      gender:
        "• الجنس: \\${selectedGender === 'male' ? '👨 ذكر' : selectedGender === 'female' ? '👩 أنثى' : '🌈 أي شخص'}",
      gender2: '👤 **فلتر الجنس**\n\n',
      ...
      mbtiLabel: '• MBTI: {mbti}',
      message:
        "المحدد: \\${selectedZodiac.length > 0 ? selectedZodiac.map((z) => ZODIAC_NAMES[z]).join(', ') : 'لا شيء'}",
      message2:
        "التحديد الحالي: \\${currentGender === 'male' ? '👨 ذكر' : currentGender === 'female' ? '👩 أنثى' : '🌈 أي شخص'}",
      message3:
        'المحدد: \\${selectedZodiac.length > 0 ? selectedZodiac.map((z) => ZODIAC_NAMES[z]).join(',
      message4: 'الاختيار الحالي: \\${bloodTypeDisplay[currentBloodType]}\n\n',
      message5: '👤 الخصم: \\${vipMatchInfo.matcherNickname}\n',
      message6:
        '"مرحبًا! أنا شخص يستمتع بالموسيقى والأفلام، وآمل أن ألتقي بأصدقاء ذوي اهتمامات مشابهة~"\n\n',
      ...
      zodiac:
        "• برج: \\${selectedZodiac.length > 0 ? selectedZodiac.map((z) => ZODIAC_NAMES[z]).join(', ') : 'لا توجد قيود'}",
    ...
    tooShort:
      'محتويات زجاجة الرسائل قصيرة جداً، مطلوب على الأقل ${min} حرف (حالياً ${current} حرف)',
  },
  broadcast: {
    ...
    filter: {
      ...
      invalidAgeMinMax:
        'نطاق العمر غير صالح: {value} (يجب ألا يكون الحد الأدنى للعمر أكبر من الحد الأقصى)',
    ...
    filterCreatedSending:
      'سيتم إرسال البث في الخلفية. استخدم /broadcast_status {id} للتحقق من التقدم.',
    ...
    maxUsersExceeded:
      '❌ نظام البث الحالي يدعم فقط البث لغاية ${max} مستخدمين.\n\nعدد المستخدمين المستهدفين: ${current}',
    ...
    upgradeRequired:
      'يتطلب البث الجماعي ترقية في بنية النظام، يرجى الرجوع إلى BROADCAST_SYSTEM_REDESIGN.md',
    usageError: '❌ استخدام غير صحيح\n\n',
  ...
  common: {
    ...
    bloodTypeO: '🩸 نوع O',
    bottle:
      'محتوى زجاجة الرسائل قصير جداً، يجب أن يكون هناك على الأقل ${MIN_BOTTLE_LENGTH} حرف (الحالي ${trimmedContent.length} حرف)',
    ...
    bottle2:
      'محتوى زجاجة الرسائل طويل جداً، الحد الأقصى هو ${MAX_BOTTLE_LENGTH} حرف (الحالي ${content.length} حرف)',
    ...
    bottle4:
      'منصة صداقة زجاجات رسائل مجهولة تساعدك في العثور على أصدقاء متشابهين في التفكير من خلال MBTI وعلامات الأبراج\n\n',
    ...
    broadcast:
      'سيتم إرسال البث في الخلفية. استخدم /broadcast_status ${broadcastId} للتحقق من التقدم.',
    ...
    broadcast2:
      'تتطلب البثوص الضخمة ترقية في بنية النظام، يرجى مراجعة BROADCAST_SYSTEM_REDESIGN.md',
    ...
    conversation6:
      'لقد تم تحديث ذاكرة الصورة الرمزية الخاصة بك. ستظهر الصورة الرمزية الأحدث في المرة التالية التي تعرض فيها سجل المحادثات.\n\n',
    ...
    message23:
      "💡 يرجى الضغط طويلاً على الرسالة التي ترغب في الرد عليها، اختر 'رد' من القائمة التي تظهر، وأدخل ردك في صندوق الدردشة.",
    ...
    message4:
      '💡 استخدم /history ${formatIdentifier(conversations[0].identifier)} لعرض المحادثة الكاملة',
    ...
    start4:
      '🧠 MBTI: \\$ (إعادة الاختبار متاحة) {broadcast.started_at} ${broadcast.started_at}\n\n',
    ...
    text13:
      '💡 سيتم عرض هذا على بطاقة ملفك الشخصي لمساعدة المستخدمين الآخرين على فهمك بشكل أفضل.\n',
  ...
  conversation: {
    ...
    reportSuccessMessage:
      'شكرًا لبلاغك، سنقوم بمراجعته في أسرع وقت ممكن.\n\n💡 هل تريد بدء محادثة جديدة؟\n• استخدم /catch لالتقاط زجاجة رسائل جديدة',
  ...
  error: {
    ...
    admin:
      '❌ حدث خطأ في النظام، يرجى المحاولة مرة أخرى لاحقًا.\n\nإذا استمرت المشكلة، يرجى الاتصال بالمدير.',
    ...
    cancel:
      '❌ اسم المستخدم طويل جدًا، يرجى إدخال اسم مستخدم لا يزيد عن 36 حرفًا.\n\nيرجى إعادة الإدخال أو إلغاء التعديل:',
    cancel2:
      '❌ السيرة الشخصية طويلة جداً، يرجى إدخال 200 حرف كحد أقصى.\n\nيرجى إعادة الإدخال أو إلغاء التعديل:',
    cancel3:
      '❌ اسم المنطقة طويل جداً، يرجى إدخال 50 حرف كحد أقصى.\n\nيرجى إعادة الإدخال أو إلغاء التعديل:',
    cancel4:
      '❌ اللقب قصير جداً، يجب أن يكون على الأقل 4 أحرف.\n\nيرجى إعادة الإدخال أو إلغاء التعديل:',
    cancel5:
      '❌ يمكن أن يحتوي كل علامة على 20 حرف كحد أقصى.\n\nيرجى إعادة الإدخال أو إلغاء التعديل:',
    ...
    failed24:
      '❌ فشل في إرسال التقرير اليومي: ${error instanceof Error ? error.message : String(error)}',
    ...
    failed3:
      '❌ فشل في معالجة قائمة انتظار البث: ${error instanceof Error ? error.message : String(error)}',
    ...
    failed4:
      '❌ فشل في استعلام حالة البث: ${error instanceof Error ? error.message : String(error)}',
    ...
    message4:
      '❌ عذرًا، يجب أن تكون في السن القانونية (18 عامًا) على الأقل لاستخدام هذه الخدمة.\n\nيرجى العودة عندما تكون بالغًا!',
    ...
    quota:
      '❌ لقد استهلكت حصة زجاجات الرسائل اليوم (${quotaDisplay})\n\n💡 طرق لكسب المزيد من الحصة: \n',
    ...
    register3:
      '❌ يجب عليك إكمال عملية التسجيل لالتقاط زجاجات الرسائل.\n\nاستخدم /start لمتابعة التسجيل.',
    settings:
      '❌ يمكنك فقط تعيين حد أقصى من 5 علامات اهتمام.\n\nيرجى إعادة الإدخال أو إلغاء التحرير:',
  ...
  errors: {
    ...
    error: {
      ...
      bottle2:
        '❌ تم حظر حسابك ولا يمكنك التقاط زجاجات رسائل.\n\nإذا كانت لديك أسئلة، يرجى استخدام /appeal للاستئناف.',
      ...
      broadcast3: '❌ لم يتم العثور على سجل البث',
      cancel:
        '❌ الاسم المستعار طويل جدًا؛ يرجى إدخال اسم مستعار لا يتجاوز 36 حرفًا.\n\nيرجى إعادة الإدخال أو إلغاء التحرير:',
      cancel2:
        '❌ وصف الملف الشخصي طويل جدًا؛ يرجى إدخال وصف لا يتجاوز 200 حرف.\n\nيرجى إعادة الإدخال أو إلغاء التحرير:',
      cancel3:
        '❌ اسم المنطقة طويل جدًا؛ يرجى إدخال اسم لا يتجاوز 50 حرفًا.\n\nيرجى إعادة الإدخال أو إلغاء التحرير:',
      cancel4:
        '❌ الاسم المستعار قصير جدًا؛ يجب أن يتكون من 4 حروف على الأقل.\n\nيرجى إعادة الإدخال أو إلغاء التحرير:',
      ...
      failed37: '❌ فشل في تعيين الأولوية',
      failed38:
        '❌ فشل في استرداد المبلغ: ${error instanceof Error ? error.message : String(error)}',
      ...
      message3:
        '❌ حدث خطأ، يرجى المحاولة مرة أخرى لاحقًا.\n\nرسالة الخطأ: \\${error instanceof Error ? error.message : String(error)}',
      message4:
        '❌ نعتذر، يجب أن تكون في سن 18 عامًا على الأقل لاستخدام هذه الخدمة.\n\nيرجى العودة عندما تصبح بالغًا!',
      ...
      quota:
        '❌ تم استخدام حصة زجاجة الرسائل اليوم (\\${quotaDisplay})\n\n💡 طرق للحصول على المزيد من الحصة: \n',
      ...
      register3:
        '❌ يجب عليك إكمال عملية التسجيل لالتقاط زجاجات الرسائل.\n\nاستخدم /start للمتابعة في التسجيل.',
      settings:
        '❌ يمكنك تعيين حد أقصى من 5 علامات اهتمام.\n\nيرجى إعادة الإدخال أو إلغاء التعديل:',
  ...
  history: {
    ...
    conversationNotFound:
      '❌ لم يتم العثور على محادثة مع المعرف {identifier}\n\nاستخدم /history لعرض جميع المحادثات\n\n🏠 العودة إلى القائمة الرئيسية: /menu',
  ...
  menu: {
    ...
    levelVip: '💎 عضو مميز',
    message:
      'لنلقِ زجاجة رسائل معًا على XunNi! 🍾 استخدم رمز الدعوة الخاص بي للانضمام، وسنحصل كلاهما على المزيد من الحصص!',
    message2:
      'https://t.me/share/url?url=https://t.me/${botUsername}?start=invite_${inviteCode}&text=تعال إلى XunNi وارسل زجاجة رسائل معًا',
    notRegistered: 'غير مسجل',
    notSet: 'غير محدد',
  ...
  officialAd: {
    ...
    requiresVerification:
      "✅ تحتاج إلى التحقق: انقر على زر 'التحقق' بعد الانضمام إلى المجموعة/القناة",
  ...
  onboarding: {
    ...
    back: '⬅️ العودة',
    birthday:
      'إذا كنت تعتقد أن هذا خطأ، يرجى التحقق مما إذا كان تنسيق تاريخ ميلادك صحيحًا (YYYY-MM-DD).',
    ...
    birthdayCheck:
      'إذا كنت تعتقد أن هذه خطأ، يرجى التحقق مما إذا كانت صيغة تاريخ ميلادك صحيحة (YYYY-MM-DD).',
    birthdayError: '❌ {error}',
    birthdayFormatError:
    ...
    understandRisks:
      'لحماية سلامة جميع المستخدمين، يرجى التأكيد على أنك تفهم مخاطر التعارف عبر الإنترنت.\n\n',
  ...
  profile: {
    ...
    message:
      'https://t.me/share/url?url=https://t.me/${botUsername}?start=invite_${inviteCode}&text=تعال إلى XunNi وارمِ زجاجة رسائل معًا!🍾 استخدم رمز الدعوة الخاص بي: ${inviteCode}',
    ...
    message7:
      'https://t.me/share/url?url=https://t.me/${botUsername}?start=invite_${inviteCode}&text=تعال وانضم إلى XunNi وأرسل زجاجة رسائل',
  ...
  tasks: {
    ...
    description: {
      ...
      invite_progress:
        'احصل على +1 حصة يومية دائمة لكل شخص تتم دعوته (مجانية حتى 10 أشخاص، VIP حتى 100 شخص)',
    ...
    message2:
      'اضغط على الزر أدناه للانضمام إلى القناة الرسمية لـ XunNi للحصول على آخر الأخبار والفعاليات!\n\n',
    name: {
  ...
  throw: {
    ...
    gender:
      "• الجنس: ${selectedGender === 'male' ? '👨 ذكر' : selectedGender === 'female' ? '👩 أنثى' : '🌈 أي'}",
    gender2: '👤 **فلتر الجنس**\n\n',
    gender3: '• الجنس: تصفية حسب الجنس\n\n',
    ...
    mbtiLabel: '• MBTI: {mbti}',
    message:
      "تم الاختيار: ${selectedZodiac.length > 0 ? selectedZodiac.map((z) => ZODIAC_NAMES[z]).join(', ') : 'لا شيء'}",
    message2:
      "الاختيار الحالي: ${currentGender === 'male' ? '👨 ذكر' : currentGender === 'female' ? '👩 أنثى' : '🌈 أي شخص'}",
    message3:
      'المحدد: ${selectedZodiac.length > 0 ? selectedZodiac.map((z) => ZODIAC_NAMES[z]).join(',
    message4: 'اختيار الحالي: ${bloodTypeDisplay[currentBloodType]}',
    message5: '👤 الخصم: ${vipMatchInfo.matcherNickname}',
    message6:
      '"مرحبًا! أنا شخص يحب الموسيقى والأفلام، وآمل أن ألتقي بأصدقاء يشاركونني الاهتمامات～"',
    ...
    zodiac:
      "• علامة زودياك: ${selectedZodiac.length > 0 ? selectedZodiac.map((z) => ZODIAC_NAMES[z]).join(', ') : 'لا توجد قيود'}",
  ...
  tutorial: {
    ...
    howToBecomeFriendsDesc:
      'أنت تلتقط زجاجة وترد → الطرف الآخر يرد أيضًا → ابدأ المحادثة بشكل مجهول',
    ...
    throwBottleDesc:
      'اكتب مشاعرك أو أفكارك، وسيقوم النظام بمساعدتك في العثور على الأشخاص المناسبين',
    unknownStep: '❌ خطوة البرنامج التعليمي غير معروفة',
    viewTasks: '📋 عرض المهام',
    welcome: '🎉 تهانينا على إكمال تسجيلك!',
    whatIsXunNi: '🌊 **ما هو XunNi؟**',
    whatIsXunNiDesc:
      'منصة زجاجة رسائل مجهولة تساعدك في العثور على أصدقاء يشاركونك الاهتمامات من خلال MBTI وعلامات الأبراج.',
  },
  vip: {
    admin: '⏳ لديك طلب استرداد معلق. يرجى التحلي بالصبر بينما يقوم المدير بمراجعته.',
    bottle:
      "📝 محتوى زجاجة الرسائل: ${bottle.content.substring(0, 50)}${bottle.content.length > 50 ? '...' : ''}\n\n",
    bottle2:
      '📝 محتوى زجاجة الرسائل: ${bottle.content.substring(0, 50)}${bottle.content.length > 50 ?',
    ...
    message12:
      "💬 **يرجى الضغط لمدة طويلة على هذه الرسالة، اختيار 'رد'، وإدخال محتواك لبدء المحادثة مع الطرف الآخر**",
    ...
    reminderGracePeriod:
      '📌 فترة السماح: تجديد الاشتراك خلال 3 أيام بعد انتهاء الصلاحية لن يقطع الخدمة.',
  ...
  vipTripleBottle: {
    ...
    replyHint:
      "💬 **يرجى الضغط مطولاً على هذه الرسالة، اختر 'رد', وأدخل محتواك لبدء الدردشة مع الطرف الآخر**",
  ...
  warnings: {
    ...
    warning: {
      ...
      message5: '⚠️ **الرسالة تحتوي على روابط محظورة**\n\n',
      register:
        '⚠️ لم يتم العثور على ملف التعريف الخاص بالمستخدم، يرجى التسجيل أولاً باستخدام /start.',
      register2: '⚠️ يرجى إكمال عملية التسجيل أولاً.\n\nاستخدم /start للمتابعة في التسجيل.',
    ...
    BROADCAST: {
      ...
      TOO_MANY_USERS:
        '⚠️ عدد المستخدمين المستهدفين كثير جداً ({count} شخص)، الحد الأقصى حالياً هو إرسال الرسائل إلى {max} شخص في وقت واحد.',
    ...
    push: {
      ...
      catchReminder:
        '🎣 ظهرت بعض زجاجات الرسائل الجديدة على الشاطئ، هل ترغب في الذهاب للتحقق منها؟',
      ...
      messageReminderB:
        '📩 لديك رسالة غير مقروءة من {masked_partner_name}:\n> "{last_message_preview}..."\n(لقد مرت أكثر من 24 ساعة!)',
  ...
  push: {
    ...
    messageReminderB:
      '📩 لديك رسالة unread من {masked_partner_name}:\n> "{last_message_preview}..."\n(لقد مرت 24 ساعة بالفعل!)',
    messageReminderC: '⏳ {masked_partner_name} ينتظر ردك...',
  },
};
