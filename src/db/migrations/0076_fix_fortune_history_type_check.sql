-- Migration: 0076_fix_fortune_history_type_check.sql
-- Fix check constraint on fortune_history.type to support new advanced types
...
CREATE TABLE fortune_history_new (
  ...
  -- Fortune type (Updated)
  -- Supports all types defined in FortuneType
  type TEXT NOT NULL CHECK(type IN ('daily', 'deep', 'match', 'celebrity', 'ziwei', 'astrology', 'tarot', 'bazi', 'love_ideal', 'love_match')),
