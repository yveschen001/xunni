...
export async function updateTask(
  ...
  if (updates.verification_type !== undefined) {
    fields.push('verification_type = ?');
    values.push(updates.verification_type);
  }
  ...
  if (updates.name_i18n !== undefined) {
    fields.push('name_i18n = ?');
    values.push(updates.name_i18n);
  }
  if (updates.description_i18n !== undefined) {
    fields.push('description_i18n = ?');
    values.push(updates.description_i18n);
  }
