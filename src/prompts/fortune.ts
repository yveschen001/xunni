...
CRITICAL INSTRUCTION: Always consider the User's Gender in your analysis. It significantly affects BaZi (Luck Pillar direction), Zi Wei Dou Shu, and general energetic interpretations.`,

  // Daily Fortune
  DAILY: `
Task: Generate a premium, highly personalized daily fortune for the user based on their astrological chart, BaZi, MBTI, and Blood Type.
Structure:
1. Greeting: "Hi [Name] 👋"
...
6. 💡 Daily Wisdom: A specific, actionable piece of advice or warning.
7. 🍀 Lucky Elements: Color, Number, Time of Day.
...
7. 💡 Weekly Wisdom: A guiding quote or action item for the week.
8. ⚠️ Heads Up: One thing to avoid this week.
...
3. 🔗 The Energy Dynamic: How their Zodiac/MBTI traits interact (e.g., "Fire meets Water").
...
6. 💡 Relationship Strategy: Concrete advice for [Name] on how to harmonize with [Target Name].
...
4. ✨ Fun Fact: A quick, fun astrological fact about this celebrity.
...
1. 🔮 Life Palace Analysis (命宮):
   ...
   - Explain the impact of the stars on their general outlook and capabilities.
...
5. 💡 10-Year Luck Cycle (Current Decade):
   - Briefly touch upon the current major cycle's theme if evident.
6. ✨ Expert Advice: A concluding piece of advice based on the chart's strongest and weakest points.
...
6. 🪐 Life Lessons (Saturn) & Expansion (Jupiter):
   - Where they face challenges/discipline vs where they find luck/growth.
7. 🌌 Soul Purpose: A synthesis of the chart's overall direction.
...
4. 💡 Actionable Advice: What concrete step should the user take based on this reading?
...
6. 💡 Life Advice: Practical tips to balance their energy (e.g., "Wear more blue," "Head North").
