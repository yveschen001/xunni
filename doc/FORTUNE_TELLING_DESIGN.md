...
### 2.5 價值感知與營銷 (Value Perception)

**核心賣點**: 用戶必須感知到我們與普通 GPT 套殼 Bot 的區別。

1.  **Loading 狀態營銷 (The "Fake" Loading Process)**:
    *   利用計算等待時間 (3-5秒)，展示我們的技術深度。
    *   **動畫文案**:
        1.  "🛰️ 正在校對行星位置 (NASA 級星曆數據)..."
        2.  "📜 正在排布東方紫微命盤..."
        3.  "🧬 正在讀取您的 MBTI 與血型數據..."
        4.  "🧠 AI 正在進行 4 維度交叉分析..."
    *   **目的**: 讓用戶覺得 "這個運算很複雜、很專業，值得付費"。

2.  **結果頁背書**:
    *   在報告底部或開頭加上小字標註：
    *   `Data Source: Swiss Ephemeris & Lunar.js | Analysis: Gemini 1.5 Pro`
